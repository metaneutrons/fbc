		...
		{
			{
				...
				if( (TMP$103$4 - 346ull) > 49ull ) goto label$255;
...
int64 HFORWARDCALL( void )
{
	...
	fb$result$1 = 0ll;
	{
		...
		label$329:;
		{
			if( (*(int64*)((uint8*)&ENV$ + 1424ll) & 524288ll) == 0ll ) goto label$331;
			{
				...
				{
					if( *(int64*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 8520ll) + 2096ll) <= 0ll ) goto label$335;
					{
	...
	if( *(int64*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 8520ll) + 16ll) == 2147483648ll ) goto label$338;
	{
		ERRREPORT( 17ll, 0ll, (char*)0ull );
	}
	label$338:;
	...
	*(struct $11FB_CALL_ARG**)((uint8*)&ARG_LIST$1 + 16ll) = (struct $11FB_CALL_ARG*)0ull;
	label$341:;
	{
		...
		TMP$108$2 = 0ll;
		label$367:;
		struct $8FBSYMBOL* vr$17 = SYMBADDPROCPARAM( PROC$1, (char*)0ull, DTYPE$2, (struct $8FBSYMBOL*)0ull, TMP$108$2, MODE$2, 0ll, 0ll );
	...
	label$362:;
	label$361:;
	struct $8FBSYMBOL* vr$25 = SYMBADDPROC( PROC$1, (char*)*(char**)&ID$1, (char*)0ull, 0ll, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, *(int64*)((uint8*)&ENV$ + 552ll), 0ll );
	PROC$1 = vr$25;
...
static int64 HPROCCALLORASSIGN_QB( void )
{
	...
	fb$result$1 = 0ll;
	{
		...
		label$240:;
		{
			...
			label$243:;
			LEXSKIPTOKEN( 2048ll );
			if( *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 8520ll) + 2088ll) != (struct $10FBSYMCHAIN*)0ull ) goto label$246;
			{
