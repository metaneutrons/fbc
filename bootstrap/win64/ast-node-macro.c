	...
	{
		{
			...
			label$26:;
			TMP$85$3 = *($12FB_DATACLASS*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$84$3 * 56ll));
			...
			label$17:;
			{
				...
				label$27:;
				if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$86$4 * 56ll)) + 8ll) >= *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + 456ll) ) goto label$20;
				{
			...
			label$22:;
			{
				...
				label$28:;
				if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$87$4 * 56ll)) + 8ll) >= *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + 904ll) ) goto label$25;
				{
