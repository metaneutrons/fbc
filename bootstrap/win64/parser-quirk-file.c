...
int64 CLINEINPUTSTMT( void )
{
	...
	label$144:;
	{
		...
		if( TMP$95$2 == 17ll ) goto label$152;
		label$153:;
		if( TMP$95$2 == 18ll ) goto label$152;
		label$154:;
		if( TMP$95$2 != 4ll ) goto label$151;
		label$152:;
		{
		...
		goto label$150;
		label$151:;
		if( TMP$95$2 != 7ll ) goto label$155;
		label$156:;
		{
...
int64 CFILESTMT( $8FB_TOKEN TK$1 )
{
	...
	fb$result$1 = 0ll;
	{
		...
		if( (TMP$120$2 - 470ull) > 20ull ) goto label$518;
		goto *tmp$121[TMP$120$2 - 470ull];
		label$518:;
	}
	label$517:;
	return fb$result$1;
...
struct $7ASTNODE* CFILEFUNCT( $8FB_TOKEN TK$1 )
{
	...
	fb$result$1 = (struct $7ASTNODE*)0ull;
	{
		...
		if( (TMP$122$2 - 470ull) > 15ull ) goto label$555;
		goto *tmp$124[TMP$122$2 - 470ull];
		label$555:;
	}
	label$554:;
	return fb$result$1;
		...
		{
			{
				...
				if( TMP$96$4 == 17ll ) goto label$255;
				label$256:;
				if( TMP$96$4 != 18ll ) goto label$254;
				label$255:;
				{
					ERRREPORT( 277ll, 0ll, (char*)0ull );
			...
			{
				{
					...
					if( TMP$97$5 == 17ll ) goto label$310;
					label$311:;
					if( TMP$97$5 != 18ll ) goto label$309;
					label$310:;
					{
						ERRREPORT( 277ll, 0ll, (char*)0ull );
						ASTDELTREE( ELMEXPR$1 );
	...
	if( vr$33 == 0ll ) goto label$320;
	{
		...
		if( IOBEXPR$1 == (struct $7ASTNODE*)0ull ) goto label$322;
		{
			...
			if( S$1 == (struct $8FBSYMBOL*)0ull ) goto label$324;
			{
				...
				label$593:;
				if( (((int64)-(*(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$98$4 * 56ll)) + 8ll) != *(int64*)((uint8*)&ENV$ + 592ll)) | (int64)-(*(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$99$4 * 56ll)) != 0ll)) | (int64)-((DTYPE$4 & 480ll) != 0ll)) == 0ll ) goto label$328;
				{
					ERRREPORT( 24ll, 0ll, (char*)0ull );
				}
				label$328:;
...
static struct $7ASTNODE* HFILEOPEN( int64 ISFUNC$1 )
{
	...
	{
		{
			...
			label$343:;
			{
				if( *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 8520ll) + 2088ll) != (struct $10FBSYMCHAIN*)0ull ) goto label$345;
				{
					LEXSKIPTOKEN( 2048ll );
					OPEN_KIND$1 = 1ll;
				}
			...
			label$353:;
			{
				if( *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 8520ll) + 2088ll) != (struct $10FBSYMCHAIN*)0ull ) goto label$355;
				{
					LEXSKIPTOKEN( 2048ll );
					OPEN_KIND$1 = 4ll;
				}
			...
			label$357:;
			{
				if( *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 8520ll) + 2088ll) != (struct $10FBSYMCHAIN*)0ull ) goto label$359;
				{
					LEXSKIPTOKEN( 2048ll );
					OPEN_KIND$1 = 5ll;
				}
			...
			label$361:;
			{
				if( *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 8520ll) + 2088ll) != (struct $10FBSYMCHAIN*)0ull ) goto label$363;
				{
					LEXSKIPTOKEN( 2048ll );
					OPEN_KIND$1 = 6ll;
				}
	...
	label$368:;
	{
					...
					{
						{
							...
							TMP$108$7 = vr$49;
							if( TMP$108$7 == 281ll ) goto label$385;
							label$386:;
							if( TMP$108$7 == 475ll ) goto label$385;
							label$387:;
							if( TMP$108$7 != 376ll ) goto label$384;
							label$385:;
							{
							}
							goto label$383;
		...
		if( TMP$107$2 > 7ull ) goto label$391;
	...
	{
		{
			...
			fb_StrInit( (void*)&TMP$109$3, -1ll, (void*)vr$72, -1ll, 0 );
			int32 vr$75 = fb_StrCompare( (void*)&TMP$109$3, -1ll, (void*)"INPUT", 6ll );
			...
			goto label$430;
			label$431:;
			int32 vr$78 = fb_StrCompare( (void*)&TMP$109$3, -1ll, (void*)"OUTPUT", 7ll );
			...
			goto label$430;
			label$433:;
			int32 vr$81 = fb_StrCompare( (void*)&TMP$109$3, -1ll, (void*)"BINARY", 7ll );
			...
			goto label$430;
			label$435:;
			int32 vr$84 = fb_StrCompare( (void*)&TMP$109$3, -1ll, (void*)"RANDOM", 7ll );
			...
			goto label$430;
			label$437:;
			int32 vr$87 = fb_StrCompare( (void*)&TMP$109$3, -1ll, (void*)"APPEND", 7ll );
