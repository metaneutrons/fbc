...
typedef char* (*tmp$103)( int64 );
typedef char* (*tmp$104)( int64, int64 );
struct $9EMIT_VTBL {
	tmp$40 INIT;
	tmp$39 END;
	tmp$41 GETOPTIONVALUE;
...
static void HLOADIDX( struct $6IRVREG* VREG$1 )
{
	...
	label$26:;
	{
		$15IRVREGTYPE_ENUM TMP$107$2;
		TMP$107$2 = *($15IRVREGTYPE_ENUM*)VREG$1;
		if( TMP$107$2 == 2ll ) goto label$30;
		label$31:;
		if( TMP$107$2 != 3ll ) goto label$29;
		label$30:;
		{
		}
		goto label$28;
	...
	label$36:;
	label$35:;
	(*(tmp$84*)*(struct $8REGCLASS**)REGTB$)( *(struct $8REGCLASS**)REGTB$, VI$1, (struct $6IRVREG*)0ull, *(uint64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + 456ll) );
	label$25:;
}
...
static void _EMITPROCBEGIN( struct $8FBSYMBOL* PROC$1, struct $8FBSYMBOL* INITLABEL$1 )
{
	...
	_FLUSH(  );
	{
		...
		label$86:;
		{
			(*(tmp$91*)((uint8*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (CLASS_$1 << (3ll & 63ll))) + 88ll))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (CLASS_$1 << (3ll & 63ll))) );
		}
		label$84:;
...
static void _EMITPROCEND( struct $8FBSYMBOL* PROC$1, struct $8FBSYMBOL* INITLABEL$1, struct $8FBSYMBOL* EXITLABEL$1 )
{
	...
	(*(tmp$101*)((uint8*)&EMIT$ + 400ll))( PROC$1, vr$0, INITLABEL$1, EXITLABEL$1 );
	label$88:;
}
...
static void _EMITCONVERT( struct $6IRVREG* V1$1, struct $6IRVREG* V2$1 )
{
	...
	{
		int64 TMP$108$2;
		$12FB_DATACLASS TMP$109$2;
		if( (*(int64*)((uint8*)V1$1 + 8ll) & 480ll) == 0ll ) goto label$99;
		TMP$108$2 = 24ll;
		goto label$856;
		label$99:;
		TMP$108$2 = *(int64*)((uint8*)V1$1 + 8ll) & 31ll;
		label$856:;
		TMP$109$2 = *($12FB_DATACLASS*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$108$2 * 56ll));
		if( TMP$109$2 != 0ll ) goto label$101;
		label$102:;
		{
		...
		goto label$100;
		label$101:;
		if( TMP$109$2 != 1ll ) goto label$105;
		label$106:;
		{
...
static void _EMITPUSHARG( struct $8FBSYMBOL* PARAM$1, struct $6IRVREG* VR$1, int64 UDTLEN$1, int64 LEVEL$1, struct $6IRVREG* LREG$1 )
{
	...
	if( LREG$1 == (struct $6IRVREG*)0ull ) goto label$120;
	{
		...
		if( VR$1 == (struct $6IRVREG*)0ull ) goto label$122;
		{
			...
			goto label$857;
			label$123:;
			TMP$110$3 = *(int64*)((uint8*)VR$1 + 8ll) & 31ll;
			label$857:;
			VR_DTYPE$2 = TMP$110$3;
		...
		label$121:;
		(*(tmp$99*)((uint8*)&EMIT$ + 352ll))( VR_DCLASS$2, VR_TYP$2, *(int64*)((uint8*)PARAM$1 + 136ll), &REG1$2 );
		if( REG1$2 == -1ll ) goto label$127;
		{
			...
			*(int64*)((uint8*)LREG$1 + 24ll) = REG1$2;
			...
			goto label$858;
			label$130:;
			TMP$111$3 = VR_DTYPE$2 & 31ll;
			label$858:;
			(*(tmp$84*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (VR_DCLASS$2 << (3ll & 63ll))))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (VR_DCLASS$2 << (3ll & 63ll))), LREG$1, (struct $6IRVREG*)0ull, *(uint64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$111$3 * 56ll)) + 8ll) );
...
static void _EMITASMLINE( struct $9ASTASMTOK* ASMTOKENHEAD$1 )
{
	...
	{
		{
			$14AST_ASMTOKTYPE TMP$112$3;
			TMP$112$3 = *($14AST_ASMTOKTYPE*)N$1;
			if( TMP$112$3 != 0ll ) goto label$164;
			label$165:;
			{
				FBSTRING TMP$113$4;
				__builtin_memset( &TMP$113$4, 0, 24ll );
				FBSTRING* vr$6 = fb_StrConcat( &TMP$113$4, (void*)&LN$1, -1ll, *(void**)((uint8*)N$1 + 8ll), 0ll );
				fb_StrAssign( (void*)&LN$1, -1ll, (void*)vr$6, -1ll, 0 );
			}
			goto label$163;
			label$164:;
			if( TMP$112$3 != 1ll ) goto label$166;
			label$167:;
			{
				FBSTRING TMP$114$4;
				char* vr$9 = SYMBGETMANGLEDNAME( *(struct $8FBSYMBOL**)((uint8*)N$1 + 8ll) );
				__builtin_memset( &TMP$114$4, 0, 24ll );
				FBSTRING* vr$13 = fb_StrConcat( &TMP$114$4, (void*)&LN$1, -1ll, (void*)vr$9, 0ll );
...
static void _EMITVARINISTR( int64 TOTLGT$1, char* LITSTR$1, int64 LITLGT$1 )
{
	...
	if( LITLGT$1 <= TOTLGT$1 ) goto label$187;
	{
		...
		fb_StrAssign( (void*)&TMP$116$2, -1ll, (void*)vr$3, -1ll, 0 );
		char* vr$5 = HESCAPE( (char*)*(char**)&TMP$116$2 );
		S$1 = vr$5;
		fb_StrDelete( (FBSTRING*)&TMP$116$2 );
	}
	goto label$186;
	label$187:;
	{
...
static void _EMITVARINIWSTR( int64 TOTLGT$1, uint16* LITSTR$1, int64 LITLGT$1 )
{
	...
	if( LITLGT$1 <= TOTLGT$1 ) goto label$195;
	{
		...
		TMP$117$2 = vr$2;
		char* vr$3 = HESCAPEW( (uint16*)TMP$117$2 );
		S$1 = vr$3;
	...
	label$195:;
	{
		char* vr$4 = HESCAPEW( (uint16*)LITSTR$1 );
		S$1 = vr$4;
	}
	label$194:;
...
static void HREUSE( struct $5IRTAC* T$1 )
{
	...
	label$267:;
	{
		...
		if( TMP$123$2 != 4ll ) goto label$273;
		label$274:;
		{
			if( VR$1 == V1$1 ) goto label$276;
			{
				...
				label$865:;
				if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$124$4 * 56ll)) + 40ll) != *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$125$4 * 56ll)) + 40ll) ) goto label$280;
				{
		...
		goto label$272;
		label$273:;
		if( TMP$123$2 == 3ll ) goto label$284;
		label$285:;
		if( TMP$123$2 != 14ll ) goto label$283;
		label$284:;
		{
			int64 V1RENAME$3;
			int64 V2RENAME$3;
			...
			if( VR$1 == V1$1 ) goto label$291;
			{
				...
				label$867:;
				if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$126$4 * 56ll)) + 40ll) != *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$127$4 * 56ll)) + 40ll) ) goto label$295;
				{
			...
			if( (*(int64*)(((int64)(struct $10AST_OPINFO*)AST_OPTB$ + (OP$1 << (5ll & 63ll))) + 8ll) & 2ll) == 0ll ) goto label$299;
			{
				if( VR$1 == V2$1 ) goto label$301;
				{
					...
					label$869:;
					if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$128$5 * 56ll)) + 40ll) != *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$129$5 * 56ll)) + 40ll) ) goto label$305;
					{
	...
	label$321:;
	{
		*(struct $5IRTAC**)((uint8*)&CTX$ + 120ll) = T$1;
		...
		VR$1 = *(struct $6IRVREG**)((uint8*)T$1 + 16ll);
		{
			...
			if( (TMP$130$3 - 1ull) > 29ull ) goto label$324;
...
static void HFLUSHBRANCH( int64 OP$1, struct $8FBSYMBOL* LABEL$1 )
{
	label$347:;
	{
		...
		if( (TMP$131$2 - 98ull) > 3ull ) goto label$355;
		goto *tmp$184[TMP$131$2 - 98ull];
		label$349:;
	}
	label$348:;
}
...
static void HFREEPRESERVEDREGS( void )
{
	...
	static int64 REG$1;
	{
		...
		label$361:;
		{
			int64 vr$1 = (*(tmp$89*)((uint8*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (CLASS_$1 << (3ll & 63ll))) + 56ll))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (CLASS_$1 << (3ll & 63ll))) );
			REG$1 = vr$1;
			label$362:;
			if( REG$1 == -1ll ) goto label$363;
			{
				int64 vr$5 = (*(tmp$87*)((uint8*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (CLASS_$1 << (3ll & 63ll))) + 32ll))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (CLASS_$1 << (3ll & 63ll))), REG$1 );
				if( vr$5 != 0ll ) goto label$365;
				{
					(*(tmp$86*)((uint8*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (CLASS_$1 << (3ll & 63ll))) + 24ll))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (CLASS_$1 << (3ll & 63ll))), REG$1 );
				}
				label$365:;
				label$364:;
				int64 vr$12 = (*(tmp$87*)((uint8*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (CLASS_$1 << (3ll & 63ll))) + 64ll))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (CLASS_$1 << (3ll & 63ll))), REG$1 );
				REG$1 = vr$12;
			}
			goto label$362;
			label$363:;
...
static int64 HPRESERVEREG( struct $6IRVREG* VR$1 )
{
	...
	if( PRESERVED1$1 != 0ll ) goto label$378;
	{
		...
		label$380:;
		label$379:;
		int64 vr$22 = (*(tmp$85*)((uint8*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (VR_DCLASS$1 << (3ll & 63ll))) + 16ll))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (VR_DCLASS$1 << (3ll & 63ll))), FREG1$1, VR$1, (struct $6IRVREG*)0ull );
	...
	if( PRESERVED2$1 != 0ll ) goto label$382;
	{
		...
		if( FREG2$1 != -1ll ) goto label$384;
		{
			...
			{
				(*(tmp$86*)((uint8*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (VR_DCLASS$1 << (3ll & 63ll))) + 24ll))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (VR_DCLASS$1 << (3ll & 63ll))), *(int64*)((uint8*)VR$1 + 24ll) );
	...
	{
		(*(tmp$86*)((uint8*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (VR_DCLASS$1 << (3ll & 63ll))) + 24ll))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (VR_DCLASS$1 << (3ll & 63ll))), *(int64*)((uint8*)&ORIGVREG$1 + 24ll) );
	}
	label$393:;
	label$392:;
...
static void HPRESERVEREGS( struct $6IRVREG* PTRVREG$1 )
{
	...
	struct $6IRVREG* VAUXPARENT$1;
	{
		...
		label$401:;
		{
				...
				{
					{
						...
						if( TMP$133$6 != 4ll ) goto label$407;
						label$408:;
						{
						...
						goto label$406;
						label$407:;
						if( TMP$133$6 == 2ll ) goto label$410;
						label$411:;
						if( TMP$133$6 != 3ll ) goto label$409;
						label$410:;
						{
			...
			label$403:;
			label$402:;
			int64 vr$5 = (*(tmp$89*)((uint8*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (CLASS_$2 << (3ll & 63ll))) + 56ll))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (CLASS_$2 << (3ll & 63ll))) );
			REG$1 = vr$5;
			label$414:;
			if( REG$1 == -1ll ) goto label$415;
			{
				int64 vr$9 = (*(tmp$87*)((uint8*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (CLASS_$2 << (3ll & 63ll))) + 32ll))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (CLASS_$2 << (3ll & 63ll))), REG$1 );
				if( ((int64)-(vr$9 == 0ll) & (int64)-(REG$1 != NPREG$1)) == 0ll ) goto label$417;
				{
					struct $6IRVREG* vr$17 = (*(tmp$90*)((uint8*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (CLASS_$2 << (3ll & 63ll))) + 72ll))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (CLASS_$2 << (3ll & 63ll))), REG$1, &VAUXPARENT$1 );
					VR$1 = vr$17;
				...
				label$417:;
				label$416:;
				int64 vr$22 = (*(tmp$87*)((uint8*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (CLASS_$2 << (3ll & 63ll))) + 64ll))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (CLASS_$2 << (3ll & 63ll))), REG$1 );
				REG$1 = vr$22;
			}
			goto label$414;
			label$415:;
...
static void HLOADPOINTER( struct $6IRVREG* V1$1 )
{
	...
	if( VTYPE$1 != 4ll ) goto label$430;
	{
		...
		label$872:;
		(*(tmp$84*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (DCLASS$1 << (3ll & 63ll))))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (DCLASS$1 << (3ll & 63ll))), V1$1, (struct $6IRVREG*)0ull, *(uint64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$135$2 * 56ll)) + 8ll) );
	}
	label$430:;
	label$429:;
	label$423:;
...
static void HLOADRESULT( struct $8FBSYMBOL* PROC$1, struct $6IRVREG* VR$1 )
{
	...
	if( VR$1 == (struct $6IRVREG*)0ull ) goto label$435;
	{
		...
		label$436:;
		(*(tmp$100*)((uint8*)&EMIT$ + 360ll))( DTYPE$1, DCLASS$1, &REG1$1, &REG2$1 );
		if( ((int64)-(DTYPE$1 == 13ll) | (int64)-(DTYPE$1 == 14ll)) == 0ll ) goto label$442;
		{
			VA$1 = *(struct $6IRVREG**)((uint8*)VR$1 + 88ll);
			int64 vr$13 = (*(tmp$85*)((uint8*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (DCLASS$1 << (3ll & 63ll))) + 16ll))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (DCLASS$1 << (3ll & 63ll))), REG2$1, VA$1, VR$1 );
			*(int64*)((uint8*)VA$1 + 24ll) = vr$13;
			*($15IRVREGTYPE_ENUM*)VA$1 = 4ll;
		}
		label$442:;
		label$441:;
		int64 vr$19 = (*(tmp$85*)((uint8*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (DCLASS$1 << (3ll & 63ll))) + 16ll))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (DCLASS$1 << (3ll & 63ll))), REG1$1, VR$1, (struct $6IRVREG*)0ull );
	...
	label$435:;
	{
		...
		label$874:;
		if( ((int64)-(*(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$137$2 * 56ll)) == 1ll) & (int64)-(*(int64*)((uint8*)PROC$1 + 176ll) != 1ll)) == 0ll ) goto label$445;
		{
			EMITPOPST0(  );
		}
		label$445:;
...
static void HFLUSHSTACK( int64 OP$1, struct $6IRVREG* V1$1, struct $6IRVREG* VR$1, int64 EX$1 )
{
	...
	if( V1_TYP$1 != 4ll ) goto label$466;
	{
		...
		if( ((int64)-(V1_DTYPE$1 == 13ll) | (int64)-(V1_DTYPE$1 == 14ll)) == 0ll ) goto label$468;
		{
			...
			(*(tmp$84*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V1_DCLASS$1 << (3ll & 63ll))))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V1_DCLASS$1 << (3ll & 63ll))), VA$1, V1$1, *(uint64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + 456ll) );
			V1_DTYPE$1 = 8ll;
		}
		label$468:;
		label$467:;
		...
		label$876:;
		(*(tmp$84*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V1_DCLASS$1 << (3ll & 63ll))))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V1_DCLASS$1 << (3ll & 63ll))), V1$1, (struct $6IRVREG*)0ull, *(uint64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$139$2 * 56ll)) + 8ll) );
	}
	label$466:;
	label$465:;
	{
...
static void HFLUSHUOP( int64 OP$1, struct $6IRVREG* V1$1, struct $6IRVREG* VR$1 )
{
	...
	if( VR$1 == (struct $6IRVREG*)0ull ) goto label$492;
	{
		if( V1$1 == VR$1 ) goto label$494;
		{
			...
			{
				VA$1 = *(struct $6IRVREG**)((uint8*)VR$1 + 88ll);
				(*(tmp$84*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (VR_DCLASS$1 << (3ll & 63ll))))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (VR_DCLASS$1 << (3ll & 63ll))), VA$1, VR$1, *(uint64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + 456ll) );
				VR_DTYPE$1 = 8ll;
			}
			label$496:;
			label$495:;
			...
			label$879:;
			(*(tmp$84*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (VR_DCLASS$1 << (3ll & 63ll))))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (VR_DCLASS$1 << (3ll & 63ll))), VR$1, (struct $6IRVREG*)0ull, *(uint64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$142$3 * 56ll)) + 8ll) );
		}
		label$494:;
		label$493:;
	}
	...
	if( VR$1 == (struct $6IRVREG*)0ull ) goto label$499;
	{
		...
		label$880:;
		(*(tmp$84*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V1_DCLASS$1 << (3ll & 63ll))))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V1_DCLASS$1 << (3ll & 63ll))), V1$1, (struct $6IRVREG*)0ull, *(uint64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$143$2 * 56ll)) + 8ll) );
	...
	label$498:;
	{
		...
		goto label$507;
		label$508:;
		static const void* tmp$185[24ll] = {
			&&label$510,
			&&label$507,
			&&label$509,
			&&label$511,
		...
		if( (TMP$144$2 - 52ull) > 23ull ) goto label$507;
...
static void HFLUSHBOP( int64 OP$1, struct $6IRVREG* V1$1, struct $6IRVREG* V2$1, struct $6IRVREG* VR$1 )
{
	...
	if( VR$1 != (struct $6IRVREG*)0ull ) goto label$552;
	{
		if( V2_TYP$1 == 0ll ) goto label$554;
		{
			...
			if( ((int64)-(V2_DTYPE$1 == 13ll) | (int64)-(V2_DTYPE$1 == 14ll)) == 0ll ) goto label$556;
			{
				...
				(*(tmp$84*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V2_DCLASS$1 << (3ll & 63ll))))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V2_DCLASS$1 << (3ll & 63ll))), VA$1, V2$1, *(uint64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + 456ll) );
				V2_DTYPE$1 = 8ll;
			}
			label$556:;
			label$555:;
			...
			label$884:;
			(*(tmp$84*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V2_DCLASS$1 << (3ll & 63ll))))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V2_DCLASS$1 << (3ll & 63ll))), V2$1, (struct $6IRVREG*)0ull, *(uint64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$148$3 * 56ll)) + 8ll) );
		}
		label$554:;
		label$553:;
	}
	...
	label$552:;
	{
		...
		if( V2_TYP$1 != 4ll ) goto label$559;
		{
			...
			label$885:;
			(*(tmp$84*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V2_DCLASS$1 << (3ll & 63ll))))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V2_DCLASS$1 << (3ll & 63ll))), V2$1, (struct $6IRVREG*)0ull, *(uint64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$149$3 * 56ll)) + 8ll) );
		}
		label$559:;
		label$558:;
		...
		label$886:;
		(*(tmp$84*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V1_DCLASS$1 << (3ll & 63ll))))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V1_DCLASS$1 << (3ll & 63ll))), V1$1, (struct $6IRVREG*)0ull, *(uint64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$150$2 * 56ll)) + 8ll) );
	}
	label$551:;
	{
		uint64 TMP$151$2;
		...
		goto label$566;
		label$567:;
		static const void* tmp$186[37ll] = {
			&&label$568,
			&&label$569,
			&&label$570,
			&&label$571,
		...
		if( (TMP$151$2 - 28ull) > 36ull ) goto label$566;
	...
	if( VR$1 == (struct $6IRVREG*)0ull ) goto label$584;
	{
		if( V1$1 == VR$1 ) goto label$586;
		{
			...
			label$887:;
			(*(tmp$84*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (VR_DCLASS$1 << (3ll & 63ll))))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (VR_DCLASS$1 << (3ll & 63ll))), VR$1, (struct $6IRVREG*)0ull, *(uint64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$152$3 * 56ll)) + 8ll) );
			EMITMOV( VR$1, V1$1 );
		}
		label$586:;
		label$585:;
...
static void HFLUSHCOMP( int64 OP$1, struct $6IRVREG* V1$1, struct $6IRVREG* V2$1, struct $6IRVREG* VR$1, struct $8FBSYMBOL* LABEL$1 )
{
	...
	if( ((int64)-(V2_TYP$1 == 4ll) | DOLOAD$1) == 0ll ) goto label$616;
	{
		...
		label$891:;
		(*(tmp$84*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V2_DCLASS$1 << (3ll & 63ll))))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V2_DCLASS$1 << (3ll & 63ll))), V2$1, (struct $6IRVREG*)0ull, *(uint64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$156$2 * 56ll)) + 8ll) );
		V2_TYP$1 = 4ll;
	}
	label$616:;
	label$615:;
	...
	if( ((int64)-(V1_TYP$1 == 4ll) | DOLOAD$1) == 0ll ) goto label$630;
	{
		...
		label$892:;
		(*(tmp$84*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V1_DCLASS$1 << (3ll & 63ll))))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V1_DCLASS$1 << (3ll & 63ll))), V1$1, (struct $6IRVREG*)0ull, *(uint64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$157$2 * 56ll)) + 8ll) );
	}
	label$630:;
	label$629:;
	if( VR$1 == (struct $6IRVREG*)0ull ) goto label$635;
	{
		if( VR$1 == V1$1 ) goto label$637;
		{
			...
			label$893:;
			int64 vr$58 = (*(tmp$84*)((uint8*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (VR_DCLASS$1 << (3ll & 63ll))) + 8ll))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (VR_DCLASS$1 << (3ll & 63ll))), VR$1, (struct $6IRVREG*)0ull, *(uint64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$158$3 * 56ll)) + 8ll) );
	...
	label$634:;
	{
		...
		if( (TMP$159$2 - 45ull) > 5ull ) goto label$639;
...
static void HSPILLREGS( void )
{
	...
	int64 REG$1;
	{
		...
		label$654:;
		{
			int64 vr$1 = (*(tmp$89*)((uint8*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (CLASS_$2 << (3ll & 63ll))) + 56ll))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (CLASS_$2 << (3ll & 63ll))) );
			REG$1 = vr$1;
			label$655:;
			if( REG$1 == -1ll ) goto label$656;
			{
				int64 vr$5 = (*(tmp$87*)((uint8*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (CLASS_$2 << (3ll & 63ll))) + 32ll))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (CLASS_$2 << (3ll & 63ll))), REG$1 );
				if( vr$5 != 0ll ) goto label$658;
				{
					struct $6IRVREG* vr$10 = (*(tmp$90*)((uint8*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (CLASS_$2 << (3ll & 63ll))) + 72ll))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (CLASS_$2 << (3ll & 63ll))), REG$1, &VAUXPARENT$1 );
					VR$1 = vr$10;
					(*(tmp$46*)((uint8*)&IR$ + 528ll))( VR$1, VAUXPARENT$1 );
				}
				label$658:;
				label$657:;
				int64 vr$14 = (*(tmp$87*)((uint8*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (CLASS_$2 << (3ll & 63ll))) + 64ll))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (CLASS_$2 << (3ll & 63ll))), REG$1 );
				REG$1 = vr$14;
			}
			goto label$655;
			label$656:;
...
static void HFLUSHSTORE( int64 OP$1, struct $6IRVREG* V1$1, struct $6IRVREG* V2$1 )
{
	...
	if( ((int64)-(V2_TYP$1 == 4ll) | ((int64)-(V2_TYP$1 != 0ll) & (int64)-(V1_DCLASS$1 == 0ll))) == 0ll ) goto label$674;
	{
		...
		label$896:;
		(*(tmp$84*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V2_DCLASS$1 << (3ll & 63ll))))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V2_DCLASS$1 << (3ll & 63ll))), V2$1, (struct $6IRVREG*)0ull, *(uint64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$162$2 * 56ll)) + 8ll) );
	}
	label$674:;
	label$673:;
	EMITSTORE( V1$1, V2$1 );
...
static void HFLUSHLOAD( int64 OP$1, struct $6IRVREG* V1$1, struct $6IRVREG* VR$1 )
{
	...
	HLOADIDX( V1$1 );
	{
		...
		label$687:;
		{
			...
			label$898:;
			(*(tmp$84*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V1_DCLASS$1 << (3ll & 63ll))))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V1_DCLASS$1 << (3ll & 63ll))), V1$1, (struct $6IRVREG*)0ull, *(uint64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$164$3 * 56ll)) + 8ll) );
		}
		goto label$685;
		label$686:;
		...
		label$692:;
		{
			if( V1_TYP$1 != 4ll ) goto label$694;
			{
				if( ((int64)-(V1_DTYPE$1 == 13ll) | (int64)-(V1_DTYPE$1 == 14ll)) == 0ll ) goto label$696;
				{
					VA$1 = *(struct $6IRVREG**)((uint8*)V1$1 + 88ll);
					(*(tmp$84*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V1_DCLASS$1 << (3ll & 63ll))))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V1_DCLASS$1 << (3ll & 63ll))), VA$1, V1$1, *(uint64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + 456ll) );
					int64 vr$27 = (*(tmp$84*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V1_DCLASS$1 << (3ll & 63ll))))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V1_DCLASS$1 << (3ll & 63ll))), V1$1, (struct $6IRVREG*)0ull, *(uint64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + 456ll) );
					V1_REG$1 = vr$27;
				}
				goto label$695;
				label$696:;
				{
					...
					label$899:;
					int64 vr$34 = (*(tmp$84*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V1_DCLASS$1 << (3ll & 63ll))))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V1_DCLASS$1 << (3ll & 63ll))), V1$1, (struct $6IRVREG*)0ull, *(uint64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$165$5 * 56ll)) + 8ll) );
					V1_REG$1 = vr$34;
				}
				label$695:;
			}
			...
			(*(tmp$100*)((uint8*)&EMIT$ + 360ll))( V1_DTYPE$1, V1_DCLASS$1, &VR_REG$3, &VR_REG2$3 );
			if( VR_REG$3 == V1_REG$1 ) goto label$699;
			{
				if( ((int64)-(V1_DTYPE$1 == 13ll) | (int64)-(V1_DTYPE$1 == 14ll)) == 0ll ) goto label$701;
				{
					VA$1 = *(struct $6IRVREG**)((uint8*)VR$1 + 88ll);
					int64 vr$42 = (*(tmp$85*)((uint8*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V1_DCLASS$1 << (3ll & 63ll))) + 16ll))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V1_DCLASS$1 << (3ll & 63ll))), VR_REG2$3, VA$1, VR$1 );
					*(int64*)((uint8*)VA$1 + 24ll) = vr$42;
					*($15IRVREGTYPE_ENUM*)VA$1 = 4ll;
				}
				label$701:;
				label$700:;
				int64 vr$48 = (*(tmp$85*)((uint8*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V1_DCLASS$1 << (3ll & 63ll))) + 16ll))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V1_DCLASS$1 << (3ll & 63ll))), VR_REG$3, VR$1, (struct $6IRVREG*)0ull );
...
static void HFLUSHCONVERT( int64 OP$1, struct $6IRVREG* V1$1, struct $6IRVREG* V2$1 )
{
		...
		if( V2_DCLASS$1 != 1ll ) goto label$719;
		{
			...
			label$721:;
			{
				...
				*($15IRVREGTYPE_ENUM*)V1$1 = 4ll;
				(*(tmp$88*)((uint8*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V1_DCLASS$1 << (3ll & 63ll))) + 40ll))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V1_DCLASS$1 << (3ll & 63ll))), *(int64*)((uint8*)V1$1 + 24ll), V1$1, (struct $6IRVREG*)0ull );
				goto label$705;
			}
			label$720:;
		}
		...
		{
			{
				...
				if( TMP$169$4 == 1ll ) goto label$729;
				label$730:;
				if( TMP$169$4 != 8ll ) goto label$728;
				label$729:;
				{
				}
				goto label$727;
				...
				{
					{
						...
						if( TMP$171$6 == 1ll ) goto label$735;
						label$736:;
						if( TMP$171$6 != 8ll ) goto label$734;
						label$735:;
						{
						}
						goto label$733;
	...
	label$739:;
	{
		...
		if( V2_TYP$1 != 4ll ) goto label$741;
		{
			...
			label$904:;
			(*(tmp$84*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V2_DCLASS$1 << (3ll & 63ll))))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V2_DCLASS$1 << (3ll & 63ll))), V2$1, (struct $6IRVREG*)0ull, *(uint64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$172$3 * 56ll)) + 8ll) );
		}
		label$741:;
		label$740:;
		...
		{
			VA$1 = *(struct $6IRVREG**)((uint8*)V1$1 + 88ll);
			int64 vr$59 = (*(tmp$84*)((uint8*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V1_DCLASS$1 << (3ll & 63ll))) + 8ll))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V1_DCLASS$1 << (3ll & 63ll))), VA$1, V1$1, *(uint64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + 456ll) );
		...
		label$905:;
		int64 vr$68 = (*(tmp$84*)((uint8*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V1_DCLASS$1 << (3ll & 63ll))) + 8ll))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V1_DCLASS$1 << (3ll & 63ll))), V1$1, (struct $6IRVREG*)0ull, *(uint64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$173$2 * 56ll)) + 8ll) );
...
static void HFLUSHADDR( int64 OP$1, struct $6IRVREG* V1$1, struct $6IRVREG* VR$1 )
{
	...
	if( V1_TYP$1 != 4ll ) goto label$763;
	{
		...
		label$908:;
		(*(tmp$84*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V1_DCLASS$1 << (3ll & 63ll))))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (V1_DCLASS$1 << (3ll & 63ll))), V1$1, (struct $6IRVREG*)0ull, *(uint64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$176$2 * 56ll)) + 8ll) );
	}
	label$763:;
	label$762:;
	if( VR_TYP$1 != 4ll ) goto label$766;
	{
		...
		label$909:;
		(*(tmp$84*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (VR_DCLASS$1 << (3ll & 63ll))))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (VR_DCLASS$1 << (3ll & 63ll))), VR$1, (struct $6IRVREG*)0ull, *(uint64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$177$2 * 56ll)) + 8ll) );
	}
	label$766:;
	label$765:;
	{
...
static void HFLUSHMEM( int64 OP$1, struct $6IRVREG* V1$1, struct $6IRVREG* V2$1, int64 BYTES$1, void* EXTRA$1 )
{
	...
	HLOADIDX( V2$1 );
	{
		...
		if( (TMP$178$2 - 105ull) > 3ull ) goto label$775;
		goto *tmp$188[TMP$178$2 - 105ull];
		label$775:;
	}
	HFREEREG( V1$1, 0ll );
	HFREEREG( V2$1, 0ll );
...
static void HFLUSHDBG( int64 OP$1, struct $8FBSYMBOL* PROC$1, int64 EX$1, char* FILENAME$1 )
{
	label$781:;
	{
		...
		if( (TMP$179$2 - 113ull) > 3ull ) goto label$783;
		goto *tmp$189[TMP$179$2 - 113ull];
		label$783:;
	}
	label$782:;
}
...
static void HFREEREG( struct $6IRVREG* VREG$1, int64 FORCE$1 )
{
	...
	if( DIST$1 != 2147483647ll ) goto label$817;
	{
		...
		(*(tmp$86*)((uint8*)*(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (DCLASS$1 << (3ll & 63ll))) + 24ll))( *(struct $8REGCLASS**)((int64)(struct $8REGCLASS**)REGTB$ + (DCLASS$1 << (3ll & 63ll))), *(int64*)((uint8*)VREG$1 + 24ll) );
