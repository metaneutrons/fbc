...
struct $7ASTNODE* RTLTHREADCALL( struct $7ASTNODE* CALLEXPR$1 )
{
	...
	*(int64*)((uint8*)&ARGMODE$1 + 40ll) = 17ll;
	...
	fb_ArrayRedimEx( (struct $7FBARRAYIvE*)&ARGMODE$1, 8ull, -1, 0, 1ull, 1ll, ARGUPPER$1 );
	{
		...
		I$2 = I$2 + 1ll;
		label$92:;
		if( I$2 <= TMP$91$2 ) goto label$95;
		label$94:;
	}
	ASTDELTREE( CALLEXPR$1 );
	struct $7ASTNODE* EXPR$1;
	struct $8FBSYMBOL* vr$28 = RTLPROCLOOKUP( (char*)"fb_ThreadCall", 366ll );
	...
	PARAM$1 = TMP$93$1;
	{
		...
		I$2 = I$2 + 1ll;
		label$112:;
		if( I$2 <= TMP$94$2 ) goto label$115;
		label$114:;
	}
		...
		{
			{
				...
				label$140:;
				TMP$89$4 = *(uint64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$88$4 * 56ll)) + 40ll);
				goto label$50;
				label$51:;
				{
					fb$result$1 = 2ll;
