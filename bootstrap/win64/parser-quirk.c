...
int64 CQUIRKSTMT( $8FB_TOKEN TK$1 )
{
	...
	RES$1 = 0ll;
	{
		...
		goto label$27;
		label$28:;
		static const void* tmp$96[259ll] = {
			&&label$83,
			&&label$27,
			&&label$27,
			&&label$27,
		...
		if( (TMP$95$2 - 260ull) > 258ull ) goto label$27;
...
struct $7ASTNODE* CQUIRKFUNCTION( struct $8FBSYMBOL* SYM$1 )
{
	...
	if( (*(int64*)((uint8*)&PARSER$ + 304ll) & 1024ll) == 0ll ) goto label$94;
	{
		...
		if( ((int64)-(vr$3 != 40ll) & ((int64)-(TK$1 != 336ll) | (int64)-(vr$6 != 301ll))) == 0ll ) goto label$96;
		{
			...
			struct $7ASTNODE* vr$15 = ASTNEWCONSTSTR( (char*)*(char**)&TMP$97$3 );
			FUNCEXPR$1 = vr$15;
	...
	label$93:;
	{
		...
		goto label$97;
		label$98:;
		static const void* tmp$99[184ll] = {
			&&label$111,
			&&label$97,
			&&label$97,
			&&label$97,
		...
		if( (TMP$98$2 - 336ull) > 183ull ) goto label$97;
