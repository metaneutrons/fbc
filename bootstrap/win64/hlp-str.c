...
char* HREESCAPE( char* TEXT$1, int64* TEXTLEN$1, int64* ISUNICODE$1 )
{
	char* fb$result$1;
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$132:;
			...
			*DST$1 = (uint8)27u;
			...
			SRC$1 = (char*)((uint8*)SRC$1 + 1ll);
			{
				...
				label$207:;
				{
					...
					*DST$1 = (uint8)27u;
					*(char*)((uint8*)DST$1 + 1ll) = (uint8)85u;
...
int64 HHASESCAPE( char* TEXT$1 )
{
	...
	{
		if( (int64)(uint8)*TEXT$1 != 92ll ) goto label$356;
		{
...
int64 HSTR2LONG( FBSTRING* TXT$1, int32* VALUE$1 )
{
	...
	TMP$113$1 = (int64)-((int64)*S$1 == 0ll);
	goto label$456;
	label$446:;
	TMP$113$1 = -1ll;
	label$456:;
	if( TMP$113$1 == 0ll ) goto label$448;
	{
		fb$result$1 = 0ll;
		goto label$443;
	}
	...
	TMP$114$1 = (int64)-((uint64)(int64)*S$1 >= 48ull);
	goto label$457;
	label$455:;
	TMP$114$1 = 0ll;
	label$457:;
	if( TMP$114$1 == 0ll ) goto label$454;
	{
...
void HSPLITSTR( FBSTRING* TXT$1, FBSTRING* DEL$1, struct $7FBARRAYI8FBSTRINGE* RES$1 )
{
	...
	*(int64*)((uint8*)&DPOS$1 + 40ll) = 17ll;
	...
	label$460:;
	{
		...
		P$1 = vr$4;
		if( P$1 <= 0ll ) goto label$464;
		{
			if( CNT$1 < ITEMS$1 ) goto label$466;
			{
	...
	label$462:;
	if( P$1 != 0ll ) goto label$460;
	label$461:;
	CNT$1 = CNT$1 + -1ll;
	if( CNT$1 != 0ll ) goto label$468;
	{
...
int64 HSTR2TOK( char* TXT$1, struct $7FBARRAYI8FBSTRINGE* RES$1 )
{
	...
	S$1 = (uint8*)TXT$1;
	label$473:;
	if( (int64)*S$1 == 0ll ) goto label$474;
	{
		uint64 C$2;
		C$2 = (uint64)*S$1;
		if( C$2 != 7ull ) goto label$476;
		{
			C$2 = 32ull;
		}
		label$476:;
		label$475:;
		if( C$2 != 32ull ) goto label$478;
		{
			if( LC$1 == 32ull ) goto label$480;
			{
				T$1 = T$1 + 1ll;
			}
			label$480:;
	...
	goto label$473;
	label$474:;
	if( LC$1 == 32ull ) goto label$482;
	{
		T$1 = T$1 + 1ll;
	}
	label$482:;
	label$481:;
	if( T$1 != 0ll ) goto label$484;
	{
		fb$result$1 = 0ll;
		goto label$472;
	}
	...
	S$1 = (uint8*)TXT$1;
	label$485:;
	if( (int64)*S$1 == 0ll ) goto label$486;
	{
		uint64 C$2;
		C$2 = (uint64)*S$1;
		if( C$2 != 7ull ) goto label$488;
		{
			C$2 = 32ull;
		}
		label$488:;
		label$487:;
		if( C$2 != 32ull ) goto label$490;
		{
			if( LC$1 == 32ull ) goto label$492;
			{
				T$1 = T$1 + 1ll;
			}
			label$492:;
		...
		label$490:;
		{
			...
			FBSTRING* vr$21 = fb_StrConcat( &TMP$115$3, (void*)((T$1 * 24ll) + *(int64*)RES$1), -1ll, (void*)vr$14, -1ll );
	...
	goto label$485;
	label$486:;
	if( LC$1 == 32ull ) goto label$493;
	TMP$116$1 = T$1 + 1ll;
	goto label$494;
	label$493:;
	TMP$116$1 = T$1;
	label$494:;
	fb$result$1 = TMP$116$1;
	label$472:;
	return fb$result$1;
}
...
int64 HSTR2ARGS( char* TXT$1, struct $7FBARRAYI8FBSTRINGE* RES$1 )
{
	...
	int64 MAX_T$1;
	MAX_T$1 = 10ll;
	if( TXT$1 != (char*)0ull ) goto label$498;
	{
		fb$result$1 = 0ll;
		goto label$496;
	}
	...
	{
		C$1 = (uint64)*S$1;
		if( ((int64)-(C$1 == 9ull) | (int64)-(C$1 == 32ull)) == 0ll ) goto label$503;
		{
			S$1 = (uint8*)((uint8*)S$1 + 1ll);
		}
		goto label$502;
	...
	label$506:;
	{
		...
		C$1 = (uint64)*S$1;
		{
			...
			goto label$509;
			label$512:;
			if( C$1 != 41ull ) goto label$514;
			label$515:;
			{
				if( PRNTCNT$1 <= 0ll ) goto label$517;
				{
					PRNTCNT$1 = PRNTCNT$1 + -1ll;
				}
				label$517:;
			...
			goto label$509;
			label$514:;
			if( C$1 != 44ull ) goto label$518;
			label$519:;
			{
				if( PRNTCNT$1 != 0ll ) goto label$521;
				{
					T$1 = T$1 + 1ll;
					if( T$1 <= MAX_T$1 ) goto label$523;
					{
			...
			goto label$509;
			label$518:;
			if( C$1 == 34ull ) goto label$525;
			label$526:;
			if( C$1 == 33ull ) goto label$525;
			label$527:;
			if( C$1 != 36ull ) goto label$524;
			label$525:;
			{
				FBSTRING TMP$118$4;
				int64 ESCAPED$4;
				ESCAPED$4 = *(int64*)((uint8*)&ENV$ + 1528ll);
				if( C$1 == 34ull ) goto label$529;
				{
					FBSTRING TMP$117$5;
					ESCAPED$4 = (int64)-(C$1 == 33ull);
					FBSTRING* vr$18 = fb_CHR( 1, (int64)C$1 );
					__builtin_memset( &TMP$117$5, 0, 24ll );
					FBSTRING* vr$25 = fb_StrConcat( &TMP$117$5, (void*)((uint8*)((T$1 * 24ll) + *(int64*)RES$1) + -24ll), -1ll, (void*)vr$18, -1ll );
					fb_StrAssign( (void*)((uint8*)((T$1 * 24ll) + *(int64*)RES$1) + -24ll), -1ll, (void*)vr$25, -1ll, 0 );
					S$1 = (uint8*)((uint8*)S$1 + 1ll);
					C$1 = (uint64)*S$1;
					if( C$1 == 34ull ) goto label$531;
					{
						goto label$508;
					}
					label$531:;
				...
				FBSTRING* vr$40 = fb_StrConcat( &TMP$118$4, (void*)((uint8*)((T$1 * 24ll) + *(int64*)RES$1) + -24ll), -1ll, (void*)vr$33, -1ll );
				...
				label$532:;
				{
					...
					FBSTRING* vr$55 = fb_StrConcat( &TMP$119$5, (void*)((uint8*)((T$1 * 24ll) + *(int64*)RES$1) + -24ll), -1ll, (void*)vr$48, -1ll );
					...
					if( C$1 != 34ull ) goto label$538;
					{
						...
						FBSTRING* vr$70 = fb_StrConcat( &TMP$120$6, (void*)((uint8*)((T$1 * 24ll) + *(int64*)RES$1) + -24ll), -1ll, (void*)vr$63, -1ll );
						fb_StrAssign( (void*)((uint8*)((T$1 * 24ll) + *(int64*)RES$1) + -24ll), -1ll, (void*)vr$70, -1ll, 0 );
						S$1 = (uint8*)((uint8*)S$1 + 1ll);
					}
					goto label$537;
					label$538:;
					if( C$1 != 92ull ) goto label$541;
					{
						C$1 = (uint64)*S$1;
						{
							if( C$1 == 34ull ) goto label$544;
							label$545:;
							if( C$1 != 92ull ) goto label$543;
							label$544:;
							{
								FBSTRING TMP$121$8;
								FBSTRING* vr$78 = fb_CHR( 1, (int64)C$1 );
								__builtin_memset( &TMP$121$8, 0, 24ll );
								FBSTRING* vr$85 = fb_StrConcat( &TMP$121$8, (void*)((uint8*)((T$1 * 24ll) + *(int64*)RES$1) + -24ll), -1ll, (void*)vr$78, -1ll );
			...
			label$547:;
			{
				...
				FBSTRING* vr$98 = fb_StrConcat( &TMP$122$4, (void*)((uint8*)((T$1 * 24ll) + *(int64*)RES$1) + -24ll), -1ll, (void*)vr$91, -1ll );
				fb_StrAssign( (void*)((uint8*)((T$1 * 24ll) + *(int64*)RES$1) + -24ll), -1ll, (void*)vr$98, -1ll, 0 );
				S$1 = (uint8*)((uint8*)S$1 + 1ll);
				C$1 = (uint64)*S$1;
				if( C$1 == 39ull ) goto label$549;
				{
					goto label$508;
				}
				label$549:;
				...
				FBSTRING* vr$113 = fb_StrConcat( &TMP$123$4, (void*)((uint8*)((T$1 * 24ll) + *(int64*)RES$1) + -24ll), -1ll, (void*)vr$106, -1ll );
				...
				label$550:;
				{
					...
					FBSTRING* vr$128 = fb_StrConcat( &TMP$124$5, (void*)((uint8*)((T$1 * 24ll) + *(int64*)RES$1) + -24ll), -1ll, (void*)vr$121, -1ll );
					fb_StrAssign( (void*)((uint8*)((T$1 * 24ll) + *(int64*)RES$1) + -24ll), -1ll, (void*)vr$128, -1ll, 0 );
					S$1 = (uint8*)((uint8*)S$1 + 1ll);
					if( C$1 != 39ull ) goto label$556;
					{
						C$1 = (uint64)*S$1;
						if( C$1 != 47ull ) goto label$558;
						{
							FBSTRING TMP$125$7;
							FBSTRING* vr$136 = fb_CHR( 1, (int64)C$1 );
							__builtin_memset( &TMP$125$7, 0, 24ll );
							FBSTRING* vr$143 = fb_StrConcat( &TMP$125$7, (void*)((uint8*)((T$1 * 24ll) + *(int64*)RES$1) + -24ll), -1ll, (void*)vr$136, -1ll );
			...
			goto label$509;
			label$546:;
			if( C$1 != 39ull ) goto label$559;
			label$560:;
			{
				label$561:;
				if( C$1 == 0ull ) goto label$562;
				{
					FBSTRING TMP$126$5;
					FBSTRING* vr$149 = fb_CHR( 1, (int64)C$1 );
					__builtin_memset( &TMP$126$5, 0, 24ll );
					FBSTRING* vr$156 = fb_StrConcat( &TMP$126$5, (void*)((uint8*)((T$1 * 24ll) + *(int64*)RES$1) + -24ll), -1ll, (void*)vr$149, -1ll );
		...
		FBSTRING* vr$171 = fb_StrConcat( &TMP$127$2, (void*)((uint8*)((T$1 * 24ll) + *(int64*)RES$1) + -24ll), -1ll, (void*)vr$164, -1ll );
...
static int64 HREMAPCHAR( int64 CHAR$1 )
{
	...
	label$339:;
	{
		...
		goto label$341;
		label$342:;
		static const void* tmp$128[22ll] = {
			&&label$347,
			&&label$346,
			&&label$350,
			&&label$350,
