	...
	label$104:;
	{
		...
		label$107:;
		{
			...
			label$123:;
			{
				{
					int64 TMP$111$5;
					TMP$111$5 = *(int64*)((uint8*)SYM$2 + 56ll) & 511ll;
					if( TMP$111$5 != 20ll ) goto label$125;
					label$126:;
					{
					...
					goto label$124;
					label$125:;
					if( TMP$111$5 != 10ll ) goto label$129;
					label$130:;
					{
						SYM$2 = *(struct $8FBSYMBOL**)((uint8*)SYM$2 + 64ll);
					}
			...
			if( (TMP$110$3 - 8ull) > 5ull ) goto label$132;
			goto *tmp$114[TMP$110$3 - 8ull];
			label$117:;
		}
		...
		label$151:;
		{
			...
			if( TMP$112$3 > 5ull ) goto label$161;
			goto *tmp$115[TMP$112$3 - 0ull];
			label$153:;
		}
		...
		{
			{
				$12FB_SYMBCLASS TMP$113$4;
				TMP$113$4 = *($12FB_SYMBCLASS*)PARENT$1;
				if( TMP$113$4 == 10ll ) goto label$178;
				label$179:;
				if( TMP$113$4 != 11ll ) goto label$177;
				label$178:;
				{
	...
	if( CHAIN_$1 == (struct $10FBSYMCHAIN*)0ull ) goto label$201;
	{
		SYM$1 = *(struct $8FBSYMBOL**)CHAIN_$1;
		{
			...
			label$208:;
			{
				{
					int64 TMP$117$5;
					TMP$117$5 = *(int64*)((uint8*)SYM$1 + 56ll) & 511ll;
					if( TMP$117$5 != 20ll ) goto label$210;
					label$211:;
					{
					...
					goto label$209;
					label$210:;
					if( TMP$117$5 != 10ll ) goto label$214;
					label$215:;
					{
						SYM$1 = *(struct $8FBSYMBOL**)((uint8*)SYM$1 + 64ll);
					}
			...
			if( (TMP$116$3 - 8ull) > 5ull ) goto label$217;
			goto *tmp$119[TMP$116$3 - 8ull];
			label$202:;
		}
		...
		label$232:;
		{
			...
			if( TMP$118$3 > 5ull ) goto label$240;
			goto *tmp$120[TMP$118$3 - 0ull];
			label$234:;
		}
...
void CCURRENTPARENTID( void )
{
	...
	label$249:;
	{
		...
		TMP$121$2 = *($12FB_SYMBCLASS*)S$1;
		if( TMP$121$2 != 8ll ) goto label$252;
		label$253:;
		{
		...
		goto label$251;
		label$252:;
		if( TMP$121$2 != 11ll ) goto label$256;
		label$257:;
		{
...
struct $8FBSYMBOL* CIDENTIFIERORUDTMEMBER( struct $8FBSYMBOL** BASE_PARENT$1, struct $10FBSYMCHAIN* CHAIN_$1 )
{
	...
	if( CHAIN_$1 != (struct $10FBSYMCHAIN*)0ull ) goto label$263;
	{
		...
		label$265:;
		{
			...
			{
				struct $8FBSYMBOL* TMP$122$4;
				TMP$122$4 = (struct $8FBSYMBOL*)0ull;
				struct $10FBSYMCHAIN* vr$7 = CIDENTIFIER( &TMP$122$4, 664ll );
				CHAIN_$1 = vr$7;
			}
			label$267:;
			label$266:;
	...
	label$272:;
	{
		...
		label$277:;
		{
			...
			label$278:;
			{
				...
				goto label$282;
				label$283:;
				static const void* tmp$125[71ll] = {
					&&label$284,
					&&label$285,
					&&label$282,
					&&label$282,
				...
				if( (TMP$124$4 - 347ull) > 70ull ) goto label$282;
				goto *tmp$125[TMP$124$4 - 347ull];
				label$282:;
			}
			LEXSKIPTOKEN( 0ll );
			fb$result$1 = SYM$3;
		...
		if( TMP$123$2 > 2ull ) goto label$274;
		goto *tmp$126[TMP$123$2 - 0ull];
		label$274:;
	}
...
static FBSTRING* HGETCHAINNAMES( struct $10FBSYMCHAIN* CHAIN_$1 )
{
	...
	label$40:;
	{
		...
		if( NS$1 == (struct $8FBSYMBOL*)((uint8*)&SYMB$ + 196704ll) ) goto label$44;
		{
			if( (*(int64*)((uint8*)NS$1 + 8ll) & 16777216ll) == 0ll ) goto label$46;
			{
				if( *(int64*)NS$1 != 9ll ) goto label$48;
				{
					...
					FBSTRING* vr$13 = fb_StrConcat( &TMP$97$5, (void*)"<enum>.", 8ll, (void*)&S$2, -1ll );
				...
				label$48:;
				{
					...
					FBSTRING* vr$18 = fb_StrConcat( &TMP$99$5, (void*)"<unknown>.", 11ll, (void*)&S$2, -1ll );
			...
			label$46:;
			{
				...
				FBSTRING* vr$24 = fb_StrConcat( &TMP$100$4, *(void**)((uint8*)NS$1 + 32ll), 0ll, (void*)".", 2ll );
				__builtin_memset( &TMP$101$4, 0, 24ll );
				FBSTRING* vr$27 = fb_StrConcat( &TMP$101$4, (void*)vr$24, -1ll, (void*)&S$2, -1ll );
		...
		label$52:;
		{
			...
			FBSTRING* vr$43 = fb_StrConcat( &TMP$103$3, (void*)&S$2, -1ll, *(void**)((uint8*)*(struct $8FBSYMBOL**)CHAIN_$1 + 32ll), 0ll );
			__builtin_memset( &TMP$104$3, 0, 24ll );
			FBSTRING* vr$47 = fb_StrConcat( &TMP$104$3, (void*)&NAMES$1, -1ll, (void*)vr$43, -1ll );
			...
			if( CHAIN_$1 == (struct $10FBSYMCHAIN*)0ull ) goto label$68;
			{
				if( *(struct $10FBSYMCHAIN**)((uint8*)CHAIN_$1 + 8ll) == (struct $10FBSYMCHAIN*)0ull ) goto label$70;
				{
					if( *(int64*)((uint8*)CHAIN_$1 + 16ll) == 0ll ) goto label$72;
					{
						...
						label$292:;
						if( TMP$106$6 == 0ll ) goto label$75;
						{
							FBSTRING TMP$108$7;
							FBSTRING TMP$109$7;
							...
							FBSTRING* vr$21 = fb_StrConcat( &TMP$108$7, (void*)" for ", 6ll, (void*)vr$18, -1ll );
							fb_StrAssign( (void*)&TMP$109$7, -1ll, (void*)vr$21, -1ll, 0 );
							ERRREPORT( 255ll, 0ll, (char*)*(char**)&TMP$109$7 );
							fb_StrDelete( (FBSTRING*)&TMP$109$7 );
						}
						label$75:;
						label$74:;
					}
