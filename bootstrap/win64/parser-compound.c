...
void CEXITSTATEMENT( void )
{
	...
	TK$1 = vr$1;
	{
		...
		label$116:;
		{
			...
			if( LABEL$1 != (struct $8FBSYMBOL*)0ull ) goto label$120;
			{
				...
				__builtin_memset( &ERRMSG$4, 0, 8ll );
				{
					...
					if( (TMP$100$5 - 345ull) > 5ull ) goto label$128;
			...
			ERRNUM$3 = 0ll;
			{
				...
				if( (TMP$101$4 - 345ull) > 5ull ) goto label$129;
		...
		if( (TMP$99$2 - 270ull) > 80ull ) goto label$155;
...
void CCONTINUESTATEMENT( void )
{
	...
	LEXSKIPTOKEN( 2048ll );
	{
		...
		if( (TMP$105$2 - 273ull) > 8ull ) goto label$187;
...
int64 CCOMPSTMTCHECK( void )
{
	...
	label$203:;
	{
		...
		{
			{
				...
				if( (TMP$109$4 - 345ull) > 5ull ) goto label$214;
		...
		if( (TMP$108$2 - 266ull) > 80ull ) goto label$205;
	...
	*(struct $7ASTNODE**)((uint8*)STK$1 + 16ll) = (struct $7ASTNODE*)0ull;
	{
		...
		if( (TMP$112$2 - 270ull) > 76ull ) goto label$227;
		...
		if( SHOWERROR$1 == 0ll ) goto label$242;
		{
			...
			label$244:;
			{
				static int64 ERRMSG$4;
				{
					...
					if( (TMP$114$5 - 266ull) > 80ull ) goto label$245;
...
void CCOMPSTMTPOP( struct $13FB_CMPSTMTSTK* STK$1 )
{
	label$257:;
	{
		...
		if( (TMP$116$2 - 270ull) > 76ull ) goto label$259;
...
static void CCOMPOUNDEND( void )
{
	label$188:;
	{
		...
		if( (TMP$107$2 - 266ull) > 84ull ) goto label$200;
