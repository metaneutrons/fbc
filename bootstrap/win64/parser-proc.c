				...
				{
					{
						...
						if( TMP$105$6 == 3ll ) goto label$160;
						label$161:;
						if( TMP$105$6 != 5ll ) goto label$159;
						label$160:;
						{
...
$21FB_PROC_RETURN_METHOD CPROCRETURNMETHOD( $11FB_DATATYPE DTYPE$1 )
{
	...
	label$182:;
	if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$106$1 * 56ll)) == 1ll ) goto label$170;
	{
...
$11FB_FUNCMODE CPROCCALLINGCONV( $11FB_FUNCMODE DEFAULT$1, int64* IS_EXPLICIT$1 )
{
	...
	*IS_EXPLICIT$1 = 0ll;
	...
	label$185:;
	{
		...
		if( (TMP$109$2 - 381ull) > 4ull ) goto label$187;
		goto *tmp$111[TMP$109$2 - 381ull];
		label$187:;
	}
	if( *IS_EXPLICIT$1 != 0ll ) goto label$199;
	{
		{
			uint64 TMP$110$3;
			TMP$110$3 = *(uint64*)((uint8*)&PARSER$ + 208ll);
			goto label$201;
			label$202:;
			{
			...
			if( TMP$110$3 > 6ull ) goto label$200;
			goto *tmp$112[TMP$110$3 - 0ull];
			label$200:;
		}
	}
	label$199:;
...
struct $8FBSYMBOL* CPROCHEADER( $13FB_SYMBATTRIB ATTRIB$1, $13FB_PROCATTRIB PATTRIB$1, int64* IS_NESTED$1, $10FB_PROCOPT OPTIONS$1, int64 TK$1 )
{
	...
	label$448:;
	{
		...
		label$467:;
		{
			...
			label$475:;
			{
				...
				if( (TMP$134$4 - 18ull) > 3ull ) goto label$488;
	...
	*($13FB_PROCATTRIB*)((uint8*)PROC$1 + 16ll) = PATTRIB$1;
	CPARAMETERS( PARENT$1, PROC$1, MODE$1, (int64)-((OPTIONS$1 & 1ll) != 0ll) );
	{
		...
		label$563:;
		{
			if( IS_MEMBERPROC$1 == 0ll ) goto label$571;
			{
				...
				TMP$135$4 = -1ll;
				label$696:;
				if( TMP$135$4 == 0ll ) goto label$574;
				{
					PATTRIB$1 = PATTRIB$1 | 1ll;
				}
				label$574:;
	...
	label$585:;
	{
		...
		TMP$136$2 = vr$155;
		if( TMP$136$2 == 347ll ) goto label$606;
		label$607:;
		if( TMP$136$2 != 348ll ) goto label$605;
		label$606:;
		{
		...
		{
			{
				...
				label$654:;
				{
					...
					TMP$137$5 = 0ll;
					label$697:;
					struct $8FBSYMBOL* vr$201 = SYMBFINDOVERLOADPROC( HEAD_PROC$1, PROC$1, TMP$137$5 );
					HEAD_PROC$1 = vr$201;
				}
				label$656:;
				label$651:;
...
void HDISALLOWCONSTCTORDTOR( int64 TK$1, $13FB_SYMBATTRIB* ATTRIB$1, $13FB_PROCATTRIB* PATTRIB$1 )
{
	...
	if( (*(int64*)ATTRIB$1 & 2048ll) == 0ll ) goto label$715;
	{
		...
		TMP$139$2 = 315ll;
		label$717:;
		ERRREPORT( TMP$139$2, 0ll, (char*)0ull );
...
void CPROCSTMTBEGIN( $13FB_SYMBATTRIB ATTRIB$1, $13FB_PROCATTRIB PATTRIB$1 )
{
	...
	TKN$1 = vr$5;
	{
		...
		if( (TMP$140$2 - 345ull) > 5ull ) goto label$739;
	...
	{
		{
			...
			if( TMP$142$3 != 345ll ) goto label$755;
			label$756:;
			{
			...
			goto label$754;
			label$755:;
			if( TMP$142$3 != 346ll ) goto label$757;
			label$758:;
			{
			...
			goto label$754;
			label$757:;
			if( TMP$142$3 != 347ll ) goto label$759;
			label$760:;
			{
			...
			goto label$754;
			label$759:;
			if( TMP$142$3 != 348ll ) goto label$761;
			label$762:;
			{
			...
			goto label$754;
			label$761:;
			if( TMP$142$3 != 349ll ) goto label$763;
			label$764:;
			{
			...
			goto label$754;
			label$763:;
			if( TMP$142$3 != 350ll ) goto label$765;
			label$766:;
			{
...
static void HCHECKPROTOTYPE( struct $8FBSYMBOL* PROTO$1, struct $8FBSYMBOL* PROC$1, char* PALIAS$1, int64 PROC_DTYPE$1, struct $8FBSYMBOL* PROC_SUBTYPE$1, int64 MODE$1 )
{
	...
	if( ((int64)-(PALIAS$1 != (char*)0ull) & (int64)-((*(int64*)((uint8*)PROTO$1 + 24ll) & 512ll) != 0ll)) == 0ll ) goto label$50;
	{
		...
		if( (int64)vr$6 == 0ll ) goto label$52;
		{
			...
			ERRREPORTEX( 311ll, (char*)*(char**)&TMP$99$3, 0ll, 1ll, (char*)0ull );
...
static int64 HCHECKOPOVLPARAMS( struct $8FBSYMBOL* PARENT$1, int64 OP$1, struct $8FBSYMBOL* PROC$1 )
{
	...
	{
		uint64 TMP$115$2;
		TMP$115$2 = *(uint64*)((int64)(struct $10AST_OPINFO*)AST_OPTB$ + (OP$1 << (5ll & 63ll)));
		goto label$233;
		label$234:;
		{
			int64 TMP$116$3;
		...
		if( (TMP$115$2 - 2ull) > 12ull ) goto label$243;
	...
	if( PARAMS$1 <= 0ll ) goto label$249;
	{
		...
		{
			uint64 TMP$119$3;
			TMP$119$3 = *(uint64*)((int64)(struct $10AST_OPINFO*)AST_OPTB$ + (OP$1 << (5ll & 63ll)));
			goto label$255;
			label$256:;
			{
				{
					...
					if( TMP$120$5 == 20ll ) goto label$259;
					label$260:;
					if( TMP$120$5 != 10ll ) goto label$258;
					label$259:;
					{
					}
					goto label$257;
			...
			label$262:;
			{
				if( PARAMS$1 <= 1ll ) goto label$264;
				{
					...
					label$267:;
					{
						...
						if( TMP$121$6 == 20ll ) goto label$271;
						label$272:;
						if( TMP$121$6 != 10ll ) goto label$270;
						label$271:;
						{
						}
						goto label$269;
						...
						{
							{
								...
								if( TMP$122$8 == 20ll ) goto label$276;
								label$277:;
								if( TMP$122$8 != 10ll ) goto label$275;
								label$276:;
								{
								}
								goto label$274;
			...
			{
				{
					...
					label$282:;
					{
						...
						label$781:;
						if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$123$6 * 56ll)) != 0ll ) goto label$286;
						{
							int64 IS_INTEGER$7;
							IS_INTEGER$7 = -1ll;
							...
							label$287:;
							{
								...
								if( TMP$124$8 == 4ll ) goto label$291;
								label$292:;
								if( TMP$124$8 != 7ll ) goto label$290;
								label$291:;
								{
									IS_INTEGER$7 = 0ll;
								}
					...
					label$281:;
					{
						...
						label$782:;
						if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$125$6 * 56ll)) != 0ll ) goto label$298;
						{
			...
			{
				{
					...
					label$304:;
					{
						if( PARAMS$1 <= 1ll ) goto label$306;
						{
							...
							label$309:;
							{
								...
								if( TMP$127$8 == 20ll ) goto label$313;
								label$314:;
								if( TMP$127$8 != 10ll ) goto label$312;
								label$313:;
								{
								}
								goto label$311;
								...
								{
									{
										...
										if( TMP$128$10 == 20ll ) goto label$318;
										label$319:;
										if( TMP$128$10 != 10ll ) goto label$317;
										label$318:;
										{
										}
										goto label$316;
					...
					if( (TMP$126$5 - 24ull) > 26ull ) goto label$336;
			...
			if( (TMP$119$3 - 3ull) > 11ull ) goto label$254;
	...
	FOUND_MISMATCH$1 = 0ll;
	{
		...
		TMP$129$2 = *($13AST_NODECLASS*)((int64)(struct $10AST_OPINFO*)AST_OPTB$ + (OP$1 << (5ll & 63ll)));
		if( TMP$129$2 != 5ll ) goto label$338;
		label$339:;
		{
		...
		goto label$337;
		label$338:;
		if( TMP$129$2 != 4ll ) goto label$342;
		label$343:;
		{
			FOUND_MISMATCH$1 = (int64)-((*(int64*)((uint8*)PROC$1 + 56ll) & 511ll) == 0ll);
		}
		goto label$337;
		label$342:;
		if( TMP$129$2 != 2ll ) goto label$344;
		label$345:;
		{
			FOUND_MISMATCH$1 = (int64)-((*(int64*)((uint8*)PROC$1 + 56ll) & 511ll) != 0ll);
		}
		goto label$337;
		label$344:;
		if( TMP$129$2 != 6ll ) goto label$346;
		label$347:;
		{
			{
		...
		goto label$337;
		label$346:;
		if( TMP$129$2 != 12ll ) goto label$354;
		label$355:;
		{
			{
		...
		goto label$337;
		label$354:;
		if( TMP$129$2 != 3ll ) goto label$361;
		label$362:;
		{
			{
				uint64 TMP$130$4;
				...
				if( (TMP$130$4 - 23ull) > 27ull ) goto label$367;
		...
		goto label$337;
		label$361:;
		if( TMP$129$2 != 14ll ) goto label$370;
		label$371:;
		{
...
static int64 HCHECKISSELFCLONEBYVAL( struct $8FBSYMBOL* PARENT$1, struct $8FBSYMBOL* PROC$1, int64 OPTIONS$1 )
{
	...
	label$783:;
	if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$131$1 * 56ll)) != 0ll ) goto label$392;
	{
...
static void HCHECKPROPPARAMS( struct $8FBSYMBOL* PROC$1, int64 IS_GET$1 )
{
	...
	if( ((int64)-((int64)*(int16*)((uint8*)PROC$1 + 120ll) < (MIN_PARAMS$1 + 1ll)) | (int64)-((int64)*(int16*)((uint8*)PROC$1 + 120ll) > (MAX_PARAMS$1 + 1ll))) == 0ll ) goto label$404;
	{
		...
		TMP$132$2 = 191ll;
		label$784:;
		ERRREPORT( TMP$132$2, -1ll, (char*)0ull );
	}
	label$404:;
	label$403:;
	PARAM$1 = *(struct $8FBSYMBOL**)((uint8*)PROC$1 + 136ll);
