...
static struct $7SYMBKWD KWDTB$[24] = { { (char*)"IF", 266ll }, { (char*)"IFDEF", 267ll }, { (char*)"IFNDEF", 268ll }, { (char*)"ELSE", 269ll }, { (char*)"ELSEIF", 270ll }, { (char*)"ENDIF", 271ll }, { (char*)"DEFINE", 272ll }, { (char*)"UNDEF", 273ll }, { (char*)"MACRO", 274ll }, { (char*)"ENDMACRO", 275ll }, { (char*)"INCLUDE", 276ll }, { (char*)"LIBPATH", 278ll }, { (char*)"INCLIB", 277ll }, { (char*)"PRAGMA", 279ll }, { (char*)"PRINT", 280ll }, { (char*)"ERROR", 281ll }, { (char*)"LINE", 282ll }, { (char*)"LANG", 283ll }, { (char*)"ASSERT", 284ll }, { (char*)"CMDLINE", 285ll }, { (char*)"DUMP", 286ll }, { (char*)"ODUMP", 287ll }, { (char*)"LOOKUP", 288ll }, { (char*)0ull } };
struct $6PP_CTX PP$;
...
void PPPARSE( void )
{
	label$40:;
	{
					...
					label$52:;
					{
						if( *(int64*)((uint8*)&ENV$ + 1192ll) <= 0ll ) goto label$54;
						{
							if( *(int64*)SYM$4 == 5ll ) goto label$56;
							{
								...
								fb_StrAssign( (void*)&TMP$120$8, -1ll, (void*)"#undef", 7ll, 0 );
								LEXPPONLYEMITTEXT( &TMP$120$8 );
								fb_StrDelete( (FBSTRING*)&TMP$120$8 );
								LEXPPONLYEMITTOKEN(  );
							}
							label$56:;
							label$55:;
		...
		if( (TMP$118$2 - 266ull) > 22ull ) goto label$73;
		goto *tmp$121[TMP$118$2 - 266ull];
		label$42:;
	}
	CCOMMENT( 0ll );
	...
	{
		{
			...
			label$138:;
			{
				...
				label$141:;
				{
					LEXSKIPTOKEN( 63ll );
					{
						...
						TMP$135$6 = vr$2;
						if( TMP$135$6 == 257ll ) goto label$146;
						label$147:;
						if( TMP$135$6 != 256ll ) goto label$145;
						label$146:;
						{
							goto label$142;
						}
			...
			{
				{
					...
					TMP$136$5 = vr$3;
					if( TMP$136$5 != 35ll ) goto label$150;
					label$151:;
					{
						LEXSKIPTOKEN( 62ll );
						LEXSKIPTOKEN( 63ll );
					...
					goto label$149;
					label$150:;
					if( TMP$136$5 != 274ll ) goto label$154;
					label$155:;
					{
					...
					goto label$149;
					label$154:;
					if( TMP$136$5 != 275ll ) goto label$158;
					label$159:;
					{
			...
			label$167:;
			{
				...
				fb_StrAssign( (void*)&TMP$140$4, -1ll, (void*)vr$10, -1ll, 0 );
				DZSTRCONCATASSIGN( &TEXT$1, (char*)*(char**)&TMP$140$4 );
				fb_StrDelete( (FBSTRING*)&TMP$140$4 );
				goto label$126;
			}
			goto label$128;
			label$129:;
			static const void* tmp$141[369ll] = {
				&&label$164,
				&&label$128,
				&&label$128,
				&&label$128,
			...
			if( (TMP$133$3 - 9ull) > 368ull ) goto label$128;
			goto *tmp$141[TMP$133$3 - 9ull];
			label$128:;
		}
	...
	{
		{
			...
			label$188:;
			{
				...
				if( *(int64*)((uint8*)&TEXT$1 + 8ll) <= 0ll ) goto label$192;
				{
					...
					TMP$144$5 = vr$2;
					DWSTRCONCATASSIGN( &TEXT$1, (uint16*)TMP$144$5 );
			...
			label$193:;
			{
				...
				label$196:;
				{
					LEXSKIPTOKEN( 63ll );
					{
						...
						TMP$145$6 = vr$3;
						if( TMP$145$6 == 257ll ) goto label$201;
						label$202:;
						if( TMP$145$6 != 256ll ) goto label$200;
						label$201:;
						{
							goto label$197;
						}
			...
			{
				{
					...
					TMP$146$5 = vr$4;
					if( TMP$146$5 != 35ll ) goto label$205;
					label$206:;
					{
						LEXSKIPTOKEN( 62ll );
						LEXSKIPTOKEN( 63ll );
					...
					goto label$204;
					label$205:;
					if( TMP$146$5 != 274ll ) goto label$209;
					label$210:;
					{
					...
					goto label$204;
					label$209:;
					if( TMP$146$5 != 275ll ) goto label$213;
					label$214:;
					{
			...
			label$219:;
			{
				if( *(int64*)((uint8*)&TEXT$1 + 8ll) <= 0ll ) goto label$221;
				{
					...
					TMP$147$5 = vr$10;
					DWSTRCONCATASSIGN( &TEXT$1, (uint16*)TMP$147$5 );
			...
			label$222:;
			{
				...
				fb_StrAssign( (void*)&TMP$148$4, -1ll, (void*)vr$12, -1ll, 0 );
				DWSTRCONCATASSIGNA( &TEXT$1, (char*)*(char**)&TMP$148$4 );
				fb_StrDelete( (FBSTRING*)&TMP$148$4 );
				goto label$181;
			}
			goto label$183;
			label$184:;
			static const void* tmp$149[369ll] = {
				&&label$219,
				&&label$183,
				&&label$183,
				&&label$183,
			...
			if( (TMP$143$3 - 9ull) > 368ull ) goto label$183;
			goto *tmp$149[TMP$143$3 - 9ull];
			label$183:;
		}
...
FBSTRING* PPTYPEOF( void )
{
	...
	TMP$150$1 = (struct $8FBSYMBOL*)0ull;
	CTYPEOF( &DTYPE$1, &SUBTYPE$1, &LGT$1, &IS_FIXLENSTR$1, &TMP$150$1 );
...
static void PPINCLIB( void )
{
	...
	if( *(int64*)((uint8*)&ENV$ + 1192ll) <= 0ll ) goto label$91;
	{
		...
		fb_StrAssign( (void*)&TMP$124$2, -1ll, (void*)"#inclib", 8ll, 0 );
...
static void PPLIBPATH( void )
{
	...
	if( *(int64*)((uint8*)&ENV$ + 1192ll) <= 0ll ) goto label$97;
	{
		...
		fb_StrAssign( (void*)&TMP$126$2, -1ll, (void*)"#libpath", 9ll, 0 );
		LEXPPONLYEMITTEXT( &TMP$126$2 );
...
static void PPLANG( void )
{
	...
	if( *(int64*)((uint8*)&ENV$ + 1192ll) <= 0ll ) goto label$111;
	{
		...
		FBSTRING* vr$7 = fb_StrConcat( &TMP$129$2, (void*)"#lang \x22", 8ll, (void*)vr$4, -1ll );
		__builtin_memset( &TMP$130$2, 0, 24ll );
		FBSTRING* vr$10 = fb_StrConcat( &TMP$130$2, (void*)vr$7, -1ll, (void*)"\x22", 2ll );
		fb_StrAssign( (void*)&TMP$131$2, -1ll, (void*)vr$10, -1ll, 0 );
		LEXPPONLYEMITTEXT( &TMP$131$2 );
	...
	{
		{
			...
			if( (TMP$132$3 - 9ull) > 23ull ) goto label$122;
			goto *tmp$157[TMP$132$3 - 9ull];
			label$119:;
		}
	...
	{
		{
			...
			if( (TMP$142$3 - 9ull) > 23ull ) goto label$177;
			goto *tmp$158[TMP$142$3 - 9ull];
			label$174:;
		}
...
static void PPCMDLINE( void )
{
	...
	if( *(int64*)((uint8*)&ENV$ + 1192ll) <= 0ll ) goto label$238;
	{
		...
		FBSTRING* vr$5 = fb_StrConcat( &TMP$152$2, (void*)"#cmdline \x22", 11ll, (void*)ARGS$1, 0ll );
		__builtin_memset( &TMP$153$2, 0, 24ll );
		FBSTRING* vr$8 = fb_StrConcat( &TMP$153$2, (void*)vr$5, -1ll, (void*)"\x22", 2ll );
		fb_StrAssign( (void*)&TMP$154$2, -1ll, (void*)vr$8, -1ll, 0 );
		LEXPPONLYEMITTEXT( &TMP$154$2 );
