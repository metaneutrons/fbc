...
struct $6IRVREG* ASTLOAD( struct $7ASTNODE* N$1 )
{
	...
	{
		struct $6IRVREG* vr$1 = (*(tmp$84*)((int64)(tmp$84*)AST_LOADCALLBACKS$ + (*(int64*)N$1 << (3ll & 63ll))))( N$1 );
		fb$result$1 = vr$1;
	}
	label$130:;
	label$129:;
