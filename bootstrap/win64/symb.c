...
int64 SYMBCANDUPLICATE( struct $8FBSYMBOL* HEAD_SYM$1, struct $8FBSYMBOL* S$1 )
{
	...
	fb$result$1 = 0ll;
	{
			...
			{
				{
					...
					if( (TMP$102$5 - 1ull) > 15ull ) goto label$117;
			...
			{
				{
					...
					if( (TMP$104$5 - 1ull) > 15ull ) goto label$138;
		...
		if( (TMP$98$2 - 1ull) > 15ull ) goto label$32;
		goto *tmp$110[TMP$98$2 - 1ull];
		label$32:;
	}
	fb$result$1 = -1ll;
	label$31:;
...
struct $10FBSYMCHAIN* SYMBLOOKUP( char* ID$1, $8FB_TOKEN* TK$1, $10FB_TKCLASS* TK_CLASS$1 )
{
	...
	*TK_CLASS$1 = 0ll;
	...
	{
		{
			$12FB_SYMBCLASS TMP$114$3;
			TMP$114$3 = *($12FB_SYMBCLASS*)*(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 197024ll);
			if( TMP$114$3 == 10ll ) goto label$322;
			label$323:;
			if( TMP$114$3 != 11ll ) goto label$321;
			label$322:;
			{
...
struct $10FBSYMCHAIN* SYMBLOOKUPAT( struct $8FBSYMBOL* NS$1, char* ID$1, int64 PRESERVE_CASE$1, int64 SEARCH_IMPORTS$1 )
{
	...
	label$356:;
	{
		...
		TMP$115$2 = *($12FB_SYMBCLASS*)NS$1;
		if( TMP$115$2 == 10ll ) goto label$360;
		label$361:;
		if( TMP$115$2 != 11ll ) goto label$359;
		label$360:;
		{
		...
		if( CHAIN_$1 == (struct $10FBSYMCHAIN*)0ull ) goto label$386;
		{
			...
			label$387:;
			{
				if( *(int64*)SYM$1 != 1ll ) goto label$391;
				{
					{
						int64 TMP$116$6;
						TMP$116$6 = *(int64*)((uint8*)SYM$1 + 56ll) & 511ll;
						if( TMP$116$6 == 17ll ) goto label$394;
						label$395:;
						if( TMP$116$6 == 18ll ) goto label$394;
						label$396:;
						if( TMP$116$6 != 4ll ) goto label$393;
						label$394:;
						{
							goto label$397;
						}
					...
					{
						{
							...
							TMP$117$7 = *($11FB_DATATYPE*)((uint8*)SYM$1 + 56ll);
							if( TMP$117$7 == 17ll ) goto label$424;
							label$425:;
							if( TMP$117$7 == 18ll ) goto label$424;
							label$426:;
							if( TMP$117$7 != 4ll ) goto label$423;
							label$424:;
							{
								goto label$427;
							}
...
void SYMBFREESYMBOL_REMONLY( struct $8FBSYMBOL* S$1 )
{
	label$470:;
	POOLDELITEM( (struct $5TPOOL*)((uint8*)&SYMB$ + 197184ll), *(void**)((uint8*)S$1 + 32ll) );
	if( *(char**)((uint8*)S$1 + 40ll) == (char*)0ull ) goto label$473;
	{
		free( *(void**)((uint8*)S$1 + 40ll) );
	}
	label$473:;
	label$472:;
	if( *(char**)((uint8*)S$1 + 48ll) == (char*)0ull ) goto label$475;
	{
		free( *(void**)((uint8*)S$1 + 48ll) );
	}
	label$475:;
...
void SYMBDELSYMBOL( struct $8FBSYMBOL* S$1, int64 IS_TBDEL$1 )
{
	label$482:;
	{
		...
		goto label$484;
		label$485:;
		static const void* tmp$119[17ll] = {
			&&label$486,
			&&label$487,
			&&label$488,
			&&label$496,
		...
		if( (TMP$118$2 - 1ull) > 16ull ) goto label$496;
...
struct $8FBSYMBOL* SYMBCLONESYMBOL( struct $8FBSYMBOL* S$1 )
{
	...
	struct $8FBSYMBOL* ARRAYSUBTYPE$1;
	{
		...
		if( (TMP$120$2 - 1ull) > 9ull ) goto label$508;
...
int64 SYMBISARRAY( struct $8FBSYMBOL* SYM$1 )
{
	...
	label$539:;
	{
		...
		TMP$122$2 = *($12FB_SYMBCLASS*)SYM$1;
		if( TMP$122$2 == 1ll ) goto label$543;
		label$544:;
		if( TMP$122$2 != 12ll ) goto label$542;
		label$543:;
		{
...
int64 SYMBISSTRING( int64 DTYPE$1 )
{
	...
	label$546:;
	{
		...
		goto label$548;
		label$549:;
		static const void* tmp$124[15ll] = {
			&&label$550,
			&&label$551,
			&&label$551,
			&&label$550,
		...
		if( (TMP$123$2 - 4ull) > 14ull ) goto label$551;
		goto *tmp$124[TMP$123$2 - 4ull];
		label$548:;
	}
	label$547:;
	return fb$result$1;
...
$19FB_CVA_LIST_TYPEDEF SYMBGETVALISTTYPE( int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	if( ((DTYPE$1 & 32505856ll) >> (20ll & 63ll)) != 19ll ) goto label$555;
	{
		{
			int64 TMP$125$3;
			TMP$125$3 = DTYPE$1 & 31ll;
			if( TMP$125$3 != 0ll ) goto label$557;
			label$558:;
			{
			...
			goto label$556;
			label$557:;
			if( TMP$125$3 != 20ll ) goto label$561;
			label$562:;
			{
			...
			label$561:;
			{
				...
				goto label$571;
				label$566:;
				TMP$126$4 = DTYPE$1 & 31ll;
				label$571:;
				if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$126$4 * 56ll)) != 0ll ) goto label$568;
				{
...
FBSTRING* SYMBTYPETOSTR( int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, int64 LENGTH$1, int64 IS_FIXLENSTR$1 )
{
	...
	label$578:;
	{
		...
		label$582:;
		{
			...
			FBSTRING* vr$18 = fb_StrConcat( &TMP$129$3, (void*)&S$1, -1ll, *(void**)((uint8*)SUBTYPE$1 + 32ll), 0ll );
		...
		label$583:;
		{
			...
			FBSTRING* vr$24 = fb_StrConcat( &TMP$130$3, (void*)&S$1, -1ll, *(void**)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (DTYPEONLY$1 * 56ll)) + 48ll), 0ll );
		...
		label$598:;
		{
			...
			FBSTRING* vr$43 = fb_StrConcat( &TMP$134$3, (void*)&S$1, -1ll, *(void**)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (DTYPEONLY$1 * 56ll)) + 48ll), 0ll );
			fb_StrAssign( (void*)&S$1, -1ll, (void*)vr$43, -1ll, 0 );
		}
		goto label$580;
		label$581:;
		static const void* tmp$137[20ll] = {
			&&label$583,
			&&label$598,
			&&label$598,
			&&label$583,
		...
		if( (TMP$128$2 - 4ull) > 19ull ) goto label$598;
		goto *tmp$137[TMP$128$2 - 4ull];
		label$580:;
	}
	{
		int64 I$2;
...
void SYMBSETDEFTYPE( int64 ICHAR$1, int64 ECHAR$1, int64 DTYPE$1 )
{
	...
	label$621:;
	{
		...
		I$1 = I$1 + 1ll;
		label$623:;
		if( I$1 <= TMP$141$2 ) goto label$626;
		label$625:;
	}
	label$614:;
}
...
int64 SYMBCALCLEN( int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	DTYPE$1 = TMP$142$1;
	{
		...
		label$644:;
		{
			...
			goto label$647;
			label$645:;
			TMP$144$3 = DTYPE$1 & 31ll;
			label$647:;
			fb$result$1 = *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$144$3 * 56ll)) + 8ll);
		}
		goto label$640;
		label$641:;
		...
		if( (TMP$143$2 - 18ull) > 2ull ) goto label$644;
		goto *tmp$145[TMP$143$2 - 18ull];
		label$640:;
	}
	label$638:;
	return fb$result$1;
...
FBSTRING* SYMBDUMPPRETTYTOSTR( struct $8FBSYMBOL* SYM$1 )
{
	...
	FBSTRING* vr$6 = fb_StrConcat( &TMP$171$1, *(void**)(((int64)(char**)CLASSNAMESPRETTY$ + (*(int64*)SYM$1 << (3ll & 63ll))) + -8ll), 0ll, (void*)" ", 2ll );
	__builtin_memset( &TMP$172$1, 0, 24ll );
	FBSTRING* vr$9 = fb_StrConcat( &TMP$172$1, (void*)vr$6, -1ll, *(void**)((uint8*)SYM$1 + 32ll), 0ll );
		...
		if( SYM$2 == (struct $8FBSYMBOL*)0ull ) goto label$241;
		{
			...
			if( (OPTIONS$1 & 1ll) == 0ll ) goto label$243;
			{
				PARENT$1 = *(struct $8FBSYMBOL**)*(struct $10FBSYMBOLTB**)((uint8*)SYM$2 + 288ll);
				{
					...
					if( TMP$112$5 != 20ll ) goto label$245;
					label$246:;
					{
					...
					goto label$244;
					label$245:;
					if( TMP$112$5 != 10ll ) goto label$249;
					label$250:;
					{
						ADD$1 = -1ll;
					}
...
static struct $10FBSYMCHAIN* HSYMBLOOKUPTYPENS( char* ID$1, $8FB_TOKEN* TK$1, $10FB_TKCLASS* TK_CLASS$1, struct $8FBHASHTB* HASHTB$1, uint64 INDEX$1 )
{
	...
	void* vr$11 = HASHLOOKUPEX( (struct $5THASH*)((uint8*)NS$1 + 128ll), (char*)ID$1, INDEX$1 );
	...
	{
		struct $10FBSYMCHAIN* vr$22 = HLOOKUPIMPORTLIST( NS$1, (char*)ID$1, INDEX$1, 0ll );
		CHAIN_$1 = vr$22;
		...
		if( CHAIN_$1 == (struct $10FBSYMCHAIN*)0ull ) goto label$292;
		{
			...
			if( SYM$1 == (struct $8FBSYMBOL*)0ull ) goto label$294;
			{
				PARENT$1 = *(struct $8FBSYMBOL**)*(struct $10FBSYMBOLTB**)((uint8*)SYM$1 + 288ll);
				{
					...
					if( TMP$113$5 != 20ll ) goto label$296;
					label$297:;
					{
					...
					goto label$295;
					label$296:;
					if( TMP$113$5 != 10ll ) goto label$300;
					label$301:;
					{
					}
					label$300:;
	...
	label$302:;
	{
		void* vr$35 = HASHLOOKUPEX( (struct $5THASH*)((uint8*)HASHTB$1 + 8ll), (char*)ID$1, INDEX$1 );
	...
	label$303:;
	void* vr$39 = HASHLOOKUPEX( (struct $5THASH*)((uint8*)&SYMB$ + 197096ll), (char*)ID$1, INDEX$1 );
...
static int64 HSYMBCHECKCONSTASSIGNFUNCPTR( $11FB_DATATYPE LDTYPE$1, $11FB_DATATYPE RDTYPE$1, struct $8FBSYMBOL* LSUBTYPE$1, struct $8FBSYMBOL* RSUBTYPE$1, $12FB_PARAMMODE MODE$1, int64* MATCHES$1, $13FB_WARNINGMSG* WRNMSG$1 )
{
	...
	TMP$146$1 = 1ll;
	label$774:;
	$22FB_OVLPROC_MATCH_SCORE vr$7 = TYPECALCMATCH( *(int64*)((uint8*)LSUBTYPE$1 + 56ll), *(struct $8FBSYMBOL**)((uint8*)LSUBTYPE$1 + 64ll), TMP$146$1, *(int64*)((uint8*)RSUBTYPE$1 + 56ll), *(struct $8FBSYMBOL**)((uint8*)RSUBTYPE$1 + 64ll) );
	MATCH$1 = vr$7;
	...
	if( LPARAM$1 == (struct $8FBSYMBOL*)0ull ) goto label$740;
	{
		...
		TMP$147$2 = 0ll;
		int64 vr$31 = SYMBCHECKCONSTASSIGN( L$2, R$2, LS$2, RS$2, M$2, &TMP$147$2, WRNMSG$1 );
...
static void HFOREACHGLOBAL( struct $8FBSYMBOL* SYM$1, int64 SYMCLASS$1, tmp$43 CALLBACK$1 )
{
	...
	{
		{
			$12FB_SYMBCLASS TMP$148$3;
			TMP$148$3 = *($12FB_SYMBCLASS*)SYM$1;
			if( TMP$148$3 != 8ll ) goto label$754;
			label$755:;
			{
			...
			goto label$753;
			label$754:;
			if( TMP$148$3 != 10ll ) goto label$756;
			label$757:;
			{
				HFOREACHGLOBAL( *(struct $8FBSYMBOL**)((uint8*)SYM$1 + 104ll), SYMCLASS$1, CALLBACK$1 );
			}
			goto label$753;
			label$756:;
			if( TMP$148$3 != 15ll ) goto label$758;
			label$759:;
			{
			...
			goto label$753;
			label$758:;
			if( TMP$148$3 != SYMCLASS$1 ) goto label$760;
			label$761:;
			{
				(CALLBACK$1)( SYM$1 );
			}
...
static FBSTRING* HGETNAMESPACEPREFIX( struct $8FBSYMBOL* SYM$1 )
{
	...
	if( NS$1 == (struct $8FBSYMBOL*)((uint8*)&SYMB$ + 196704ll) ) goto label$769;
	{
		...
		FBSTRING* vr$12 = fb_StrConcat( &TMP$150$2, *(void**)((uint8*)NS$1 + 32ll), 0ll, (void*)".", 2ll );
		__builtin_memset( &TMP$151$2, 0, 24ll );
		FBSTRING* vr$15 = fb_StrConcat( &TMP$151$2, (void*)vr$12, -1ll, (void*)&S$1, -1ll );
