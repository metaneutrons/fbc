...
static struct $8FBSYMBOL* HMOCKPARAM( struct $8FBSYMBOL* PROC$1, int64 PMODE$1 )
{
	...
	TMP$95$1 = 0ll;
	label$161:;
	struct $8FBSYMBOL* vr$1 = SYMBADDPROCPARAM( PROC$1, (char*)0ull, DTYPE$1, (struct $8FBSYMBOL*)0ull, TMP$95$1, PMODE$1, 0ll, 0ll );
	fb$result$1 = vr$1;
	label$50:;
	return fb$result$1;
}
...
static struct $8FBSYMBOL* HPARAMDECL( struct $8FBSYMBOL* PROC$1, int64 PROC_MODE$1, int64 ISPROTO$1 )
{
	...
	static struct $8FBARRAY1IcE tmp$96$1 = { (char*)IDTB$1, (char*)IDTB$1, 1032ll, 129ll, 1ll, 49ll, { { 8ll, 0ll, 7ll } } };
