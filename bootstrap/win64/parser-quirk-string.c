...
struct $7ASTNODE* CCVXFUNCT( $8FB_TOKEN TK$1 )
{
	...
	TMP$119$1 = (int64)-(vr$1 != 0ll);
	goto label$234;
	label$151:;
	TMP$119$1 = 0ll;
	label$234:;
	if( TMP$119$1 == 0ll ) goto label$153;
	{
		int64 LGT$2;
	...
	{
		int64 TMP$120$2;
		TMP$120$2 = *(int64*)((uint8*)EXPR1$1 + 8ll) & 511ll;
		if( TMP$120$2 != 4ll ) goto label$165;
		label$166:;
		{
		...
		goto label$164;
		label$165:;
		if( TMP$120$2 == 17ll ) goto label$168;
		label$169:;
		if( TMP$120$2 == 18ll ) goto label$168;
		label$170:;
		if( TMP$120$2 != 7ll ) goto label$167;
		label$168:;
		{
			IS_STR$1 = -1ll;
		}
	...
	$11FB_DATATYPE FUNCTYPE$1;
	{
		...
		if( (TMP$121$2 - 424ull) > 4ull ) goto label$180;
		goto *tmp$139[TMP$121$2 - 424ull];
		label$171:;
	}
	char* ZS$1;
	int64 ZSLEN$1;
	if( ((int64)-(ALLOWCONST$1 != 0ll) & (int64)-(LITSYM$1 != (struct $8FBSYMBOL*)0ull)) == 0ll ) goto label$182;
	{
		int64 TMP$122$2;
		TMP$122$2 = 0ll;
		char* vr$18 = HUNESCAPE( *(char**)((uint8*)LITSYM$1 + 96ll), &TMP$122$2 );
		ZS$1 = vr$18;
	...
	TMP$123$1 = (int64)-(FUNCTYPE$1 == 5ll);
	goto label$235;
	label$183:;
	TMP$123$1 = -1ll;
	label$235:;
	if( TMP$123$1 == 0ll ) goto label$185;
	{
		int64 TMP$124$2;
		...
		goto label$236;
		label$186:;
		TMP$124$2 = FUNCTYPE$1 & 31ll;
		label$236:;
		if( ZSLEN$1 < *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$124$2 * 56ll)) + 8ll) ) goto label$188;
		{
			{
				...
				{
					{
						...
						goto label$237;
						label$195:;
						TMP$125$6 = FUNCTYPE$1 & 31ll;
						label$237:;
						TMP$126$6 = *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$125$6 * 56ll)) + 8ll);
						if( TMP$126$6 != 2ll ) goto label$197;
						label$198:;
						{
						...
						goto label$196;
						label$197:;
						if( TMP$126$6 != 4ll ) goto label$199;
						label$200:;
						{
				...
				{
					{
						...
						goto label$238;
						label$208:;
						TMP$129$6 = FUNCTYPE$1 & 31ll;
						label$238:;
						TMP$130$6 = *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$129$6 * 56ll)) + 8ll);
						if( TMP$130$6 != 2ll ) goto label$210;
						label$211:;
						{
						...
						goto label$209;
						label$210:;
						if( TMP$130$6 != 4ll ) goto label$212;
						label$213:;
						{
	...
	{
		{
			...
			label$220:;
			{
				...
				goto label$239;
				label$223:;
				TMP$136$4 = FUNCTYPE$1 & 31ll;
				label$239:;
				if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$136$4 * 56ll)) + 8ll) != 4ll ) goto label$225;
				{
...
struct $7ASTNODE* CMKXFUNCT( $8FB_TOKEN TK$1 )
{
	...
	int64 vr$1 = HMATCH( 301ll, 0ll );
	TMP$140$1 = (int64)-(vr$1 != 0ll);
	goto label$281;
	label$242:;
	TMP$140$1 = 0ll;
	label$281:;
	if( TMP$140$1 == 0ll ) goto label$244;
	{
		int64 LGT$2;
		struct $7ASTNODE* vr$3 = CGTINPARENSONLYEXPR(  );
		int64 vr$4 = CCONSTINTEXPR( vr$3, 8ll );
	...
	{
		{
				...
				{
					{
						...
						goto label$282;
						label$266:;
						TMP$145$6 = DTYPE$1 & 31ll;
						label$282:;
						TMP$146$6 = *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$145$6 * 56ll)) + 40ll);
						if( TMP$146$6 != 3ll ) goto label$268;
						label$269:;
						{
						...
						goto label$267;
						label$268:;
						if( TMP$146$6 != 5ll ) goto label$270;
						label$271:;
						{
						...
						goto label$267;
						label$270:;
						if( TMP$146$6 != 7ll ) goto label$272;
						label$273:;
						{
			...
			if( (TMP$141$3 - 430ull) > 4ull ) goto label$276;
			goto *tmp$150[TMP$141$3 - 430ull];
			label$257:;
		}
	...
	if( LITSYM$1 == (struct $8FBSYMBOL*)0ull ) goto label$124;
	{
		...
		if( P$1 < 0ll ) goto label$134;
		{
			...
			if( (*(int64*)((uint8*)EXPR1$1 + 8ll) & 511ll) == 7ll ) goto label$136;
			{
				...
				TMP$113$4 = (int64)-(TEXTLEN$3 == 0ll);
				goto label$421;
				label$137:;
				TMP$113$4 = -1ll;
				label$421:;
				if( TMP$113$4 != 0ll ) goto label$138;
				TMP$114$4 = (int64)-(P$1 <= 0ll);
				goto label$422;
				label$138:;
				TMP$114$4 = -1ll;
				label$422:;
				if( TMP$114$4 != 0ll ) goto label$139;
				TMP$115$4 = (int64)-(P$1 > TEXTLEN$3);
				goto label$423;
				label$139:;
				TMP$115$4 = -1ll;
				label$423:;
				if( TMP$115$4 == 0ll ) goto label$141;
				{
			...
			label$136:;
			{
				...
				TMP$116$4 = (int64)-(TEXTLEN$3 == 0ll);
				goto label$424;
				label$142:;
				TMP$116$4 = -1ll;
				label$424:;
				if( TMP$116$4 != 0ll ) goto label$143;
				TMP$117$4 = (int64)-(P$1 <= 0ll);
				goto label$425;
				label$143:;
				TMP$117$4 = -1ll;
				label$425:;
				if( TMP$117$4 != 0ll ) goto label$144;
				TMP$118$4 = (int64)-(P$1 > TEXTLEN$3);
				goto label$426;
				label$144:;
				TMP$118$4 = -1ll;
				label$426:;
				if( TMP$118$4 == 0ll ) goto label$146;
				{
