			...
			{
				{
					...
					label$90:;
					TMP$153$5 = *(uint64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$152$5 * 56ll)) + 40ll);
					goto label$44;
					label$45:;
					{
			...
			{
				{
					...
					label$144:;
					TMP$159$5 = *(uint64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$158$5 * 56ll)) + 40ll);
					goto label$122;
					label$123:;
					{
...
int64 RTLPRINTER_CB( struct $8FBSYMBOL* SYM$1 )
{
	...
	if( LIBSADDED$1 != 0ll ) goto label$214;
	{
		LIBSADDED$1 = -1ll;
		{
			...
			if( TMP$165$3 == 0ll ) goto label$217;
			label$218:;
			if( TMP$165$3 != 1ll ) goto label$216;
			label$217:;
			{
