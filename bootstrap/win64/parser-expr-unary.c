...
struct $7ASTNODE* CNEGNOTEXPRESSION( void )
{
	...
	struct $7ASTNODE* NEGEXPR$1;
	{
		...
		TMP$95$2 = vr$1;
		if( TMP$95$2 != 45ll ) goto label$19;
		label$20:;
		{
			LEXSKIPTOKEN( 0ll );
		...
		goto label$18;
		label$19:;
		if( TMP$95$2 != 43ll ) goto label$25;
		label$26:;
		{
			LEXSKIPTOKEN( 0ll );
		...
		goto label$18;
		label$25:;
		if( TMP$95$2 != 295ll ) goto label$31;
		label$32:;
		{
			LEXSKIPTOKEN( 2048ll );
...
struct $7ASTNODE* CSTRIDXORMEMBERDEREF( struct $7ASTNODE* EXPR$1 )
{
	...
	SUBTYPE$1 = *(struct $8FBSYMBOL**)((uint8*)EXPR$1 + 16ll);
	{
		...
		{
			{
				...
				TMP$98$4 = vr$7;
				if( TMP$98$4 != 46ll ) goto label$49;
				label$50:;
				{
					LEXSKIPTOKEN( 64ll );
				...
				goto label$48;
				label$49:;
				if( TMP$98$4 == 400ll ) goto label$54;
				label$55:;
				if( TMP$98$4 != 91ll ) goto label$53;
				label$54:;
				{
		...
		if( (TMP$97$2 - 4ull) > 16ull ) goto label$42;
	...
	if( (DTYPE$1 & 480ll) == 0ll ) goto label$57;
	{
		...
		ISFIELD$2 = 0ll;
		{
			...
			TMP$99$3 = vr$13;
			if( TMP$99$3 != 40ll ) goto label$59;
			label$60:;
			{
			...
			goto label$58;
			label$59:;
			if( TMP$99$3 == 400ll ) goto label$62;
			label$63:;
			if( TMP$99$3 != 91ll ) goto label$61;
			label$62:;
			{
				ISFIELD$2 = -1ll;
			}
			goto label$58;
			label$61:;
			if( TMP$99$3 != 46ll ) goto label$64;
			label$65:;
			{
...
struct $7ASTNODE* CHIGHESTPRECEXPR( struct $8FBSYMBOL* BASE_PARENT$1, struct $10FBSYMCHAIN* CHAIN_$1 )
{
	...
	struct $7ASTNODE* EXPR$1;
	{
		...
		int64 vr$1 = LEXGETTOKEN( 0ll );
		TMP$101$2 = vr$1;
		if( TMP$101$2 != 64ll ) goto label$72;
		label$73:;
		{
			goto label$75;
			{
		...
		goto label$71;
		label$72:;
		if( TMP$101$2 != 42ll ) goto label$76;
		label$77:;
		{
			goto label$79;
			{
		...
		goto label$71;
		label$76:;
		if( TMP$101$2 != 40ll ) goto label$80;
		label$81:;
		{
			int64 IS_OPT$3;
		...
		{
			{
					...
					{
						{
							...
							TMP$103$7 = vr$17;
							if( TMP$103$7 != 377ll ) goto label$95;
							label$96:;
							{
								FBSTRING TMP$104$8;
								__builtin_memset( &TMP$104$8, 0, 24ll );
								FBSTRING* vr$19 = PPTYPEOF(  );
								fb_StrAssign( (void*)&TMP$104$8, -1ll, (void*)vr$19, -1ll, 0 );
								struct $7ASTNODE* vr$21 = ASTNEWCONSTSTR( (char*)*(char**)&TMP$104$8 );
								fb$result$1 = vr$21;
								fb_StrDelete( (FBSTRING*)&TMP$104$8 );
								goto label$70;
							}
							goto label$94;
							label$95:;
							if( TMP$103$7 != 315ll ) goto label$97;
							label$98:;
							{
				...
				goto label$85;
				label$86:;
				static const void* tmp$105[29ll] = {
					&&label$90,
					&&label$91,
					&&label$91,
					&&label$91,
				...
				if( (TMP$102$4 - 389ull) > 28ull ) goto label$91;
				goto *tmp$105[TMP$102$4 - 389ull];
				label$85:;
			}
		}
		label$84:;
...
struct $7ASTNODE* CPROCPTRBODY( int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	if( vr$8 == 0ll ) goto label$190;
	{
		...
		if( vr$10 == 41ll ) goto label$194;
		{
			...
			TMP$111$3 = 0ll;
			TMP$110$3 = 0ll;
			int64 vr$15 = CSYMBOLTYPE( &DTYPE$2, &SUBTYPE$2, &TMP$110$3, &TMP$111$3, 1ll );
			...
			{
				int64 TMP$112$4;
				TMP$112$4 = DTYPE$2 & 511ll;
				if( TMP$112$4 != 0ll ) goto label$198;
				label$199:;
				{
				}
				goto label$197;
				label$198:;
				if( TMP$112$4 != 54ll ) goto label$200;
				label$201:;
				{
					IS_EXACT$2 = -1ll;
				}
...
struct $7ASTNODE* CADDROFEXPRESSION( void )
{
	...
	label$222:;
	{
		...
		label$244:;
		{
			...
			goto label$268;
			label$249:;
			TMP$116$3 = DTYPE$3 & 31ll;
			label$268:;
			if( TMP$116$3 != 20ll ) goto label$251;
			{
			...
			T$3 = vr$42;
			{
				...
				goto label$256;
				label$257:;
				static const void* tmp$119[20ll] = {
					&&label$258,
					&&label$258,
					&&label$258,
					&&label$258,
				...
				if( (TMP$117$4 - 17ull) > 19ull ) goto label$259;
				goto *tmp$119[TMP$117$4 - 17ull];
				label$256:;
			}
			{
		...
		if( (TMP$115$2 - 396ull) > 3ull ) goto label$232;
		goto *tmp$120[TMP$115$2 - 396ull];
		label$232:;
	}
...
static struct $7ASTNODE* HPPDEFINEDEXPR( void )
{
	...
	struct $8FBSYMBOL* vr$3 = CIDENTIFIERORUDTMEMBER( &TMP$94$1, (struct $10FBSYMCHAIN*)0ull );
...
static struct $7ASTNODE* HCAST( $11AST_CONVOPT OPTIONS$1 )
{
	...
	TMP$107$1 = 0ll;
	TMP$106$1 = 0ll;
	int64 vr$7 = CSYMBOLTYPE( &DTYPE$1, &SUBTYPE$1, &TMP$106$1, &TMP$107$1, 1ll );
	...
	label$105:;
	{
		...
		goto label$110;
		label$111:;
		static const void* tmp$121[25ll] = {
			&&label$112,
			&&label$121,
			&&label$121,
			&&label$121,
		...
		if( TMP$109$2 > 24ull ) goto label$121;
		goto *tmp$121[TMP$109$2 - 0ull];
		label$110:;
	}
...
static struct $7ASTNODE* HPROCPTRBODY( struct $8FBSYMBOL* BASE_PARENT$1, struct $8FBSYMBOL* PROC$1, boolean CHECK_EXACT$1, int64 IS_VTABLE_INDEX$1 )
{
	...
	{
		char* vr$9 = SYMBGETFULLPROCNAME( PROC$1 );
		ERRREPORTEX( 202ll, (char*)vr$9, 0ll, 1ll, (char*)0ull );
	}
	label$172:;
	label$171:;
	tmp$35 CALLBACK$1;
	CALLBACK$1 = *(tmp$35*)((uint8*)PROC$1 + 184ll);
	if( CALLBACK$1 == (tmp$35)0ull ) goto label$174;
	{
		(CALLBACK$1)( PROC$1 );
	}
	label$174:;
...
static struct $7ASTNODE* HVARPTRBODY( struct $8FBSYMBOL* BASE_PARENT$1, struct $10FBSYMCHAIN* CHAIN_$1 )
{
	...
	T$1 = vr$3;
	{
		...
		goto label$207;
		label$208:;
		static const void* tmp$122[27ll] = {
			&&label$209,
			&&label$213,
			&&label$213,
			&&label$213,
		...
		if( (TMP$113$2 - 10ull) > 26ull ) goto label$213;
		goto *tmp$122[TMP$113$2 - 10ull];
		label$207:;
	}
	{
