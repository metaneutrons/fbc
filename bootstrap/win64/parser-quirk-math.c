...
struct $7ASTNODE* CMATHFUNCT( $8FB_TOKEN TK$1, int64 ISASM$1 )
{
	...
	fb$result$1 = (struct $7ASTNODE*)0ull;
	{
		...
		if( (TMP$105$2 - 448ull) > 18ull ) goto label$85;
		goto *tmp$106[TMP$105$2 - 448ull];
		label$85:;
	}
	label$84:;
	return fb$result$1;
...
static struct $7ASTNODE* HLEN( struct $7ASTNODE* EXPR$1, int64* LGT$1 )
{
	...
	struct $7ASTNODE* LENEXPR$1;
	{
		...
		label$44:;
		{
			...
			label$45:;
			TMP$96$3 = 0ll;
			uint16* vr$13 = HUNESCAPEW( *(uint16**)((uint8*)LITSYM$1 + 96ll), &TMP$96$3 );
		...
		label$48:;
		{
			int64 TMP$97$3;
			TMP$97$3 = 0ll;
			int64 vr$17 = ASTSIZEOF( EXPR$1, &TMP$97$3 );
			*LGT$1 = vr$17 + -1ll;
		}
		goto label$36;
		label$47:;
		...
		label$50:;
		{
			...
			label$51:;
			TMP$98$3 = 0ll;
			int64 vr$22 = ASTSIZEOF( EXPR$1, &TMP$98$3 );
			*LGT$1 = vr$22;
		}
		goto label$36;
		label$49:;
		{
			int64 TMP$99$3;
			TMP$99$3 = 0ll;
			int64 vr$25 = ASTSIZEOF( EXPR$1, &TMP$99$3 );
			*LGT$1 = vr$25;
		}
		label$53:;
		label$36:;
...
static struct $7ASTNODE* HLENSIZEOF( int64 TK$1, int64 ISASM$1 )
{
	...
	label$56:;
	TMP$100$1 = 0ll;
	struct $7ASTNODE* vr$6 = CTYPEOREXPRESSION( TK$1, &DTYPE$1, &SUBTYPE$1, &LGT$1, &TMP$100$1 );
	EXPR$1 = vr$6;
		...
		{
			{
				...
				if( TMP$103$4 == 4ll ) goto label$68;
				label$69:;
				if( TMP$103$4 == 17ll ) goto label$68;
				label$70:;
				if( TMP$103$4 != 18ll ) goto label$67;
				label$68:;
				{
				...
				goto label$66;
				label$67:;
				if( TMP$103$4 != 7ll ) goto label$71;
				label$72:;
				{
	...
	if( EXPR$1 == (struct $7ASTNODE*)0ull ) goto label$78;
	{
		...
		label$80:;
		{
			int64 TMP$104$3;
			TMP$104$3 = 0ll;
			int64 vr$37 = ASTSIZEOF( EXPR$1, &TMP$104$3 );
			LGT$1 = vr$37;
			ASTDELTREE( EXPR$1 );
