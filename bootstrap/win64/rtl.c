...
static struct $8FBARRAY1IP8FBSYMBOLE tmp$85$ = { (struct $8FBSYMBOL**)RTLLOOKUPTB$, (struct $8FBSYMBOL**)RTLLOOKUPTB$, 2936ll, 8ll, 1ll, 49ll, { { 367ll, 0ll, 366ll } } };
...
void RTLADDINTRINSICPROCS( struct $14FB_RTL_PROCDEF* PROCDEF$1 )
{
	...
	label$16:;
	{
		...
		if( DOADD$2 == 0ll ) goto label$36;
		{
			...
			struct $8FBSYMBOL* vr$20 = SYMBPREADDPROC( (char*)0ull );
			PROC$3 = vr$20;
			{
				int64 I$4;
				I$4 = 0ll;
				...
				{
					{
						...
						TMP$87$6 = (struct $15FB_RTL_PARAMDEF*)((uint8*)((uint8*)PROCDEF$1 + (I$4 << (5ll & 63ll))) + 56ll);
						...
						{
							{
								...
								label$45:;
								{
									struct $7ASTNODE* vr$29 = ASTNEWCONSTSTR( (char*)"" );
								...
								label$47:;
								{
									...
									struct $8FBSYMBOL* vr$34 = SYMBPREADDPROC( (char*)0ull );
									INNER_PROC$9 = vr$34;
									{
										int64 FUNC_ARG$10;
										FUNC_ARG$10 = 0ll;
										...
										label$51:;
										{
											I$4 = I$4 + 1ll;
											{
												...
												TMP$90$12 = (struct $15FB_RTL_PARAMDEF*)((uint8*)((uint8*)PROCDEF$1 + (I$4 << (5ll & 63ll))) + 56ll);
												...
												{
													{
														...
														label$56:;
														{
															struct $7ASTNODE* vr$44 = ASTNEWCONSTSTR( (char*)"" );
												...
												TMP$92$12 = 0ll;
												label$82:;
												struct $8FBSYMBOL* vr$55 = SYMBADDPROCPARAM( INNER_PROC$9, (char*)0ull, *(int64*)TMP$90$12, (struct $8FBSYMBOL*)0ull, TMP$92$12, *(int64*)((uint8*)TMP$90$12 + 8ll), 0ll, 0ll );
												PARAM$1 = vr$55;
									...
									I$4 = I$4 + 1ll;
									{
										...
										TMP$93$10 = (struct $15FB_RTL_PARAMDEF*)((uint8*)((uint8*)PROCDEF$1 + (I$4 << (5ll & 63ll))) + 56ll);
										struct $8FBSYMBOL* vr$62 = SYMBADDPROCPTR( INNER_PROC$9, *(int64*)TMP$93$10, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, *(int64*)((uint8*)&ENV$ + 552ll) );
										SUBTYPE$6 = vr$62;
									}
						...
						TMP$94$6 = 0ll;
						label$83:;
						struct $8FBSYMBOL* vr$69 = SYMBADDPROCPARAM( PROC$3, (char*)0ull, DTYPE$6, SUBTYPE$6, TMP$94$6, *(int64*)((uint8*)TMP$87$6 + 8ll), 0ll, 0ll );
						PARAM$1 = vr$69;
			...
			if( (*(int64*)((uint8*)PROCDEF$1 + 40ll) & 128ll) == 0ll ) goto label$69;
			{
				...
				{
					FBSTRING TMP$96$5;
					if( PALIAS$3 != (char*)0ull ) goto label$73;
					{
			...
			label$69:;
			label$68:;
			if( PALIAS$3 != (char*)0ull ) goto label$75;
			{
				PALIAS$3 = PNAME$3;
			}
			label$75:;
