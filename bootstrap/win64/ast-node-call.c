...
struct $6IRVREG* ASTLOADCALL( struct $7ASTNODE* N$1 )
{
	...
	{
		{
			$11FB_FUNCMODE TMP$85$3;
			TMP$85$3 = *($11FB_FUNCMODE*)((uint8*)PROC$1 + 152ll);
			if( TMP$85$3 == 3ll ) goto label$60;
			label$61:;
			if( TMP$85$3 == 5ll ) goto label$60;
			label$62:;
			if( TMP$85$3 != 6ll ) goto label$59;
			label$60:;
			{
...
int64 ASTISBYREFRESULTDEREF( struct $7ASTNODE* EXPR$1 )
{
	...
	TMP$86$1 = (int64)-(*(struct $7ASTNODE**)((uint8*)EXPR$1 + 112ll) != (struct $7ASTNODE*)0ull);
	goto label$126;
	label$121:;
	TMP$86$1 = 0ll;
	label$126:;
	if( TMP$86$1 == 0ll ) goto label$123;
	{
