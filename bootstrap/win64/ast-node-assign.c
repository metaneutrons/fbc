...
int64 ASTCHECKASSIGN( struct $7ASTNODE* L$1, struct $7ASTNODE* R$1, int64 NO_UPCAST$1 )
{
	...
	label$133:;
	LDCLASS$1 = *($12FB_DATACLASS*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$94$1 * 56ll));
	...
	label$134:;
	RDCLASS$1 = *($12FB_DATACLASS*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$95$1 * 56ll));
	...
	if( ((int64)-(LDTYPE$1 == 7ll) | (int64)-(RDTYPE$1 == 7ll)) == 0ll ) goto label$98;
	{
		if( LDTYPE$1 == RDTYPE$1 ) goto label$100;
		{
			...
			label$135:;
			LDCLASS$1 = *($12FB_DATACLASS*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$96$3 * 56ll));
			...
			label$136:;
			RDCLASS$1 = *($12FB_DATACLASS*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$97$3 * 56ll));
	...
	if( ((int64)-(LDTYPE$1 == 4ll) | (int64)-(RDTYPE$1 == 4ll)) == 0ll ) goto label$109;
	{
		...
		label$139:;
		LDCLASS$1 = *($12FB_DATACLASS*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$100$2 * 56ll));
		...
		label$140:;
		RDCLASS$1 = *($12FB_DATACLASS*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$101$2 * 56ll));
...
struct $7ASTNODE* ASTNEWASSIGN( struct $7ASTNODE* L$1, struct $7ASTNODE* R$1, $9AST_OPOPT OPTIONS$1 )
{
	...
	label$265:;
	LDCLASS$1 = *($12FB_DATACLASS*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$105$1 * 56ll));
	...
	label$267:;
	RDCLASS$1 = *($12FB_DATACLASS*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$107$1 * 56ll));
	...
	label$269:;
	RDCLASS$1 = *($12FB_DATACLASS*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$110$1 * 56ll));
	...
	if( ((int64)-(LDTYPE$1 == 20ll) | (int64)-(RDTYPE$1 == 20ll)) == 0ll ) goto label$204;
	{
		...
		label$271:;
		LDCLASS$1 = *($12FB_DATACLASS*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$112$2 * 56ll));
	...
	if( ((int64)-(LDTYPE$1 == 7ll) | (int64)-(RDTYPE$1 == 7ll)) == 0ll ) goto label$217;
	{
		...
		label$219:;
		{
			...
			label$272:;
			LDCLASS$1 = *($12FB_DATACLASS*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$113$3 * 56ll));
			...
			label$273:;
			RDCLASS$1 = *($12FB_DATACLASS*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$114$3 * 56ll));
	...
	if( ((int64)-(LDTYPE$1 == 4ll) | (int64)-(RDTYPE$1 == 4ll)) == 0ll ) goto label$230;
	{
		...
		label$276:;
		LDCLASS$1 = *($12FB_DATACLASS*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$117$2 * 56ll));
		...
		label$277:;
		RDCLASS$1 = *($12FB_DATACLASS*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$118$2 * 56ll));
...
static int64 HCHECKCONSTANDPOINTEROPS( struct $7ASTNODE* L$1, $11FB_DATATYPE LDTYPE$1, struct $7ASTNODE* R$1, $11FB_DATATYPE RDTYPE$1 )
{
	...
	if( (LDTYPE$1 & 480ll) == 0ll ) goto label$67;
	{
		...
		label$293:;
		if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$90$2 * 56ll)) != 1ll ) goto label$70;
		{
			goto label$63;
		}
		label$70:;
	...
	if( (RDTYPE$1 & 480ll) == 0ll ) goto label$79;
	{
		...
		label$294:;
		if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$91$2 * 56ll)) != 1ll ) goto label$82;
		{
			goto label$63;
		}
		label$82:;
