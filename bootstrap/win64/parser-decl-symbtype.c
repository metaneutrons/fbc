...
int64 HISCONSTINRANGE( int64 DTYPE$1, int64 VALUE$1, int64 TODTYPE$1 )
{
	...
	label$36:;
	R$1 = (struct $11RANGEVALUES*)((int64)(struct $11RANGEVALUES*)RANGE$1 + (*(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$96$1 * 56ll)) + 40ll) * 24ll));
	...
	label$37:;
	if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$97$1 * 56ll)) + 16ll) == 0ll ) goto label$21;
	{
		int64 TMP$98$2;
		...
		label$38:;
		if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$98$2 * 56ll)) + 16ll) == 0ll ) goto label$24;
		{
		...
		label$24:;
		{
			...
			label$40:;
			if( ((int64)-(*(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$99$3 * 56ll)) + 40ll) == 7ll) & (int64)-(*(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$100$3 * 56ll)) + 40ll) == 8ll)) == 0ll ) goto label$28;
			{
	...
	label$21:;
	{
		...
		label$41:;
		if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$101$2 * 56ll)) + 16ll) == 0ll ) goto label$31;
		{
			int64 TMP$102$3;
			int64 TMP$103$3;
			...
			label$43:;
			if( ((int64)-(*(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$102$3 * 56ll)) + 40ll) == 8ll) & (int64)-(*(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$103$3 * 56ll)) + 40ll) == 7ll)) == 0ll ) goto label$35;
			{
...
void _ZN19AMBIGIOUSSIZEOFINFO13CHECKSYMCHAINEP10FBSYMCHAIN( struct $19AMBIGIOUSSIZEOFINFO* THIS$1, struct $10FBSYMCHAIN* CHAIN_$1 )
{
	...
	label$70:;
	{
		...
		{
			{
				$12FB_SYMBCLASS TMP$108$4;
				TMP$108$4 = *($12FB_SYMBCLASS*)SYM$2;
				if( TMP$108$4 == 10ll ) goto label$78;
				label$79:;
				if( TMP$108$4 == 13ll ) goto label$78;
				label$80:;
				if( TMP$108$4 != 14ll ) goto label$77;
				label$78:;
				{
				...
				goto label$76;
				label$77:;
				if( TMP$108$4 == 1ll ) goto label$84;
				label$85:;
				if( TMP$108$4 != 2ll ) goto label$83;
				label$84:;
				{
...
void _ZN19AMBIGIOUSSIZEOFINFO9MAYBEWARNEu7INTEGERS0_( struct $19AMBIGIOUSSIZEOFINFO* THIS$1, int64 TK$1, int64 REFERS_TO_TYPE$1 )
{
	...
	FBSTRING* vr$23 = fb_StrConcat( &TMP$112$1, (void*)"Ambigious ", 11ll, (void*)vr$20, -1ll );
	__builtin_memset( &TMP$113$1, 0, 24ll );
	FBSTRING* vr$26 = fb_StrConcat( &TMP$113$1, (void*)vr$23, -1ll, (void*)"()", 3ll );
...
struct $7ASTNODE* CTYPEOREXPRESSION( int64 TK$1, int64* DTYPE$1, struct $8FBSYMBOL** SUBTYPE$1, int64* LGT$1, int64* IS_FIXLENSTR$1 )
{
	...
	TMP$116$1 = (int64)-(vr$11 != 42ll);
	goto label$125;
	label$102:;
	TMP$116$1 = 0ll;
	label$125:;
	if( TMP$116$1 == 0ll ) goto label$103;
	int64 vr$13 = LEXGETLOOKAHEAD( 1ll, 0ll );
	TMP$117$1 = (int64)-(vr$13 != 301ll);
	goto label$126;
	label$103:;
	TMP$117$1 = 0ll;
	label$126:;
	if( TMP$117$1 == 0ll ) goto label$105;
	{
		MAYBE_TYPE$1 = 0ll;
	}
	goto label$104;
	...
	{
		{
			...
			TMP$118$3 = vr$15;
			if( TMP$118$3 != 91ll ) goto label$107;
			label$108:;
			{
				MAYBE_TYPE$1 = 0ll;
			}
			goto label$106;
			label$107:;
			if( TMP$118$3 != 40ll ) goto label$109;
			label$110:;
			{
				{
					int64 TMP$119$5;
					...
					TMP$119$5 = vr$16;
					if( TMP$119$5 == 377ll ) goto label$113;
					label$114:;
					if( TMP$119$5 == 345ll ) goto label$113;
					label$115:;
					if( TMP$119$5 != 346ll ) goto label$112;
					label$113:;
					{
					}
					goto label$111;
...
int64 CSYMBOLTYPE( int64* DTYPE$1, struct $8FBSYMBOL** SUBTYPE$1, int64* LGT$1, int64* IS_FIXLENSTR$1, $14FB_SYMBTYPEOPT OPTIONS$1 )
{
	...
	*IS_FIXLENSTR$1 = 0ll;
	...
	if( vr$5 != 377ll ) goto label$192;
	{
		...
		label$194:;
		label$193:;
		TMP$129$2 = (struct $8FBSYMBOL*)0ull;
		CTYPEOF( DTYPE$1, SUBTYPE$1, LGT$1, IS_FIXLENSTR$1, &TMP$129$2 );
	...
	label$192:;
	{
		...
		ISUNSIGNED$1 = vr$10;
		{
			...
			if( (TMP$130$3 - 345ull) > 27ull ) goto label$199;
			goto *tmp$147[TMP$130$3 - 345ull];
			label$199:;
		}
		if( *DTYPE$1 == 2147483648ll ) goto label$230;
		{
			{
				int64 TMP$131$4;
				TMP$131$4 = *DTYPE$1 & 511ll;
				if( TMP$131$4 == 4ll ) goto label$233;
				label$234:;
				if( TMP$131$4 != 7ll ) goto label$232;
				label$233:;
				{
					*LGT$1 = 0ll;
				}
				...
				label$232:;
				{
					...
					goto label$347;
					label$236:;
					TMP$132$5 = *DTYPE$1 & 31ll;
					label$347:;
					*LGT$1 = *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$132$5 * 56ll)) + 8ll);
				}
				label$235:;
				label$231:;
			}
		...
		label$230:;
		{
			...
			if( CHECK_ID$3 == 0ll ) goto label$242;
			{
				...
				TMP$133$4 = 50ll;
				label$348:;
				struct $10FBSYMCHAIN* vr$67 = CIDENTIFIER( &BASE_PARENT$3, TMP$133$4 );
				CHAIN_$3 = vr$67;
			}
			label$242:;
			label$241:;
			if( CHAIN_$3 == (struct $10FBSYMCHAIN*)0ull ) goto label$245;
			{
				...
				{
					{
						$12FB_SYMBCLASS TMP$134$6;
						TMP$134$6 = *($12FB_SYMBCLASS*)*(struct $8FBSYMBOL**)CHAIN_$3;
						if( TMP$134$6 == 2ll ) goto label$250;
						label$251:;
						if( TMP$134$6 == 1ll ) goto label$250;
						label$252:;
						if( TMP$134$6 != 12ll ) goto label$249;
						label$250:;
						{
				...
				label$253:;
				{
					...
					{
						{
							$12FB_SYMBCLASS TMP$135$7;
							TMP$135$7 = *($12FB_SYMBCLASS*)SYM$5;
							if( TMP$135$7 != 10ll ) goto label$260;
							label$261:;
							{
								LEXSKIPTOKEN( 2048ll );
								*DTYPE$1 = 20ll;
							...
							goto label$259;
							label$260:;
							if( TMP$135$7 != 9ll ) goto label$262;
							label$263:;
							{
								LEXSKIPTOKEN( 2048ll );
								*DTYPE$1 = 10ll;
							...
							goto label$259;
							label$262:;
							if( TMP$135$7 != 13ll ) goto label$264;
							label$265:;
							{
		...
		{
			{
				...
				goto label$349;
				label$280:;
				TMP$136$4 = *DTYPE$1 & 31ll;
				label$349:;
				TMP$137$4 = (uint64)TMP$136$4;
				goto label$282;
				label$283:;
				{
				...
				if( (TMP$137$4 - 2ull) > 11ull ) goto label$292;
				goto *tmp$148[TMP$137$4 - 2ull];
				label$281:;
			}
		}
		label$279:;
		...
		*IS_FIXLENSTR$1 = -1ll;
		{
			...
			label$301:;
			{
				...
				goto label$351;
				label$304:;
				TMP$140$4 = *DTYPE$1 & 31ll;
				label$351:;
				if( TMP$140$4 != 7ll ) goto label$306;
				{
			...
			goto label$296;
			label$297:;
			static const void* tmp$149[14ll] = {
				&&label$301,
				&&label$307,
				&&label$307,
				&&label$301,
			...
			if( (TMP$139$3 - 4ull) > 13ull ) goto label$307;
			goto *tmp$149[TMP$139$3 - 4ull];
			label$296:;
		}
		...
		{
			{
				...
				label$319:;
				{
					LEXSKIPTOKEN( 2048ll );
					{
						...
						TMP$142$6 = vr$148;
						if( TMP$142$6 == 373ll ) goto label$322;
						label$323:;
						if( TMP$142$6 != 374ll ) goto label$321;
						label$322:;
						{
				...
				goto label$317;
				label$318:;
				static const void* tmp$150[40ll] = {
					&&label$319,
					&&label$330,
					&&label$330,
					&&label$330,
				...
				if( (TMP$141$4 - 335ull) > 39ull ) goto label$330;
				goto *tmp$150[TMP$141$4 - 335ull];
				label$317:;
			}
		}
		label$316:;
	...
	if( PTR_CNT$1 <= 0ll ) goto label$332;
	{
		...
		label$352:;
		*LGT$1 = *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$143$2 * 56ll)) + 8ll);
	}
	goto label$331;
	label$332:;
	{
		...
		label$353:;
		if( TMP$144$2 != 23ll ) goto label$336;
		{
		...
		if( *(int64*)LGT$1 > 0ll ) goto label$339;
		{
			{
				int64 TMP$145$4;
				TMP$145$4 = *DTYPE$1 & 511ll;
				if( TMP$145$4 == 4ll ) goto label$342;
				label$343:;
				if( TMP$145$4 != 7ll ) goto label$341;
				label$342:;
				{
					int64 TMP$146$5;
					...
					goto label$354;
					label$346:;
					TMP$146$5 = *DTYPE$1 & 31ll;
					label$354:;
					*LGT$1 = *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$146$5 * 56ll)) + 8ll);
				}
				label$341:;
				label$340:;
			}
...
static struct $8FBSYMBOL* CSYMBOLTYPEFUNCPTR( int64 IS_FUNC$1 )
{
	...
	SUBTYPE$1 = (struct $8FBSYMBOL*)0ull;
	TMP$104$1 = 0ll;
	$11FB_FUNCMODE vr$2 = CPROCCALLINGCONV( -1ll, &TMP$104$1 );
	MODE$1 = vr$2;
		...
		{
			{
				...
				fb_StrInit( (void*)&TMP$120$4, -1ll, (void*)vr$5, -1ll, 0 );
				int32 vr$8 = fb_StrCompare( (void*)&TMP$120$4, -1ll, (void*)"long", 5ll );
					...
					{
						{
							int64 TMP$122$7;
							TMP$122$7 = *DTYPE$1;
							if( TMP$122$7 != 11ll ) goto label$157;
							label$158:;
							{
							...
							goto label$156;
							label$157:;
							if( TMP$122$7 != 12ll ) goto label$159;
							label$160:;
							{
					...
					{
						{
							int64 TMP$123$7;
							TMP$123$7 = *DTYPE$1;
							if( TMP$123$7 != 11ll ) goto label$163;
							label$164:;
							{
							}
							goto label$162;
							label$163:;
							if( TMP$123$7 != 12ll ) goto label$165;
							label$166:;
							{
							}
							goto label$162;
				...
				goto label$151;
				label$152:;
				int32 vr$25 = fb_StrCompare( (void*)&TMP$120$4, -1ll, (void*)"char", 5ll );
				...
				{
					{
						int64 TMP$125$6;
						TMP$125$6 = *DTYPE$1;
						if( TMP$125$6 != 0ll ) goto label$171;
						label$172:;
						{
						...
						goto label$170;
						label$171:;
						if( TMP$125$6 == 2ll ) goto label$174;
						label$175:;
						if( TMP$125$6 != 3ll ) goto label$173;
						label$174:;
						{
							*DTYPE$1 = (*DTYPE$1 & -32505857ll) | 4194304ll;
						}
				...
				goto label$151;
				label$168:;
				int32 vr$37 = fb_StrCompare( (void*)&TMP$120$4, -1ll, (void*)"__builtin_va_list", 18ll );
				if( (int64)vr$37 == 0ll ) goto label$178;
				label$179:;
				int32 vr$40 = fb_StrCompare( (void*)&TMP$120$4, -1ll, (void*)"__builtin_va_list[]", 20ll );
				...
				{
					{
						int64 TMP$128$6;
						TMP$128$6 = *DTYPE$1;
						if( TMP$128$6 != 0ll ) goto label$181;
						label$182:;
						{
						...
						goto label$180;
						label$181:;
						if( TMP$128$6 != 20ll ) goto label$183;
						label$184:;
						{
							*DTYPE$1 = (*DTYPE$1 & -32505857ll) | 19922944ll;
				...
				goto label$151;
				label$177:;
				int32 vr$62 = fb_StrCompare( (void*)&TMP$120$4, -1ll, (void*)"", 1ll );
				...
				label$188:;
				label$151:;
				fb_StrDelete( (FBSTRING*)&TMP$120$4 );
			}
			LEXSKIPTOKEN( 0ll );
		}
		goto label$149;
