...
int64 SYMBPROCCALCBYTESTOPOP( struct $8FBSYMBOL* PROC$1 )
{
	...
	{
		$11FB_FUNCMODE TMP$95$2;
		TMP$95$2 = *($11FB_FUNCMODE*)((uint8*)PROC$1 + 152ll);
		if( TMP$95$2 == 5ll ) goto label$56;
		label$57:;
		if( TMP$95$2 != 6ll ) goto label$55;
		label$56:;
		{
...
struct $8FBSYMBOL* SYMBADDPROCPARAM( struct $8FBSYMBOL* PROC$1, char* ID$1, int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, int64 DIMENSIONS$1, int64 MODE$1, $13FB_SYMBATTRIB ATTRIB$1, $13FB_PROCATTRIB PATTRIB$1 )
{
	...
	*(int64*)((uint8*)PARAM$1 + 120ll) = DIMENSIONS$1;
	...
	label$86:;
	if( TMP$96$1 != 20ll ) goto label$81;
	{
...
void SYMBPROCRECALCREALTYPE( struct $8FBSYMBOL* PROC$1 )
{
	...
	label$105:;
	{
		...
		if( TMP$97$2 == 17ll ) goto label$109;
		label$110:;
		if( TMP$97$2 != 7ll ) goto label$108;
		label$109:;
		{
			DTYPE$1 = (((DTYPE$1 & 31ll) | ((DTYPE$1 & 480ll) + 32ll)) | ((DTYPE$1 & 261632ll) << (1ll & 63ll))) | (DTYPE$1 & 32505856ll);
		}
		goto label$107;
		label$108:;
		if( TMP$97$2 != 20ll ) goto label$111;
		label$112:;
		{
...
struct $8FBSYMBOL* SYMBADDVARFORPARAM( struct $8FBSYMBOL* PARAM$1 )
{
	...
	*(int64*)((uint8*)&tmp$103$1 + 64ll) = 0ll;
	...
	{
		uint64 TMP$104$2;
		TMP$104$2 = *(uint64*)((uint8*)PARAM$1 + 96ll);
		goto label$377;
		label$378:;
		{
			ATTRIB$1 = 32768ll;
		...
		if( (TMP$104$2 - 1ull) > 2ull ) goto label$383;
	...
	label$385:;
	label$384:;
	struct $8FBSYMBOL* vr$14 = SYMBADDVAR( (char*)*(char**)((uint8*)PARAM$1 + 32ll), (char*)0ull, DTYPE$1, *(struct $8FBSYMBOL**)((uint8*)PARAM$1 + 64ll), 0ll, *(int64*)((uint8*)PARAM$1 + 120ll), (struct $7FBARRAYI10FBARRAYDIME*)&tmp$103$1, ATTRIB$1, 0ll );
	S$1 = vr$14;
...
struct $8FBSYMBOL* SYMBADDVARFORPROCRESULTPARAM( struct $8FBSYMBOL* PROC$1 )
{
	...
	*(int64*)((uint8*)&tmp$106$1 + 64ll) = 0ll;
	...
	struct $8FBSYMBOL* vr$7 = SYMBADDVAR( (char*)vr$6, (char*)0ull, 20ll, *(struct $8FBSYMBOL**)((uint8*)PROC$1 + 64ll), 0ll, 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$106$1, 65536ll, 1ll );
	S$1 = vr$7;
	SYMBPROCALLOCEXT( PROC$1 );
...
struct $8FBSYMBOL* SYMBADDPROCRESULTVAR( struct $8FBSYMBOL* PROC$1 )
{
	...
	*(int64*)((uint8*)&tmp$107$1 + 64ll) = 0ll;
	...
	label$401:;
	label$400:;
	struct $8FBSYMBOL* vr$19 = SYMBADDVAR( (char*)"fb$result", (char*)0ull, DTYPE$1, *(struct $8FBSYMBOL**)((uint8*)PROC$1 + 64ll), 0ll, 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$107$1, 131072ll, 1ll );
	RES$1 = vr$19;
	SYMBPROCALLOCEXT( PROC$1 );
...
void SYMBADDPROCINSTANCEPARAM( struct $8FBSYMBOL* PARENT$1, struct $8FBSYMBOL* PROC$1 )
{
	...
	int64 DTYPE$1;
	{
		...
		TMP$109$2 = *($12FB_SYMBCLASS*)PARENT$1;
		if( TMP$109$2 != 10ll ) goto label$405;
		label$406:;
		{
			DTYPE$1 = 20ll;
		}
		goto label$404;
		label$405:;
		if( TMP$109$2 != 11ll ) goto label$407;
		label$408:;
		{
		}
		label$407:;
	...
	*ERR_NUM$1 = 0ll;
	{
		...
		if( TMP$130$2 == 20ll ) goto label$693;
		label$694:;
		if( TMP$130$2 != 10ll ) goto label$692;
		label$693:;
		{
		}
		goto label$691;
		label$692:;
		{
			{
				int64 TMP$131$4;
				TMP$131$4 = *(int64*)((uint8*)R$1 + 8ll) & 511ll;
				if( TMP$131$4 == 20ll ) goto label$698;
				label$699:;
				if( TMP$131$4 != 10ll ) goto label$697;
				label$698:;
				{
				}
				goto label$696;
...
struct $8FBSYMBOL* SYMBFINDSELFBOPOVLPROC( $6AST_OP OP$1, struct $7ASTNODE* L$1, struct $7ASTNODE* R$1, $9FB_ERRMSG* ERR_NUM$1 )
{
	...
	*ERR_NUM$1 = 0ll;
	{
		...
		if( TMP$132$2 != 20ll ) goto label$708;
		label$709:;
		{
	...
	*(struct $11FB_CALL_ARG**)((uint8*)&ARG1$1 + 16ll) = (struct $11FB_CALL_ARG*)0ull;
	...
	label$716:;
	{
		...
		{
			*ERR_NUM$1 = 202ll;
			char* vr$15 = SYMBGETFULLPROCNAME( PROC$1 );
			ERRREPORTEX( 202ll, (char*)vr$15, 0ll, 1ll, (char*)0ull );
	...
	*ERR_NUM$1 = 0ll;
	{
		...
		if( TMP$133$2 == 20ll ) goto label$725;
		label$726:;
		if( TMP$133$2 != 10ll ) goto label$724;
		label$725:;
		{
		}
		goto label$723;
	...
	*ERR_NUM$1 = 0ll;
	{
		...
		if( TMP$134$2 != 20ll ) goto label$735;
		label$736:;
		{
			struct $8FBSYMBOL* SUBTYPE$3;
			SUBTYPE$3 = *(struct $8FBSYMBOL**)((uint8*)L$1 + 16ll);
...
struct $8FBSYMBOL* SYMBFINDCASTOVLPROC( int64 TO_DTYPE$1, struct $8FBSYMBOL* TO_SUBTYPE$1, struct $7ASTNODE* L$1, $9FB_ERRMSG* ERR_NUM$1, $14FB_SYMBFINDOPT OPTIONS$1 )
{
	...
	*ERR_NUM$1 = 0ll;
	{
		int64 TMP$139$2;
		TMP$139$2 = *(int64*)((uint8*)L$1 + 8ll) & 511ll;
		if( TMP$139$2 != 20ll ) goto label$773;
		label$774:;
		{
			struct $8FBSYMBOL* SUBTYPE$3;
			SUBTYPE$3 = *(struct $8FBSYMBOL**)((uint8*)L$1 + 16ll);
	...
	goto label$810;
	label$782:;
	TMP$140$1 = TO_DTYPE$1 & 31ll;
	label$810:;
	if( TMP$140$1 == 0ll ) goto label$784;
	{
		PROC$1 = PROC_HEAD$1;
		label$785:;
...
$22FB_OVLPROC_MATCH_SCORE SYMBCALCPROCMATCH( struct $8FBSYMBOL* L$1, struct $8FBSYMBOL* R$1, int64* ERRMSG$1 )
{
	...
	TMP$141$1 = 1ll;
	label$866:;
	$22FB_OVLPROC_MATCH_SCORE vr$7 = TYPECALCMATCH( *(int64*)((uint8*)L$1 + 56ll), *(struct $8FBSYMBOL**)((uint8*)L$1 + 64ll), TMP$141$1, *(int64*)((uint8*)R$1 + 56ll), *(struct $8FBSYMBOL**)((uint8*)R$1 + 64ll) );
	MATCH$1 = vr$7;
...
FBSTRING* HDUMPDYNAMICARRAYDIMENSIONS( int64 DIMENSIONS$1 )
{
	...
	fb_StrConcatAssign( (void*)&S$1, -1ll, (void*)"(", 2ll, 0 );
	{
		...
		I$2 = I$2 + 1ll;
		label$940:;
		if( I$2 <= TMP$153$2 ) goto label$943;
		label$942:;
	}
	fb_StrConcatAssign( (void*)&S$1, -1ll, (void*)") ", 3ll, 0 );
...
char* SYMBGETFULLPROCNAME( struct $8FBSYMBOL* PROC$1 )
{
	...
	if( NS$1 == (struct $8FBSYMBOL*)((uint8*)&SYMB$ + 196704ll) ) goto label$982;
	{
		...
		FBSTRING* vr$7 = fb_StrConcat( &TMP$169$2, *(void**)((uint8*)NS$1 + 32ll), 0ll, (void*)".", 2ll );
		__builtin_memset( &TMP$170$2, 0, 24ll );
		FBSTRING* vr$10 = fb_StrConcat( &TMP$170$2, (void*)vr$7, -1ll, (void*)&RES$1, -1ll );
	...
	if( (*(int64*)((uint8*)PROC$1 + 16ll) & 16ll) == 0ll ) goto label$987;
	{
		...
		if( *(struct $10FB_PROCEXT**)((uint8*)PROC$1 + 208ll) == (struct $10FB_PROCEXT*)0ull ) goto label$989;
		{
			...
			FBSTRING* vr$27 = fb_StrConcat( &TMP$174$3, (void*)&RES$1, -1ll, *(void**)(((int64)(struct $10AST_OPINFO*)AST_OPTB$ + (*(int64*)((uint8*)*(struct $10FB_PROCEXT**)((uint8*)PROC$1 + 208ll) + 80ll) << (5ll & 63ll))) + 16ll), 0ll );
	...
	if( (*(int64*)((uint8*)PROC$1 + 16ll) & 32ll) == 0ll ) goto label$990;
	{
		...
		FBSTRING* vr$33 = fb_StrConcat( &TMP$175$2, (void*)&RES$1, -1ll, *(void**)((uint8*)PROC$1 + 32ll), 0ll );
	...
	label$990:;
	{
		...
		FBSTRING* vr$39 = fb_StrConcat( &TMP$179$2, (void*)&RES$1, -1ll, *(void**)((uint8*)PROC$1 + 32ll), 0ll );
...
int64 SYMBGETDEFAULTPARAMMODE( int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	label$995:;
	{
		...
		goto label$997;
		label$998:;
		static const void* tmp$181[20ll] = {
			&&label$999,
			&&label$1000,
			&&label$1000,
			&&label$999,
		...
		if( (TMP$180$2 - 4ull) > 19ull ) goto label$1000;
		goto *tmp$181[TMP$180$2 - 4ull];
		label$997:;
	}
	label$996:;
	return fb$result$1;
...
static struct $8FBSYMBOL* HADDOVLPROC( struct $8FBSYMBOL* PROC$1, struct $8FBSYMBOL* OVL_HEAD_PROC$1, struct $10FBSYMBOLTB* SYMTB$1, struct $8FBHASHTB* HASHTB$1, char* ID$1, char* ID_ALIAS$1, int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, $13FB_SYMBATTRIB ATTRIB$1, $13FB_PROCATTRIB PATTRIB$1, int64 PRESERVECASE$1 )
{
	...
	TMP$98$1 = 0ll;
	label$1023:;
	struct $8FBSYMBOL* vr$51 = SYMBNEWSYMBOL( TMP$98$1, PROC$1, SYMTB$1, HASHTB$1, 3ll, ID$1, ID_ALIAS$1, DTYPE$1, SUBTYPE$1, ATTRIB$1, PATTRIB$1 );
	PROC$1 = vr$51;
...
static void HSETUPPROCREGISTERPARAMETERS( struct $8FBSYMBOL* PROC$1 )
{
	...
	MAXREGNUM$1 = 0ll;
	{
		$11FB_FUNCMODE TMP$99$2;
		TMP$99$2 = *($11FB_FUNCMODE*)((uint8*)PROC$1 + 152ll);
		if( TMP$99$2 != 5ll ) goto label$207;
		label$208:;
		{
			MAXREGNUM$1 = 1ll;
		}
		goto label$206;
		label$207:;
		if( TMP$99$2 != 6ll ) goto label$209;
		label$210:;
		{
			MAXREGNUM$1 = 2ll;
		}
	...
	if( MAXREGNUM$1 <= 0ll ) goto label$212;
	{
		...
		if( ((int64)-(PARAM$2 != (struct $8FBSYMBOL*)0ull) & (int64)-(REGNUM$1 <= MAXREGNUM$1)) == 0ll ) goto label$216;
		{
			...
			goto label$1024;
			label$220:;
			TMP$100$3 = (*(int64*)((uint8*)PARAM$2 + 56ll) & 511ll) & 31ll;
			label$1024:;
			if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$100$3 * 56ll)) != 0ll ) goto label$219;
			{
...
static $22FB_OVLPROC_MATCH_SCORE HCALCTYPESDIFF( int64 PARAM_DTYPE_IN$1, struct $8FBSYMBOL* PARAM_SUBTYPE$1, int64 PARAM_PTRCNT$1, int64 ARG_DTYPE_IN$1, struct $8FBSYMBOL* ARG_SUBTYPE$1, struct $7ASTNODE* ARG_EXPR$1, $12FB_PARAMMODE MODE$1 )
{
	...
	goto label$1025;
	label$463:;
	TMP$110$1 = ARG_DTYPE$1 & 31ll;
	label$1025:;
	ARG_DCLASS$1 = *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$110$1 * 56ll));
	{
		int64 TMP$111$2;
		uint64 TMP$112$2;
		...
		label$1026:;
		TMP$112$2 = *(uint64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$111$2 * 56ll));
		goto label$466;
		label$467:;
		{
			{
				uint64 TMP$113$4;
				TMP$113$4 = (uint64)ARG_DCLASS$1;
				goto label$469;
				label$470:;
				{
					int64 TMP$114$5;
				...
				if( TMP$113$4 > 2ull ) goto label$468;
				goto *tmp$182[TMP$113$4 - 0ull];
				label$468:;
			}
		}
		goto label$465;
		...
		{
			{
				...
				if( TMP$118$4 > 1ull ) goto label$540;
				goto *tmp$183[TMP$118$4 - 0ull];
				label$540:;
			}
		}
		goto label$465;
		...
		if( TMP$112$2 > 2ull ) goto label$465;
		goto *tmp$184[TMP$112$2 - 0ull];
		label$465:;
	}
	label$462:;
	return fb$result$1;
...
static $22FB_OVLPROC_MATCH_SCORE HCHECKOVLPARAM( struct $8FBSYMBOL* PARENT$1, struct $8FBSYMBOL* PARAM$1, struct $7ASTNODE* ARG_EXPR$1, int64 ARG_MODE$1, $9FB_ERRMSG* ERR_NUM$1, $14FB_SYMBFINDOPT OPTIONS$1 )
{
	...
	ARG_SUBTYPE$1 = *(struct $8FBSYMBOL**)((uint8*)ARG_EXPR$1 + 16ll);
	{
		...
		label$581:;
		{
			...
			goto label$1035;
			label$582:;
			TMP$123$3 = ARG_DTYPE$1 & 31ll;
			label$1035:;
			if( ((int64)-(ARG_MODE$1 == 1ll) & (int64)-(*(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$123$3 * 56ll)) != 3ll)) == 0ll ) goto label$584;
			{
				int64 TMP$124$4;
				int64 TMP$125$4;
				...
				label$1037:;
				if( ((int64)-(*(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$124$4 * 56ll)) != 0ll) | (int64)-(*(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$125$4 * 56ll)) + 8ll) != *(int64*)((uint8*)&ENV$ + 592ll))) == 0ll ) goto label$588;
				{
					fb$result$1 = 0ll;
					goto label$564;
				}
	...
	if( (PARAM_DTYPE$1 & 511ll) != (ARG_DTYPE$1 & 511ll) ) goto label$592;
	{
		...
		label$594:;
		{
			{
				int64 TMP$126$4;
				TMP$126$4 = PARAM_DTYPE$1 & 31ll;
				if( TMP$126$4 != 20ll ) goto label$596;
				label$597:;
				{
					int64 BASELEVEL$5;
				...
				goto label$595;
				label$596:;
				if( TMP$126$4 != 22ll ) goto label$600;
				label$601:;
				{
					int64 TMP$127$5;
					TMP$127$5 = 0ll;
					$22FB_OVLPROC_MATCH_SCORE vr$53 = SYMBCALCPROCMATCH( PARAM_SUBTYPE$1, ARG_SUBTYPE$1, &TMP$127$5 );
					MATCH$2 = vr$53;
				}
				label$600:;
				label$595:;
	...
	if( ARGS$1 > PARAMS$1 ) goto label$650;
	{
		...
		*EXACT_MATCHES$1 = 0ll;
		ARG$1 = ARG_HEAD$1;
		{
			...
			I$3 = I$3 + 1ll;
			label$653:;
			if( I$3 <= TMP$128$3 ) goto label$656;
			label$655:;
		}
		*IS_MATCH$1 = (int64)-(ARGS$1 == 0ll) | (int64)-(MATCHSCORE$1 > 0ll);
		{
			...
			I$3 = I$3 + 1ll;
			label$661:;
			if( I$3 <= TMP$129$3 ) goto label$664;
			label$663:;
		}
	}
	label$650:;
...
static $22FB_OVLPROC_MATCH_SCORE HCHECKCASTOVL( struct $8FBSYMBOL* PROC$1, int64 TO_DTYPE$1, struct $8FBSYMBOL* TO_SUBTYPE$1, $14FB_SYMBFINDOPT OPTIONS$1 )
{
	...
	label$758:;
	{
		...
		goto label$1038;
		label$760:;
		TMP$135$2 = PROC_DTYPE$1 & 31ll;
		label$1038:;
		TMP$136$2 = TMP$135$2;
		if( TMP$136$2 == 20ll ) goto label$763;
		label$764:;
		if( TMP$136$2 != 10ll ) goto label$762;
		label$763:;
		{
			fb$result$1 = 0ll;
			goto label$749;
		...
		{
			{
				...
				goto label$1039;
				label$766:;
				TMP$137$4 = TO_DTYPE$1 & 31ll;
				label$1039:;
				TMP$138$4 = TMP$137$4;
				if( TMP$138$4 != 20ll ) goto label$768;
				label$769:;
				{
					fb$result$1 = 0ll;
					goto label$749;
...
static void HPROCMODETOSTR( FBSTRING* S$1, struct $8FBSYMBOL* PROC$1 )
{
	...
	{
		{
			$11FB_FUNCMODE TMP$144$3;
			TMP$144$3 = *($11FB_FUNCMODE*)((uint8*)PROC$1 + 152ll);
			if( TMP$144$3 == 1ll ) goto label$909;
			label$910:;
			if( TMP$144$3 != 2ll ) goto label$908;
			label$909:;
			{
			...
			goto label$907;
			label$908:;
			if( TMP$144$3 != 5ll ) goto label$911;
			label$912:;
			{
			...
			goto label$907;
			label$911:;
			if( TMP$144$3 != 6ll ) goto label$913;
			label$914:;
			{
			...
			goto label$907;
			label$913:;
			if( TMP$144$3 != 4ll ) goto label$915;
			label$916:;
			{
	...
	{
		{
			$11FB_FUNCMODE TMP$149$3;
			TMP$149$3 = *($11FB_FUNCMODE*)((uint8*)PROC$1 + 152ll);
			if( TMP$149$3 == 1ll ) goto label$919;
			label$920:;
			if( TMP$149$3 != 2ll ) goto label$918;
			label$919:;
			{
				{
					$11FB_FUNCMODE TMP$150$5;
					TMP$150$5 = *($11FB_FUNCMODE*)((uint8*)&ENV$ + 552ll);
					if( TMP$150$5 == 1ll ) goto label$923;
					label$924:;
					if( TMP$150$5 != 2ll ) goto label$922;
					label$923:;
					{
					}
					goto label$921;
			...
			goto label$917;
			label$918:;
			if( TMP$149$3 != 5ll ) goto label$926;
			label$927:;
			{
				fb_StrConcatByref( (void*)S$1, -1ll, (void*)" thiscall", 10ll, 0 );
			}
			goto label$917;
			label$926:;
			if( TMP$149$3 != 6ll ) goto label$928;
			label$929:;
			{
				fb_StrConcatByref( (void*)S$1, -1ll, (void*)" fastcall", 10ll, 0 );
			}
			goto label$917;
			label$928:;
			if( TMP$149$3 != 4ll ) goto label$930;
			label$931:;
			{
			...
			goto label$917;
			label$930:;
			if( TMP$149$3 != 3ll ) goto label$934;
			label$935:;
			{
			...
			label$954:;
			{
				...
				FBSTRING TMP$162$4;
				{
					...
					label$966:;
					{
						...
						__builtin_memset( &TMP$159$6, 0, 24ll );
						FBSTRING* vr$18 = fb_StrConcat( &TMP$159$6, (void*)S$1, -1ll, (void*)vr$15, -1ll );
				...
				FBSTRING* vr$24 = fb_StrConcat( &TMP$161$4, (void*)"as ", 4ll, (void*)vr$21, -1ll );
				__builtin_memset( &TMP$162$4, 0, 24ll );
				FBSTRING* vr$27 = fb_StrConcat( &TMP$162$4, (void*)S$1, -1ll, (void*)vr$24, -1ll );
...
static void HRESULTTOSTR( FBSTRING* S$1, struct $8FBSYMBOL* PROC$1 )
{
	...
	if( (*(int64*)((uint8*)PROC$1 + 56ll) & 511ll) == 0ll ) goto label$974;
	{
		...
		FBSTRING* vr$9 = fb_StrConcat( &TMP$167$2, (void*)" as ", 5ll, (void*)vr$6, -1ll );
		__builtin_memset( &TMP$168$2, 0, 24ll );
		FBSTRING* vr$12 = fb_StrConcat( &TMP$168$2, (void*)S$1, -1ll, (void*)vr$9, -1ll );
