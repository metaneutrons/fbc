	...
	*(int64*)((uint8*)N$1 + 48ll) = 0ll;
	if( *(int64*)EXPR$1 != 36ll ) goto label$117;
	{
		...
		if( CHECK_UPCAST$1 == 0ll ) goto label$119;
		{
			...
			label$136:;
			if( TMP$98$3 != 20ll ) goto label$122;
			{
				int64 TMP$99$4;
				...
				goto label$137;
				label$123:;
				TMP$99$4 = (*(int64*)((uint8*)EXPR$1 + 8ll) & 511ll) & 31ll;
				label$137:;
				if( TMP$99$4 != 20ll ) goto label$125;
				{
	...
	{
		{
			...
			if( TMP$101$3 != 38ll ) goto label$191;
			label$192:;
			{
						...
						if( *(int64*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) != 12ll ) goto label$198;
						{
							if( *(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) + 192ll) <= 0ll ) goto label$200;
							{
								if( *(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) + 184ll) != 0ll ) goto label$202;
								{
									...
									goto label$219;
									label$203:;
									TMP$102$9 = *(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) + 56ll) & 31ll;
									label$219:;
									struct $7ASTNODE* vr$35 = ASTNEWCONSTI( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$102$9 * 56ll)) + 8ll), 8ll, (struct $8FBSYMBOL*)0ull );
			...
			goto label$190;
			label$191:;
			if( TMP$101$3 != 37ll ) goto label$204;
			label$205:;
			{
			...
			goto label$190;
			label$204:;
			if( TMP$101$3 != 39ll ) goto label$208;
			label$209:;
			{
			...
			goto label$190;
			label$208:;
			if( TMP$101$3 != 40ll ) goto label$212;
			label$213:;
			{
			...
			goto label$190;
			label$212:;
			if( TMP$101$3 != 41ll ) goto label$214;
			label$215:;
			{
			...
			goto label$190;
			label$214:;
			if( TMP$101$3 != 42ll ) goto label$216;
			label$217:;
			{
				SCOPED$1 = SCOPED$1 + -1ll;
			}
...
void ASTLOADSTATICINITIALIZER( struct $7ASTNODE* TREE$1, struct $8FBSYMBOL* BASESYM$1 )
{
	...
	if( N$1 == (struct $7ASTNODE*)0ull ) goto label$256;
	{
		...
		{
			uint64 TMP$106$3;
			TMP$106$3 = *(uint64*)N$1;
			goto label$258;
			label$259:;
			{
				(*(tmp$67*)((uint8*)&IR$ + 400ll))( *(int64*)((uint8*)N$1 + 48ll) );
			}
			goto label$257;
			label$260:;
			{
			...
			if( (TMP$106$3 - 37ull) > 5ull ) goto label$262;
			goto *tmp$107[TMP$106$3 - 37ull];
			label$257:;
		}
		ASTDELNODE( N$1 );
		N$1 = NXT$1;
...
int64 ASTTYPEINIISCONST( struct $7ASTNODE* TREE$1 )
{
	...
	{
		{
			$13AST_NODECLASS TMP$112$3;
			TMP$112$3 = *($13AST_NODECLASS*)N$1;
			if( TMP$112$3 != 38ll ) goto label$295;
			label$296:;
			{
			...
			goto label$294;
			label$295:;
			if( TMP$112$3 == 39ll ) goto label$300;
			label$301:;
			if( TMP$112$3 != 40ll ) goto label$299;
			label$300:;
			{
				fb$result$1 = 0ll;
				goto label$291;
...
static void HASTTYPEINIMAYBECONVERTUPCAST( struct $7ASTNODE* N$1, struct $7ASTNODE* L$1 )
{
	...
	goto label$338;
	label$20:;
	TMP$94$1 = (*(int64*)((uint8*)N$1 + 8ll) & 511ll) & 31ll;
	label$338:;
	if( TMP$94$1 != 20ll ) goto label$22;
	{
		int64 TMP$95$2;
		...
		goto label$339;
		label$23:;
		TMP$95$2 = (*(int64*)((uint8*)L$1 + 8ll) & 511ll) & 31ll;
		label$339:;
		if( TMP$95$2 != 20ll ) goto label$25;
		{
			if( *(struct $8FBSYMBOL**)((uint8*)N$1 + 16ll) == *(struct $8FBSYMBOL**)((uint8*)L$1 + 16ll) ) goto label$27;
			{
				...
				if( vr$18 <= 0ll ) goto label$29;
				{
					...
					*(struct $8FBSYMBOL**)((uint8*)*(struct $7ASTNODE**)((uint8*)L$1 + 112ll) + 16ll) = *(struct $8FBSYMBOL**)((uint8*)N$1 + 16ll);
					{
						$13AST_NODECLASS TMP$96$6;
						TMP$96$6 = *($13AST_NODECLASS*)*(struct $7ASTNODE**)((uint8*)L$1 + 112ll);
						if( TMP$96$6 != 36ll ) goto label$31;
						label$32:;
						{
						}
						goto label$30;
						label$31:;
						if( TMP$96$6 != 38ll ) goto label$33;
						label$34:;
						{
						}
						goto label$30;
						label$33:;
						if( TMP$96$6 != 41ll ) goto label$35;
						label$36:;
						{
						}
						goto label$30;
...
static int64 HASTINITREEISCONSTANT( struct $7ASTNODE* TREE$1 )
{
	...
	label$72:;
	{
		...
		TMP$97$2 = *($13AST_NODECLASS*)TREE$1;
		if( TMP$97$2 != 36ll ) goto label$75;
		label$76:;
		{
		}
		goto label$74;
		label$75:;
		if( TMP$97$2 != 37ll ) goto label$77;
		label$78:;
		{
		}
		goto label$74;
		label$77:;
		if( TMP$97$2 != 38ll ) goto label$79;
		label$80:;
		{
		}
		goto label$74;
		label$79:;
		if( TMP$97$2 != 39ll ) goto label$81;
		label$82:;
		{
			fb$result$1 = 0ll;
			goto label$71;
		...
		goto label$74;
		label$81:;
		if( TMP$97$2 != 40ll ) goto label$83;
		label$84:;
		{
			fb$result$1 = 0ll;
			goto label$71;
		...
		goto label$74;
		label$83:;
		if( TMP$97$2 != 41ll ) goto label$85;
		label$86:;
		{
		}
		goto label$74;
		label$85:;
		if( TMP$97$2 != 42ll ) goto label$87;
		label$88:;
		{
		}
		goto label$74;
		label$87:;
		if( TMP$97$2 != 9ll ) goto label$89;
		label$90:;
		{
			fb$result$1 = 0ll;
			goto label$71;
		...
		goto label$74;
		label$89:;
		if( TMP$97$2 != 10ll ) goto label$91;
		label$92:;
		{
			fb$result$1 = 0ll;
			goto label$71;
		...
		goto label$74;
		label$91:;
		if( TMP$97$2 != 17ll ) goto label$93;
		label$94:;
		{
			fb$result$1 = -1ll;
			goto label$71;
		...
		goto label$74;
		label$93:;
		if( TMP$97$2 != 16ll ) goto label$95;
		label$96:;
		{
			fb$result$1 = -1ll;
			goto label$71;
	...
	{
		{
			...
			if( TMP$100$3 != 37ll ) goto label$167;
			label$168:;
			{
...
static void HFLUSHEXPRSTATIC( struct $7ASTNODE* N$1, struct $8FBSYMBOL* BASESYM$1 )
{
	...
	if( LITSYM$1 != (struct $8FBSYMBOL*)0ull ) goto label$233;
	{
		...
		label$235:;
		{
			...
			if( EXPR$1 == (struct $7ASTNODE*)0ull ) goto label$241;
			{
				...
				goto label$340;
				label$244:;
				TMP$103$4 = SDTYPE$1 & 31ll;
				label$340:;
				if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$103$4 * 56ll)) != 1ll ) goto label$246;
				{
	...
	label$233:;
	{
		if( SDTYPE$1 == 7ll ) goto label$248;
		{
			...
			{
				(*(tmp$65*)((uint8*)&IR$ + 384ll))( *(int64*)((uint8*)SYM$1 + 80ll) + -1ll, *(char**)((uint8*)LITSYM$1 + 96ll), *(int64*)((uint8*)LITSYM$1 + 80ll) + -1ll );
			}
			goto label$249;
			label$250:;
			{
				...
				fb_StrAssign( (void*)&TMP$104$4, -1ll, (void*)vr$53, -1ll, 0 );
				(*(tmp$65*)((uint8*)&IR$ + 384ll))( *(int64*)((uint8*)SYM$1 + 80ll) + -1ll, (char*)*(char**)&TMP$104$4, (*(int64*)((uint8*)LITSYM$1 + 80ll) / *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + 400ll)) + -1ll );
		...
		label$248:;
		{
			if( EDTYPE$1 == 7ll ) goto label$252;
			{
				...
				TMP$105$4 = vr$61;
				(*(tmp$66*)((uint8*)&IR$ + 392ll))( (*(int64*)((uint8*)SYM$1 + 80ll) / *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + 400ll)) + -1ll, TMP$105$4, *(int64*)((uint8*)LITSYM$1 + 80ll) + -1ll );
				fb_WstrDelete( (uint16*)TMP$105$4 );
			}
			goto label$251;
			label$252:;
			{
				(*(tmp$66*)((uint8*)&IR$ + 392ll))( (*(int64*)((uint8*)SYM$1 + 80ll) / *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + 400ll)) + -1ll, *(uint16**)((uint8*)LITSYM$1 + 96ll), (*(int64*)((uint8*)LITSYM$1 + 80ll) / *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + 400ll)) + -1ll );
			}
			label$251:;
		}
		label$247:;
...
static int64 HEXPRISCONST( struct $7ASTNODE* N$1 )
{
	...
	if( LSYM$1 == (struct $8FBSYMBOL*)0ull ) goto label$266;
	{
		...
		TMP$108$2 = (int64)-(*(int64*)((uint8*)LSYM$1 + 192ll) > 0ll);
		goto label$341;
		label$267:;
		TMP$108$2 = 0ll;
		label$341:;
		if( TMP$108$2 == 0ll ) goto label$269;
		{
	...
	EXPR$1 = *(struct $7ASTNODE**)((uint8*)N$1 + 112ll);
	{
		...
		TMP$109$2 = *($13AST_NODECLASS*)EXPR$1;
		if( TMP$109$2 == 23ll ) goto label$272;
		label$273:;
		if( TMP$109$2 != 16ll ) goto label$271;
		label$272:;
		{
			fb$result$1 = -1ll;
			goto label$264;
		...
		goto label$270;
		label$271:;
		if( TMP$109$2 != 5ll ) goto label$274;
		label$275:;
		{
			label$276:;
			...
			{
				{
					$13AST_NODECLASS TMP$110$5;
					TMP$110$5 = *($13AST_NODECLASS*)EXPR$1;
					if( TMP$110$5 != 5ll ) goto label$279;
					label$280:;
					{
					}
					goto label$278;
					label$279:;
					if( TMP$110$5 != 23ll ) goto label$281;
					label$282:;
					{
						fb$result$1 = -1ll;
						goto label$264;
	...
	{
		int64 TMP$111$2;
		TMP$111$2 = *(int64*)((uint8*)EXPR$1 + 8ll) & 511ll;
		if( TMP$111$2 == 4ll ) goto label$286;
		label$287:;
		if( TMP$111$2 != 7ll ) goto label$285;
		label$286:;
		{
