...
int64 CGFXVIEW( int64 ISVIEW$1 )
{
	...
	fb$result$1 = 0ll;
	{
		...
		int64 vr$8 = LEXGETTOKEN( 0ll );
		TMP$115$2 = vr$8;
		if( TMP$115$2 == 510ll ) goto label$286;
		label$287:;
		if( TMP$115$2 != 511ll ) goto label$285;
		label$286:;
		{
			LEXSKIPTOKEN( 2048ll );
			FLAGS$1 = 1ll;
...
int64 CGFXPALETTE( void )
{
	...
	if( vr$9 == 0ll ) goto label$326;
	{
		...
		label$367:;
		DPTRSIZE$1 = *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$117$2 * 56ll)) + 8ll);
...
int64 CGFXSTMT( $8FB_TOKEN TK$1 )
{
	...
	fb$result$1 = 0ll;
	{
		...
		if( (TMP$121$2 - 473ull) > 40ull ) goto label$521;
		goto *tmp$122[TMP$121$2 - 473ull];
		label$521:;
	}
	label$520:;
	return fb$result$1;
...
static struct $7ASTNODE* HCHECKFBIMAGEEXPR( struct $7ASTNODE* EXPR$1, int64 ALLOW_CONST$1, struct $7ASTNODE** PDESCEXPR$1 )
{
	...
	if( (*(int64*)((uint8*)EXPR$1 + 8ll) & 480ll) != 0ll ) goto label$47;
	{
		if( (*(int64*)((uint8*)EXPR$1 + 8ll) & 511ll) != 20ll ) goto label$49;
		{
			...
			ERRREPORT( 99ll, -1ll, (char*)*(char**)&TMP$100$3 );
