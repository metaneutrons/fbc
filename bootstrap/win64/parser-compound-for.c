...
void CFORSTMTBEGIN( void )
{
	...
	label$162:;
	{
		...
		goto label$164;
		label$165:;
		static const void* tmp$106[20ll] = {
			&&label$166,
			&&label$167,
			&&label$167,
			&&label$169,
	...
	*(struct $8FBSYMBOL**)((uint8*)STK$1 + 152ll) = EL$1;
		...
		{
			{
				...
				if( (TMP$102$4 - 1ull) > 7ull ) goto label$188;
				goto *tmp$107[TMP$102$4 - 1ull];
				label$188:;
			}
		}
		goto label$185;
		...
		{
			{
				...
				if( (TMP$104$4 - 1ull) > 7ull ) goto label$199;
				goto *tmp$108[TMP$104$4 - 1ull];
				label$199:;
			}
		}
		label$185:;
	...
	if( ISCONST$1 != 3ll ) goto label$209;
	{
		...
		TMP$105$2 = 49ll;
		label$215:;
		struct $7ASTNODE* vr$100 = ASTNEWBOP( TMP$105$2, vr$98, vr$94, (struct $8FBSYMBOL*)0ull, 1ll );
		EXPR$1 = vr$100;
	...
	{
		{
			...
			goto label$54;
			label$55:;
			static const void* tmp$118[1ll] = {
				&&label$56,
			};
			if( (TMP$96$3 - 20ull) > 0ull ) goto label$57;
			goto *tmp$118[TMP$96$3 - 20ull];
			label$54:;
		}
	}
	label$52:;
	...
	*(int64*)((uint8*)STK$1 + 168ll) = 0ll;
	...
	if( (FLAGS$1 & 2ll) != 0ll ) goto label$121;
	{
		...
		if( (FLAGS$1 & 1ll) != 0ll ) goto label$127;
		{
			...
			label$269:;
			if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$98$3 * 56ll)) + 16ll) == 0ll ) goto label$130;
			{
	...
	label$270:;
	if( ((int64)-(*(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$99$1 * 56ll)) + 16ll) == 0ll) & (int64)-((FLAGS$1 & 1ll) == 0ll)) == 0ll ) goto label$145;
	{
...
static struct $7ASTNODE* HUDTCALLOPOVL( struct $8FBSYMBOL* PARENT$1, $6AST_OP OP$1, struct $7ASTNODE* INST_EXPR$1, struct $7ASTNODE* SECOND_ARG$1, struct $7ASTNODE* THIRD_ARG$1 )
{
	...
	label$221:;
	{
		...
		struct $8FBARRAY1I11FB_CALL_ARGE tmp$109$2;
		*(struct $11FB_CALL_ARG**)&tmp$109$2 = (struct $11FB_CALL_ARG*)ARGS$2;
		*(struct $11FB_CALL_ARG**)((uint8*)&tmp$109$2 + 8ll) = (struct $11FB_CALL_ARG*)ARGS$2;
		*(int64*)((uint8*)&tmp$109$2 + 16ll) = 48ll;
		*(int64*)((uint8*)&tmp$109$2 + 24ll) = 24ll;
		*(int64*)((uint8*)&tmp$109$2 + 32ll) = 1ll;
		*(int64*)((uint8*)&tmp$109$2 + 40ll) = 49ll;
		*(int64*)((uint8*)&tmp$109$2 + 48ll) = 2ll;
		*(int64*)((uint8*)&tmp$109$2 + 56ll) = 0ll;
		*(int64*)((uint8*)&tmp$109$2 + 64ll) = 1ll;
		int64 PARAMS$2;
		PARAMS$2 = 1ll;
		{
			struct $11FB_CALL_ARG* TMP$110$3;
			TMP$110$3 = (struct $11FB_CALL_ARG*)ARGS$2;
			*(struct $7ASTNODE**)TMP$110$3 = SECOND_ARG$1;
			*($12FB_PARAMMODE*)((uint8*)TMP$110$3 + 8ll) = -1ll;
			*(struct $11FB_CALL_ARG**)((uint8*)TMP$110$3 + 16ll) = (struct $11FB_CALL_ARG*)0ull;
		}
		if( OP$1 != 26ll ) goto label$223;
		{
			if( THIRD_ARG$1 == (struct $7ASTNODE*)0ull ) goto label$225;
			{
				*(struct $11FB_CALL_ARG**)((int64)(struct $11FB_CALL_ARG*)ARGS$2 + 16ll) = (struct $11FB_CALL_ARG*)((int64)(struct $11FB_CALL_ARG*)ARGS$2 + 24ll);
				...
				{
					struct $11FB_CALL_ARG* TMP$111$5;
					TMP$111$5 = (struct $11FB_CALL_ARG*)((int64)(struct $11FB_CALL_ARG*)ARGS$2 + 24ll);
					*(struct $7ASTNODE**)TMP$111$5 = THIRD_ARG$1;
					*($12FB_PARAMMODE*)((uint8*)TMP$111$5 + 8ll) = -1ll;
					*(struct $11FB_CALL_ARG**)((uint8*)TMP$111$5 + 16ll) = (struct $11FB_CALL_ARG*)0ull;
				}
			}
			label$225:;
			label$224:;
	...
	if( SYM$1 != (struct $8FBSYMBOL*)0ull ) goto label$227;
	{
		...
		label$229:;
		{
			...
			FBSTRING* vr$23 = fb_StrConcat( &TMP$113$3, *(void**)(((int64)(struct $10AST_OPINFO*)AST_OPTB$ + (OP$1 << (5ll & 63ll))) + 16ll), 0ll, (void*)" (with", 7ll );
			fb_StrInit( (void*)&OP_VERSION$3, -1ll, (void*)vr$23, -1ll, 0 );
			{
				uint64 TMP$114$4;
				TMP$114$4 = (uint64)OP$1;
				goto label$231;
				label$232:;
				{
				...
				if( (TMP$114$4 - 24ull) > 2ull ) goto label$230;
				goto *tmp$119[TMP$114$4 - 24ull];
				label$230:;
			}
...
static void HFORSTMTCLOSE( struct $13FB_CMPSTMTSTK* STK$1 )
{
	...
	{
		int64 TMP$117$2;
		TMP$117$2 = *(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)STK$1 + 32ll) + 56ll) & 511ll;
		if( TMP$117$2 != 20ll ) goto label$245;
		label$246:;
		{
			HUDTSTEP( STK$1 );
