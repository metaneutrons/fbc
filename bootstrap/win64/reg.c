	...
	*(struct $7REG_REG**)((uint8*)THIS_$1 + 264ll) = (struct $7REG_REG*)0ull;
	{
		...
		N$1 = N$1 + 1ll;
		label$38:;
		if( N$1 <= TMP$107$2 ) goto label$41;
		label$40:;
	}
	label$37:;
}
...
static int64 REGFINDFAREST( struct $8REGCLASS* THIS_$1, int64 SIZE$1, int64 RESERVEDREG$1 )
{
	...
	R$1 = -1ll;
	{
		...
		I$2 = I$2 + 1ll;
		label$44:;
		if( I$2 <= TMP$108$2 ) goto label$47;
		label$46:;
	}
	fb$result$1 = R$1;
	label$43:;
...
static int64 REGALLOCATE( struct $8REGCLASS* THIS_$1, struct $6IRVREG* VREG$1, struct $6IRVREG* VAUXPARENT$1, uint64 SIZE$1 )
{
	...
	if( R$1 != -1ll ) goto label$57;
	{
		...
		TMP$109$2 = (int64)-((struct $6IRVREG*)(int64)-(*(int64*)*(struct $6IRVREG**)((uint8*)VREG$1 + 88ll) == 4ll) != (struct $6IRVREG*)0ull);
		goto label$203;
		label$58:;
		TMP$109$2 = 0ll;
		label$203:;
		if( TMP$109$2 == 0ll ) goto label$60;
		{
...
static void REGINITCLASS( struct $8REGCLASS* THIS_$1, struct $7FBARRAYI12REG_SIZEMASKE* SIZETB$1 )
{
	...
	REGCLEAR( THIS_$1 );
	{
		...
		I$1 = I$1 + 1ll;
		label$95:;
		if( I$1 <= TMP$110$2 ) goto label$98;
		label$97:;
	}
...
static int64 SREGFINDREG( struct $8REGCLASS* THIS_$1, struct $6IRVREG* VREG$1 )
{
	...
	label$101:;
	{
		...
		R$1 = R$1 + 1ll;
		label$103:;
		if( R$1 <= TMP$111$2 ) goto label$106;
		label$105:;
	}
	label$100:;
	return fb$result$1;
...
static void SREGXCHG( struct $8REGCLASS* THIS_$1, int64 R1$1 )
{
	...
	R2$1 = -1ll;
	{
		...
		I$1 = I$1 + 1ll;
		label$113:;
		if( I$1 <= TMP$112$2 ) goto label$116;
		label$115:;
	}
	{
		int64 TMP$113$2;
		TMP$113$2 = *(int64*)((uint8*)((uint8*)THIS_$1 + 536ll) + (R1$1 << (3ll & 63ll)));
		*(int64*)((uint8*)((uint8*)THIS_$1 + 536ll) + (R1$1 << (3ll & 63ll))) = *(int64*)((uint8*)((uint8*)THIS_$1 + 536ll) + (R2$1 << (3ll & 63ll)));
		*(int64*)((uint8*)((uint8*)THIS_$1 + 536ll) + (R2$1 << (3ll & 63ll))) = TMP$113$2;
	}
	label$112:;
}
...
static int64 SREGFINDFREEREG( struct $8REGCLASS* THIS_$1 )
{
	...
	label$121:;
	{
		...
		R$1 = R$1 + 1ll;
		label$123:;
		if( R$1 <= TMP$114$2 ) goto label$126;
		label$125:;
	}
	label$120:;
	return fb$result$1;
...
static int64 SREGFINDTOSREG( struct $8REGCLASS* THIS_$1 )
{
	...
	static int64 R$1;
	{
		...
		R$1 = R$1 + 1ll;
		label$141:;
		if( R$1 <= TMP$116$2 ) goto label$144;
		label$143:;
	}
	fb$result$1 = -1ll;
	label$140:;
	...
	*(int64*)((uint8*)THIS_$1 + 600ll) = *(int64*)((uint8*)THIS_$1 + 600ll) + -1ll;
	{
		...
		I$2 = I$2 + 1ll;
		label$151:;
		if( I$2 <= TMP$117$2 ) goto label$154;
		label$153:;
	}
	*(struct $6IRVREG**)((uint8*)((uint8*)THIS_$1 + (R$1 << (3ll & 63ll))) + 128ll) = VREG$1;
	*(struct $6IRVREG**)((uint8*)((uint8*)THIS_$1 + (R$1 << (3ll & 63ll))) + 192ll) = VAUXPARENT$1;
	...
	*(struct $6IRVREG**)((uint8*)((uint8*)THIS_$1 + (R$1 << (3ll & 63ll))) + 192ll) = (struct $6IRVREG*)0ull;
	{
		...
		I$1 = I$1 + 1ll;
		label$169:;
		if( I$1 <= TMP$118$2 ) goto label$172;
		label$171:;
	}
	*(int64*)((uint8*)THIS_$1 + 600ll) = *(int64*)((uint8*)THIS_$1 + 600ll) + 1ll;
	label$166:;
	...
	*(int64*)((uint8*)REG$1 + 600ll) = *(int64*)((uint8*)REG$1 + 120ll);
	{
		R$1 = 0ll;
		int64 TMP$119$2;
		TMP$119$2 = *(int64*)((uint8*)REG$1 + 120ll) + -1ll;
		goto label$197;
		label$200:;
		{
		...
		R$1 = R$1 + 1ll;
		label$197:;
		if( R$1 <= TMP$119$2 ) goto label$200;
		label$199:;
	}
	label$196:;
}
