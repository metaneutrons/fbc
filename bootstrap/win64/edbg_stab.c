...
typedef void (*tmp$111)( int64, int64 );
struct $7FBTOKEN;
struct $7FBTOKEN {
	int64 ID;
	int64 CLASS;
...
typedef void (*tmp$110)( struct $8FBSYMBOL*, int64, struct $8FBSYMBOL*, struct $8FBSYMBOL* );
typedef char* (*tmp$112)( int64 );
typedef char* (*tmp$113)( int64, int64 );
struct $9EMIT_VTBL {
	tmp$40 INIT;
	tmp$39 END;
	...
	tmp$43 SCOPEEND;
	tmp$111 SETSECTION;
	tmp$112 GETTYPESTRING;
	tmp$113 GETSECTIONSTRING;
};
...
void EDBGEMITHEADER( char* FILENAME$1 )
{
	...
	*(char**)((uint8*)&CTX$ + 320ll) = (char*)0ull;
	...
	FBSTRING* vr$9 = fb_StrConcat( &TMP$148$1, (void*)".file \x22", 8ll, (void*)vr$6, 0ll );
	__builtin_memset( &TMP$149$1, 0, 24ll );
	FBSTRING* vr$12 = fb_StrConcat( &TMP$149$1, (void*)vr$9, -1ll, (void*)"\x22", 2ll );
	fb_StrAssign( (void*)&TMP$150$1, -1ll, (void*)vr$12, -1ll, 0 );
	EMITWRITESTR( (char*)*(char**)&TMP$150$1, -1ll );
	fb_StrDelete( (FBSTRING*)&TMP$150$1 );
	...
	if( vr$15 != 0ll ) goto label$27;
	{
		...
		FBSTRING* vr$20 = fb_StrConcat( &TMP$151$2, (void*)vr$17, -1ll, (void*)"\x5C", 2ll );
		fb_StrAssign( (void*)&TMP$152$2, -1ll, (void*)vr$20, -1ll, 0 );
		HEMITSTABS( 100ll, (char*)*(char**)&TMP$152$2, 0ll, 0ll, (char*)*(char**)&LNAME$1 );
		fb_StrDelete( (FBSTRING*)&TMP$152$2 );
	}
	label$27:;
	label$26:;
	HEMITSTABS( 100ll, (char*)FILENAME$1, 0ll, 0ll, (char*)*(char**)&LNAME$1 );
	(*(tmp$111*)((uint8*)&EMIT$ + 448ll))( 3ll, 0ll );
...
void EDBGEMITLINE( struct $8FBSYMBOL* PROC$1, int64 LNUM$1, struct $8FBSYMBOL* LABEL$1 )
{
	...
	*(int64*)((uint8*)&CTX$ + 48ll) = LNUM$1;
	...
	char* vr$10 = HMAKESTABN( 68ll, 0ll, LNUM$1, (char*)*(char**)&TMP$156$1 );
	S$1 = vr$10;
...
void EDBGEMITLINEFLUSH( struct $8FBSYMBOL* PROC$1, int64 LNUM$1, struct $8FBSYMBOL* LABEL$1 )
{
	...
	HEMITSTABN( 68ll, 0ll, LNUM$1, (char*)*(char**)&TMP$159$1 );
...
void EDBGEMITPROCHEADER( struct $8FBSYMBOL* PROC$1 )
{
	...
	if( (*(int64*)((uint8*)PROC$1 + 24ll) & 4096ll) == 0ll ) goto label$99;
	{
		...
		fb_StrAssign( (void*)&TMP$160$2, -1ll, (void*)vr$6, -1ll, 0 );
		HEMITSTABS( 42ll, (char*)*(char**)&TMP$160$2, 0ll, 1ll, (char*)vr$4 );
		fb_StrDelete( (FBSTRING*)&TMP$160$2 );
...
void EDBGEMITPROCFOOTER( struct $8FBSYMBOL* PROC$1, struct $8FBSYMBOL* INITLABEL$1, struct $8FBSYMBOL* EXITLABEL$1 )
{
	...
	FBSTRING* vr$5 = fb_StrConcat( &TMP$170$1, (void*)&LNAME$1, -1ll, (void*)"-", 2ll );
	__builtin_memset( &TMP$171$1, 0, 24ll );
	FBSTRING* vr$8 = fb_StrConcat( &TMP$171$1, (void*)vr$5, -1ll, (void*)&PROCNAME$1, -1ll );
	fb_StrAssign( (void*)&TMP$172$1, -1ll, (void*)vr$8, -1ll, 0 );
	HEMITSTABS( 36ll, (char*)"", 0ll, 0ll, (char*)*(char**)&TMP$172$1 );
...
void EDBGEMITPROCARG( struct $8FBSYMBOL* SYM$1 )
{
	...
	FBSTRING* vr$5 = fb_StrConcat( &TMP$214$1, *(void**)((uint8*)SYM$1 + 32ll), 0ll, (void*)":", 2ll );
	...
	fb_StrAssign( (void*)&TMP$217$1, -1ll, (void*)vr$15, -1ll, 0 );
	HEMITSTABS( 160ll, (char*)*(char**)&DESC$1, 0ll, 0ll, (char*)*(char**)&TMP$217$1 );
...
static void HEMITSTABS( int64 _TYPE$1, char* _STRING$1, int64 _OTHER$1, int64 _DESC$1, char* _VALUE$1 )
{
	...
	FBSTRING* vr$3 = fb_StrConcat( &TMP$138$1, (void*)&OSTR$1, -1ll, (void*)vr$0, 0ll );
	...
	FBSTRING* vr$9 = fb_StrConcat( &TMP$141$1, (void*)&OSTR$1, -1ll, (void*)_VALUE$1, 0ll );
...
static char* HMAKESTABN( int64 _TYPE$1, int64 _OTHER$1, int64 _DESC$1, char* _VALUE$1 )
{
	...
	FBSTRING* vr$6 = fb_StrConcat( &TMP$143$1, (void*)&OSTR$1, -1ll, (void*)_VALUE$1, 0ll );
...
static void HDECLLOCALVARS( struct $8FBSYMBOL* PROC$1, struct $8FBSYMBOL* BLK$1, struct $8FBSYMBOL* INILABEL$1, struct $8FBSYMBOL* ENDLABEL$1 )
{
	...
	{
		{
			$12FB_SYMBCLASS TMP$163$3;
			TMP$163$3 = *($12FB_SYMBCLASS*)S$1;
			if( TMP$163$3 != 1ll ) goto label$109;
			label$110:;
			{
			...
			goto label$108;
			label$109:;
			if( TMP$163$3 != 15ll ) goto label$115;
			label$116:;
			{
	...
	FBSTRING* vr$20 = fb_StrConcat( &TMP$164$1, (void*)vr$17, 0ll, (void*)"-", 2ll );
	__builtin_memset( &TMP$165$1, 0, 24ll );
	FBSTRING* vr$23 = fb_StrConcat( &TMP$165$1, (void*)vr$20, -1ll, (void*)vr$16, 0ll );
	fb_StrAssign( (void*)&TMP$166$1, -1ll, (void*)vr$23, -1ll, 0 );
	HEMITSTABN( 192ll, 0ll, 0ll, (char*)*(char**)&TMP$166$1 );
	...
	FBSTRING* vr$35 = fb_StrConcat( &TMP$167$1, (void*)vr$32, 0ll, (void*)"-", 2ll );
	__builtin_memset( &TMP$168$1, 0, 24ll );
	FBSTRING* vr$38 = fb_StrConcat( &TMP$168$1, (void*)vr$35, -1ll, (void*)vr$31, 0ll );
	fb_StrAssign( (void*)&TMP$169$1, -1ll, (void*)vr$38, -1ll, 0 );
	HEMITSTABN( 224ll, 0ll, 0ll, (char*)*(char**)&TMP$169$1 );
...
static FBSTRING* HGETDATATYPE( struct $8FBSYMBOL* SYM$1, int64 REQUESTEDDIMTBELEMENTS$1 )
{
				...
				{
					{
						...
						I$6 = 0ll;
						int64 TMP$178$6;
						TMP$178$6 = *(int64*)((uint8*)SYM$1 + 104ll) + -1ll;
						goto label$145;
						label$148:;
						{
							FBSTRING TMP$179$7;
							...
							FBSTRING* vr$48 = fb_StrConcat( &TMP$179$7, (void*)vr$45, -1ll, (void*)";", 2ll );
							__builtin_memset( &TMP$180$7, 0, 24ll );
							FBSTRING* vr$52 = fb_StrConcat( &TMP$180$7, (void*)&DESC$1, -1ll, (void*)vr$48, -1ll );
							...
							FBSTRING* vr$60 = fb_StrConcat( &TMP$181$7, (void*)vr$57, -1ll, (void*)";", 2ll );
							__builtin_memset( &TMP$182$7, 0, 24ll );
							FBSTRING* vr$64 = fb_StrConcat( &TMP$182$7, (void*)&DESC$1, -1ll, (void*)vr$60, -1ll );
							fb_StrAssign( (void*)&DESC$1, -1ll, (void*)vr$64, -1ll, 0 );
						}
						label$146:;
						I$6 = I$6 + 1ll;
						label$145:;
						if( I$6 <= TMP$178$6 ) goto label$148;
						label$147:;
					}
				}
				label$143:;
	...
	DTYPE$1 = DTYPE$1 & -513ll;
	{
		...
		label$157:;
		{
			...
			FBSTRING* vr$82 = fb_StrConcat( &TMP$184$3, (void*)&DESC$1, -1ll, (void*)vr$78, -1ll );
		...
		label$160:;
		{
			...
			FBSTRING* vr$90 = fb_StrConcat( &TMP$185$3, (void*)&DESC$1, -1ll, (void*)vr$86, -1ll );
		...
		goto label$155;
		label$156:;
		static const void* tmp$218[14ll] = {
			&&label$160,
			&&label$165,
			&&label$165,
			&&label$165,
		...
		if( (TMP$183$2 - 10ull) > 13ull ) goto label$165;
		goto *tmp$218[TMP$183$2 - 10ull];
		label$155:;
	}
	fb_StrAssign( (void*)&fb$result$1, -1ll, (void*)&DESC$1, -1ll, 0 );
	fb_StrDelete( (FBSTRING*)&DESC$1 );
...
static void HDECLUDT( struct $8FBSYMBOL* SYM$1, int64 DIMTBELEMENTS$1 )
{
	...
	*(uint64*)&CTX$ = *(uint64*)&CTX$ + 1ull;
	...
	FBSTRING* vr$11 = fb_StrConcat( &TMP$189$1, (void*)":Tt", 4ll, (void*)vr$8, -1ll );
	__builtin_memset( &TMP$190$1, 0, 24ll );
	FBSTRING* vr$14 = fb_StrConcat( &TMP$190$1, (void*)vr$11, -1ll, (void*)"=s", 3ll );
	__builtin_memset( &TMP$191$1, 0, 24ll );
	FBSTRING* vr$17 = fb_StrConcat( &TMP$191$1, (void*)vr$14, -1ll, (void*)vr$6, -1ll );
	__builtin_memset( &TMP$192$1, 0, 24ll );
	FBSTRING* vr$21 = fb_StrConcat( &TMP$192$1, (void*)&DESC$1, -1ll, (void*)vr$17, -1ll );
	...
	if( FLD$1 == (struct $8FBSYMBOL*)0ull ) goto label$169;
	{
		if( (*(int64*)((uint8*)FLD$1 + 8ll) & 4ll) != 0ll ) goto label$171;
		{
			...
			FBSTRING* vr$30 = fb_StrConcat( &TMP$193$3, *(void**)((uint8*)FLD$1 + 32ll), 0ll, (void*)":", 2ll );
			__builtin_memset( &TMP$194$3, 0, 24ll );
			FBSTRING* vr$33 = fb_StrConcat( &TMP$194$3, (void*)vr$30, -1ll, (void*)vr$26, -1ll );
			__builtin_memset( &TMP$195$3, 0, 24ll );
			FBSTRING* vr$37 = fb_StrConcat( &TMP$195$3, (void*)&DESC$1, -1ll, (void*)vr$33, -1ll );
			fb_StrAssign( (void*)&DESC$1, -1ll, (void*)vr$37, -1ll, 0 );
			if( *(int64*)((uint8*)FLD$1 + 192ll) <= 0ll ) goto label$172;
			TMP$196$3 = *(int64*)((uint8*)FLD$1 + 184ll);
			goto label$215;
			label$172:;
			TMP$196$3 = 0ll;
			label$215:;
			FBSTRING* vr$44 = fb_LongintToStr( (*(int64*)((uint8*)FLD$1 + 88ll) << (3ll & 63ll)) + TMP$196$3 );
			__builtin_memset( &TMP$197$3, 0, 24ll );
			FBSTRING* vr$47 = fb_StrConcat( &TMP$197$3, (void*)",", 2ll, (void*)vr$44, -1ll );
			__builtin_memset( &TMP$198$3, 0, 24ll );
			FBSTRING* vr$51 = fb_StrConcat( &TMP$198$3, (void*)&DESC$1, -1ll, (void*)vr$47, -1ll );
			fb_StrAssign( (void*)&DESC$1, -1ll, (void*)vr$51, -1ll, 0 );
			if( *(int64*)((uint8*)FLD$1 + 192ll) <= 0ll ) goto label$173;
			TMP$199$3 = *(int64*)((uint8*)FLD$1 + 192ll);
			goto label$216;
			label$173:;
			int64 vr$55 = SYMBGETREALSIZE( FLD$1 );
			TMP$199$3 = vr$55 << (3ll & 63ll);
			label$216:;
			FBSTRING* vr$57 = fb_LongintToStr( TMP$199$3 );
			__builtin_memset( &TMP$200$3, 0, 24ll );
			FBSTRING* vr$60 = fb_StrConcat( &TMP$200$3, (void*)",", 2ll, (void*)vr$57, -1ll );
			__builtin_memset( &TMP$201$3, 0, 24ll );
			FBSTRING* vr$64 = fb_StrConcat( &TMP$201$3, (void*)&DESC$1, -1ll, (void*)vr$60, -1ll );
			fb_StrAssign( (void*)&DESC$1, -1ll, (void*)vr$64, -1ll, 0 );
			fb_StrConcatAssign( (void*)&DESC$1, -1ll, (void*)";", 2ll, 0 );
		}
		label$171:;
...
static void HDECLENUM( struct $8FBSYMBOL* SYM$1 )
{
	...
	*(uint64*)&CTX$ = *(uint64*)&CTX$ + 1ull;
	...
	FBSTRING* vr$10 = fb_StrConcat( &TMP$204$1, (void*)":T", 3ll, (void*)vr$7, -1ll );
	__builtin_memset( &TMP$205$1, 0, 24ll );
	FBSTRING* vr$13 = fb_StrConcat( &TMP$205$1, (void*)vr$10, -1ll, (void*)"=e", 3ll );
	__builtin_memset( &TMP$206$1, 0, 24ll );
	FBSTRING* vr$17 = fb_StrConcat( &TMP$206$1, (void*)&DESC$1, -1ll, (void*)vr$13, -1ll );
	...
	if( E$1 == (struct $8FBSYMBOL*)0ull ) goto label$177;
	{
		...
		FBSTRING* vr$25 = fb_StrConcat( &TMP$207$2, *(void**)((uint8*)E$1 + 32ll), 0ll, (void*)":", 2ll );
		__builtin_memset( &TMP$208$2, 0, 24ll );
		FBSTRING* vr$28 = fb_StrConcat( &TMP$208$2, (void*)vr$25, -1ll, (void*)vr$21, -1ll );
		__builtin_memset( &TMP$209$2, 0, 24ll );
		FBSTRING* vr$31 = fb_StrConcat( &TMP$209$2, (void*)vr$28, -1ll, (void*)",", 2ll );
		__builtin_memset( &TMP$210$2, 0, 24ll );
		FBSTRING* vr$35 = fb_StrConcat( &TMP$210$2, (void*)&DESC$1, -1ll, (void*)vr$31, -1ll );
