...
void SYMBVARINIT( void )
{
	...
	*(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 199208ll) = vr$0;
	SYMBADDFIELD( *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 199208ll), (char*)"elements", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$94$1, 8ll, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, 0ll );
	SYMBADDFIELD( *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 199208ll), (char*)"lbound", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$94$1, 8ll, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, 0ll );
	SYMBADDFIELD( *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 199208ll), (char*)"ubound", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$94$1, 8ll, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, 0ll );
...
struct $8FBSYMBOL* SYMBADDARRAYDESCRIPTORTYPE( int64 DIMENSIONS$1, int64 ARRAYDTYPE$1, struct $8FBSYMBOL* ARRAYSUBTYPE$1 )
{
	...
	struct $8FBSYMBOL* vr$20 = SYMBLOOKUPINTERNALLYMANGLEDSUBTYPE( (char*)*(char**)&ID$1, (struct $8FBSYMBOL*)0ull, ($13FB_SYMBATTRIB*)&ATTRIB$1, ($13FB_PROCATTRIB*)&PATTRIB$1, &TMP$104$1, &SYMTB$1, &HASHTB$1 );
	SYM$1 = vr$20;
	...
	TMP$105$1 = (int64)-(*(int64*)ARRAYSUBTYPE$1 == 10ll);
	goto label$34;
	label$28:;
	TMP$105$1 = 0ll;
	label$34:;
	if( TMP$105$1 == 0ll ) goto label$29;
	TMP$106$1 = (int64)-((*(int64*)((uint8*)ARRAYSUBTYPE$1 + 8ll) & 128ll) != 0ll);
	goto label$35;
	label$29:;
	TMP$106$1 = 0ll;
	label$35:;
	if( TMP$106$1 == 0ll ) goto label$31;
	{
	...
	*(int64*)((int64)(struct $10FBARRAYDIM*)DTB$1 + 8ll) = 0ll;
	SYMBADDFIELD( SYM$1, (char*)"data", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$100$1, (((ARRAYDTYPE$1 & 31ll) | ((ARRAYDTYPE$1 & 480ll) + 32ll)) | ((ARRAYDTYPE$1 & 261632ll) << (1ll & 63ll))) | (ARRAYDTYPE$1 & 32505856ll), ARRAYSUBTYPE$1, 0ll, 0ll, 0ll );
	SYMBADDFIELD( SYM$1, (char*)"ptr", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$100$1, (((ARRAYDTYPE$1 & 31ll) | ((ARRAYDTYPE$1 & 480ll) + 32ll)) | ((ARRAYDTYPE$1 & 261632ll) << (1ll & 63ll))) | (ARRAYDTYPE$1 & 32505856ll), ARRAYSUBTYPE$1, 0ll, 0ll, 0ll );
	SYMBADDFIELD( SYM$1, (char*)"size", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$100$1, 8ll, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, 0ll );
	SYMBADDFIELD( SYM$1, (char*)"element_len", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$100$1, 8ll, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, 0ll );
	SYMBADDFIELD( SYM$1, (char*)"dimensions", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$100$1, 8ll, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, 0ll );
	SYMBADDFIELD( SYM$1, (char*)"flags", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$100$1, 8ll, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, 0ll );
	...
	*(int64*)((int64)(struct $10FBARRAYDIM*)DTB$1 + 8ll) = DIMENSIONS$1 + -1ll;
	SYMBADDFIELD( SYM$1, (char*)"dimTB", 1ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$100$1, 20ll, *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 199208ll), 0ll, 0ll, 0ll );
...
struct $8FBSYMBOL* SYMBADDARRAYDESC( struct $8FBSYMBOL* ARRAY$1 )
{
	...
	label$39:;
	{
		...
		if( ((int64)-((*(int64*)((uint8*)ARRAY$1 + 8ll) & 8ll) != 0ll) | ISDYNAMIC$1) == 0ll ) goto label$43;
		{
			...
			if( (*(int64*)((uint8*)ARRAY$1 + 8ll) & 1048576ll) == 0ll ) goto label$45;
			{
				...
				TMP$114$4 = 0ll;
				char* vr$24 = HMANGLEBUILTINTYPE( *(int64*)((uint8*)ARRAY$1 + 56ll) & 511ll, &TMP$114$4 );
				__builtin_memset( &TMP$115$4, 0, 24ll );
				FBSTRING* vr$27 = fb_StrConcat( &TMP$115$4, (void*)&TEMPID$1, -1ll, (void*)vr$24, 0ll );
				fb_StrAssign( (void*)&TEMPID$1, -1ll, (void*)vr$27, -1ll, 0 );
				if( *(int64*)((uint8*)&ENV$ + 208ll) != 1ll ) goto label$47;
				{
		...
		label$43:;
		{
			...
			ID$1 = vr$28;
			if( (int64)*(int16*)((uint8*)ARRAY$1 + 74ll) == 0ll ) goto label$49;
			{
				ID_ALIAS$1 = ID$1;
			}
			label$49:;
		...
		if( ISDYNAMIC$1 != 0ll ) goto label$51;
		{
			if( (*(int64*)((uint8*)ARRAY$1 + 8ll) & 16ll) == 0ll ) goto label$53;
			{
	...
	label$38:;
	ATTRIB$1 = ATTRIB$1 | 8192ll;
	if( *(int64*)ARRAY$1 != 12ll ) goto label$55;
	{
		if( *(uint64*)((uint8*)&PARSER$ + 200ll) != 0ull ) goto label$57;
		{
	...
	DESC$1 = vr$46;
	if( DESC$1 != (struct $8FBSYMBOL*)0ull ) goto label$59;
	{
		goto label$37;
	}
	label$59:;
...
int64 SYMBARRAYHASUNKNOWNBOUNDS( struct $8FBSYMBOL* SYM$1 )
{
	...
	label$72:;
	fb$result$1 = 0ll;
	if( (*(int64*)((uint8*)SYM$1 + 8ll) & 16388ll) == 0ll ) goto label$75;
	{
		goto label$73;
	}
	label$75:;
	label$74:;
	{
		...
		I$2 = 0ll;
		int64 TMP$117$2;
		TMP$117$2 = *(int64*)((uint8*)SYM$1 + 104ll) + -1ll;
		goto label$76;
		label$79:;
		{
			if( *(int64*)((uint8*)((uint8*)*(struct $10FBARRAYDIM**)((uint8*)SYM$1 + 112ll) + (I$2 << (4ll & 63ll))) + 8ll) != -9223372036854775808ull ) goto label$81;
			{
				fb$result$1 = -1ll;
				goto label$73;
			}
		...
		I$2 = I$2 + 1ll;
		label$76:;
		if( I$2 <= TMP$117$2 ) goto label$79;
		label$78:;
	}
	label$73:;
	return fb$result$1;
...
{
	label$82:;
	if( *(int64*)((uint8*)SYM$1 + 104ll) != 0ll ) goto label$85;
	{
		goto label$83;
	}
	label$85:;
	...
	if( vr$1 == 0ll ) goto label$87;
	{
		goto label$83;
	}
	label$87:;
	label$86:;
	if( *(struct $8FBSYMBOL**)((uint8*)SYM$1 + 136ll) != (struct $8FBSYMBOL*)0ull ) goto label$89;
	{
	...
	*(struct $10FBARRAYDIM**)((uint8*)SYM$1 + 112ll) = (struct $10FBARRAYDIM*)vr$3;
	{
		...
		I$2 = I$2 + 1ll;
		label$92:;
		if( I$2 <= TMP$118$2 ) goto label$95;
		label$94:;
	}
...
void SYMBSETFIXEDSIZEARRAYDIMENSIONELEMENTS( struct $8FBSYMBOL* SYM$1, int64 DIMENSION$1, int64 ELEMENTS$1 )
{
	label$96:;
	{
		struct $10FBARRAYDIM* TMP$119$2;
		TMP$119$2 = (struct $10FBARRAYDIM*)((uint8*)*(struct $10FBARRAYDIM**)((uint8*)SYM$1 + 112ll) + (DIMENSION$1 << (4ll & 63ll)));
		*(int64*)((uint8*)TMP$119$2 + 8ll) = (*(int64*)TMP$119$2 + ELEMENTS$1) + -1ll;
	}
	SYMBRECALCARRAYDIFFANDELEMENTS( SYM$1 );
	label$97:;
}
...
{
	label$98:;
	if( DIMENSIONS$1 != -1ll ) goto label$101;
	{
		goto label$99;
	}
	label$101:;
	...
	if( ((int64)-(EXISTINGDIMENSIONS$1 != -1ll) & (int64)-(EXISTINGDIMENSIONS$1 != DIMENSIONS$1)) == 0ll ) goto label$103;
	{
...
{
	label$106:;
	if( DIMENSIONS$1 == 0ll ) goto label$109;
	{
		if( (*(int64*)((uint8*)SYM$1 + 8ll) & 16388ll) == 0ll ) goto label$111;
		{
			*(int64*)((uint8*)SYM$1 + 104ll) = DIMENSIONS$1;
		}
		goto label$110;
		...
		label$110:;
		if( ((int64)-(*(int64*)SYM$1 != 12ll) & (int64)-((*(int64*)((uint8*)SYM$1 + 8ll) & 16384ll) == 0ll)) == 0ll ) goto label$113;
		{
...
struct $8FBSYMBOL* SYMBADDVAR( char* ID$1, char* ID_ALIAS$1, int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, int64 LGT$1, int64 DIMENSIONS$1, struct $7FBARRAYI10FBARRAYDIME* DTB$1, $13FB_SYMBATTRIB ATTRIB$1, $10FB_SYMBOPT OPTIONS$1 )
{
	...
	label$117:;
	label$116:;
	if( ID_ALIAS$1 != (char*)0ull ) goto label$119;
	{
		if( *(int64*)((uint8*)&PARSER$ + 208ll) == 0ll ) goto label$121;
		{
			ID_ALIAS$1 = ID$1;
		}
		label$121:;
	...
	label$118:;
	if( ISGLOBAL$1 != 0ll ) goto label$123;
	{
		ATTRIB$1 = ATTRIB$1 | 128ll;
		if( (OPTIONS$1 & 2ll) != 0ll ) goto label$125;
		{
	...
	label$123:;
	{
		...
		if( *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 197024ll) == (struct $8FBSYMBOL*)((uint8*)&SYMB$ + 196704ll) ) goto label$127;
		{
	...
	S$1 = vr$17;
	if( S$1 != (struct $8FBSYMBOL*)0ull ) goto label$131;
	{
		goto label$115;
	}
	label$131:;
	...
	*(int64*)((uint8*)S$1 + 88ll) = 0ll;
	...
	goto label$132;
	label$133:;
	if( (OPTIONS$1 & 8ll) == 0ll ) goto label$134;
	{
...
struct $8FBSYMBOL* SYMBADDTEMPVAR( int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	label$137:;
	static struct $10FBARRAYDIM DTB$1[1];
	static struct $8FBARRAY1I10FBARRAYDIME tmp$120$1 = { (struct $10FBARRAYDIM*)DTB$1, (struct $10FBARRAYDIM*)DTB$1, 16ll, 16ll, 1ll, 49ll, { { 1ll, 0ll, 0ll } } };
	$10FB_SYMBOPT OPTIONS$1;
	OPTIONS$1 = 0ll;
	if( (*(int64*)((uint8*)&ENV$ + 1424ll) & 2ll) != 0ll ) goto label$140;
	{
	...
	struct $8FBSYMBOL* vr$4 = SYMBADDVAR( (char*)vr$3, (char*)0ull, DTYPE$1, SUBTYPE$1, 0ll, 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$120$1, 4096ll, OPTIONS$1 );
	SYM$1 = vr$4;
...
struct $8FBSYMBOL* SYMBADDIMPLICITVAR( int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, int64 OPTIONS$1 )
{
	...
	label$141:;
	static struct $10FBARRAYDIM DTB$1[1];
	static struct $8FBARRAY1I10FBARRAYDIME tmp$121$1 = { (struct $10FBARRAYDIM*)DTB$1, (struct $10FBARRAYDIM*)DTB$1, 16ll, 16ll, 1ll, 49ll, { { 1ll, 0ll, 0ll } } };
	struct $8FBSYMBOL* SYM$1;
	char* vr$1 = SYMBUNIQUEID( (boolean)0ll );
	struct $8FBSYMBOL* vr$2 = SYMBADDVAR( (char*)vr$1, (char*)0ull, DTYPE$1, SUBTYPE$1, 0ll, 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$121$1, 0ll, OPTIONS$1 );
	SYM$1 = vr$2;
	*($12FB_SYMBSTATS*)((uint8*)SYM$1 + 24ll) = *(int64*)((uint8*)SYM$1 + 24ll) | 16ll;
	fb$result$1 = SYM$1;
	label$142:;
...
int64 SYMBGETREALSIZE( struct $8FBSYMBOL* SYM$1 )
{
	...
	label$145:;
	int64 SIZE$1;
	if( (*(int64*)((uint8*)SYM$1 + 8ll) & 262144ll) == 0ll ) goto label$147;
	TMP$122$1 = *(int64*)((uint8*)&ENV$ + 592ll);
	goto label$148;
	label$147:;
	TMP$122$1 = *(int64*)((uint8*)SYM$1 + 80ll);
	label$148:;
	SIZE$1 = TMP$122$1;
...
void SYMBGETREALTYPE( struct $8FBSYMBOL* SYM$1, int64* DTYPE$1, struct $8FBSYMBOL** SUBTYPE$1 )
{
	...
	*SUBTYPE$1 = *(struct $8FBSYMBOL**)((uint8*)SYM$1 + 64ll);
	if( (*(int64*)((uint8*)SYM$1 + 8ll) & 114688ll) == 0ll ) goto label$152;
	{
		int64 PARAMMODE$2;
		__builtin_memset( &PARAMMODE$2, 0, 8ll );
		struct $8FBSYMBOL* BYDESCREALSUBTYPE$2;
		__builtin_memset( &BYDESCREALSUBTYPE$2, 0, 8ll );
		if( (*(int64*)((uint8*)SYM$1 + 8ll) & 65536ll) == 0ll ) goto label$154;
		{
			PARAMMODE$2 = 2ll;
		}
		goto label$153;
		label$154:;
		if( (*(int64*)((uint8*)SYM$1 + 8ll) & 16384ll) == 0ll ) goto label$155;
		{
			PARAMMODE$2 = 3ll;
	...
	goto label$151;
	label$152:;
	if( ((int64)-((*(int64*)((uint8*)SYM$1 + 8ll) & 262144ll) != 0ll) | (int64)-((*(int64*)((uint8*)SYM$1 + 8ll) & 512ll) != 0ll)) == 0ll ) goto label$156;
	{
...
int64 SYMBCALCARRAYELEMENTS( struct $8FBSYMBOL* SYM$1, int64 FIRST$1 )
{
	...
	TOTALELEMENTS$1 = 1ll;
	{
		...
		I$2 = FIRST$1;
		int64 TMP$123$2;
		TMP$123$2 = *(int64*)((uint8*)SYM$1 + 104ll) + -1ll;
		goto label$159;
		label$162:;
		{
		...
		I$2 = I$2 + 1ll;
		label$159:;
		if( I$2 <= TMP$123$2 ) goto label$162;
		label$161:;
	}
...
int64 SYMBCHECKARRAYSIZE( int64 DIMENSIONS$1, struct $10FBARRAYDIM* DIMTB$1, int64 LGT$1, int64 IS_ON_STACK$1 )
{
	...
	ALLELEMENTS$1 = 1ull;
	{
		...
		I$2 = 0ll;
		int64 TMP$124$2;
		TMP$124$2 = DIMENSIONS$1 + -1ll;
		goto label$165;
		label$168:;
		{
			if( *(int64*)((uint8*)((uint8*)DIMTB$1 + (I$2 << (4ll & 63ll))) + 8ll) != -9223372036854775808ull ) goto label$170;
			{
				ELEMENTS$1 = 1ull;
			}
			goto label$169;
			...
			label$169:;
			if( ELEMENTS$1 <= 2147483647ull ) goto label$172;
			{
				FOUND_TOO_BIG$1 = -1ll;
				goto label$167;
			}
			...
			if( ALLELEMENTS$1 <= 2147483647ull ) goto label$174;
			{
				FOUND_TOO_BIG$1 = -1ll;
				goto label$167;
			}
		...
		I$2 = I$2 + 1ll;
		label$165:;
		if( I$2 <= TMP$124$2 ) goto label$168;
		label$167:;
	}
	if( FOUND_TOO_BIG$1 != 0ll ) goto label$176;
	{
		ALLELEMENTS$1 = ALLELEMENTS$1 * (uint64)LGT$1;
		if( ALLELEMENTS$1 <= 2147483647ull ) goto label$178;
		{
			FOUND_TOO_BIG$1 = -1ll;
		}
		label$178:;
	...
	label$176:;
	label$175:;
	if( FOUND_TOO_BIG$1 == 0ll ) goto label$180;
	{
		fb$result$1 = 0ll;
	}
	goto label$179;
	label$180:;
	{
		if( (IS_ON_STACK$1 & (int64)-(ALLELEMENTS$1 > *(uint64*)((uint8*)&ENV$ + 488ll))) == 0ll ) goto label$182;
		{
...
int64 SYMBGETVARHASCTOR( struct $8FBSYMBOL* S$1 )
{
	...
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$183:;
	if( (*(int64*)((uint8*)S$1 + 8ll) & 512011ll) == 0ll ) goto label$186;
	{
		fb$result$1 = 0ll;
		goto label$184;
	}
	...
	{
		int64 TMP$125$2;
		TMP$125$2 = *(int64*)((uint8*)S$1 + 56ll) & 511ll;
		if( TMP$125$2 != 17ll ) goto label$188;
		label$189:;
		{
			fb$result$1 = -1ll;
			goto label$184;
		...
		goto label$187;
		label$188:;
		if( TMP$125$2 != 39ll ) goto label$190;
		label$191:;
		{
			if( (*(int64*)((uint8*)S$1 + 24ll) & 16777216ll) == 0ll ) goto label$193;
			{
				fb$result$1 = -1ll;
				goto label$184;
			}
	...
	if( *(int64*)((uint8*)S$1 + 104ll) == 0ll ) goto label$195;
	{
		fb$result$1 = -1ll;
		goto label$184;
	}
...
int64 SYMBGETVARHASDTOR( struct $8FBSYMBOL* S$1 )
{
	...
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$196:;
	if( (*(int64*)((uint8*)S$1 + 8ll) & 512011ll) == 0ll ) goto label$199;
	{
		fb$result$1 = 0ll;
		goto label$197;
	}
	...
	{
		int64 TMP$126$2;
		TMP$126$2 = *(int64*)((uint8*)S$1 + 56ll) & 511ll;
		if( TMP$126$2 != 17ll ) goto label$201;
		label$202:;
		{
			fb$result$1 = -1ll;
			goto label$197;
		...
		goto label$200;
		label$201:;
		if( TMP$126$2 != 39ll ) goto label$203;
		label$204:;
		{
			if( (*(int64*)((uint8*)S$1 + 24ll) & 16777216ll) == 0ll ) goto label$206;
			{
				fb$result$1 = -1ll;
				goto label$197;
			}
	...
	if( *(int64*)((uint8*)S$1 + 104ll) == 0ll ) goto label$208;
	{
		if( (*(int64*)((uint8*)S$1 + 8ll) & 4ll) == 0ll ) goto label$210;
		{
			fb$result$1 = -1ll;
			goto label$197;
		}
...
struct $8FBSYMBOL* SYMBCLONEVAR( struct $8FBSYMBOL* SYM$1 )
{
	...
	if( (*(int64*)((uint8*)SYM$1 + 8ll) & 8192ll) == 0ll ) goto label$214;
	{
	...
	goto label$213;
	label$214:;
	if( (*(int64*)((uint8*)SYM$1 + 8ll) & 4096ll) == 0ll ) goto label$215;
	{
	...
	label$215:;
	{
		if( (*(int64*)((uint8*)SYM$1 + 8ll) & 4ll) != 0ll ) goto label$217;
		{
			{
				int64 I$4;
				I$4 = 0ll;
				int64 TMP$128$4;
				TMP$128$4 = *(int64*)((uint8*)SYM$1 + 104ll) + -1ll;
				goto label$218;
				label$221:;
				{
				...
				I$4 = I$4 + 1ll;
				label$218:;
				if( I$4 <= TMP$128$4 ) goto label$221;
				label$220:;
			}
		}
		label$217:;
		label$216:;
		struct $8FBSYMBOL* vr$27 = SYMBADDVAR( (char*)*(char**)((uint8*)SYM$1 + 32ll), (char*)0ull, *(int64*)((uint8*)SYM$1 + 56ll) & 511ll, *(struct $8FBSYMBOL**)((uint8*)SYM$1 + 64ll), 0ll, *(int64*)((uint8*)SYM$1 + 104ll), (struct $7FBARRAYI10FBARRAYDIME*)&tmp$127$1, *($13FB_SYMBATTRIB*)((uint8*)SYM$1 + 8ll), 0ll );
		fb$result$1 = vr$27;
	}
	label$213:;
	label$212:;
...
int64 SYMBVARCHECKACCESS( struct $8FBSYMBOL* SYM$1 )
{
	...
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$222:;
	if( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 216ll) == *(struct $8FBSYMBOL**)((uint8*)&ENV$ + 1408ll) ) goto label$225;
	{
		if( (*(int64*)((uint8*)SYM$1 + 8ll) & 128ll) == 0ll ) goto label$227;
		{
			if( (int64)*(uint16*)((uint8*)SYM$1 + 72ll) != 0ll ) goto label$229;
			{
				fb$result$1 = 0ll;
				goto label$223;
			}
		...
		goto label$226;
		label$227:;
		if( (*(int64*)((uint8*)SYM$1 + 8ll) & 1ll) != 0ll ) goto label$230;
		{
			fb$result$1 = 0ll;
			goto label$223;
		}
...
void SYMBDELVAR( struct $8FBSYMBOL* S$1, int64 IS_TBDEL$1 )
{
	...
	if( IS_TBDEL$1 != 0ll ) goto label$234;
	{
		if( *(struct $8FBSYMBOL**)((uint8*)S$1 + 136ll) == (struct $8FBSYMBOL*)0ull ) goto label$236;
		{
	...
	label$234:;
	label$233:;
	if( (*(int64*)((uint8*)S$1 + 8ll) & 1024ll) == 0ll ) goto label$238;
	{
		if( (*(int64*)((uint8*)S$1 + 56ll) & 511ll) != 7ll ) goto label$240;
		{
			if( *(uint16**)((uint8*)S$1 + 96ll) == (uint16*)0ull ) goto label$242;
			{
		...
		label$240:;
		{
			if( *(char**)((uint8*)S$1 + 96ll) == (char*)0ull ) goto label$246;
			{
...
static void SYMBRECALCARRAYDIFF( struct $8FBSYMBOL* SYM$1 )
{
	...
	LAST$1 = *(int64*)((uint8*)SYM$1 + 104ll) + -1ll;
	{
		...
		I$2 = I$2 + 1ll;
		label$64:;
		if( I$2 <= TMP$116$2 ) goto label$67;
		label$66:;
	}
...
{
	label$68:;
	if( *(int64*)((uint8*)SYM$1 + 104ll) <= 0ll ) goto label$71;
	{
