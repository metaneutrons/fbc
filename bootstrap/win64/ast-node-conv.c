...
int64 ASTCHECKCONVNONPTRTOPTR( int64 TO_DTYPE$1, int64 EXPR_DTYPE$1, struct $7ASTNODE* EXPR$1, $11AST_CONVOPT OPTIONS$1 )
{
	...
	label$78:;
	if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$94$1 * 56ll)) != 0ll ) goto label$70;
	{
		int64 TMP$95$2;
		...
		label$79:;
		if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$95$2 * 56ll)) + 8ll) != *(int64*)((uint8*)&ENV$ + 592ll) ) goto label$77;
		{
			fb$result$1 = 0ll;
			goto label$67;
		}
...
int64 ASTCHECKCONV( int64 TO_DTYPE$1, struct $8FBSYMBOL* TO_SUBTYPE$1, struct $7ASTNODE* L$1 )
{
	...
	label$147:;
	if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$102$1 * 56ll)) != 2ll ) goto label$133;
	{
		goto label$122;
	}
	label$133:;
...
struct $7ASTNODE* ASTNEWCONV( int64 TO_DTYPE$1, struct $8FBSYMBOL* TO_SUBTYPE$1, struct $7ASTNODE* L$1, $11AST_CONVOPT OPTIONS$1, int64* PERRMSG$1 )
{
	...
	label$299:;
	if( TMP$105$1 != 20ll ) goto label$188;
	{
	...
	label$202:;
	{
		...
		label$216:;
		{
			...
			label$302:;
			if( TMP$109$3 != 20ll ) goto label$219;
			{
				goto label$171;
			}
			label$219:;
		...
		if( TMP$107$2 > 20ull ) goto label$216;
	...
	label$303:;
	LDCLASS$1 = *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$110$1 * 56ll));
	...
	{
		{
			...
			if( (TMP$112$3 - 4ull) > 14ull ) goto label$234;
		...
		{
			{
				...
				label$305:;
				TMP$114$4 = TMP$113$4;
				if( TMP$114$4 == 4ll ) goto label$242;
				label$243:;
				if( TMP$114$4 != 7ll ) goto label$241;
				label$242:;
				{
	...
	label$306:;
	if( LDCLASS$1 != *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$115$1 * 56ll)) ) goto label$250;
	{
		{
			int64 TMP$116$3;
			int64 TMP$117$3;
			...
			label$307:;
			TMP$117$3 = TMP$116$3;
			if( TMP$117$3 != 20ll ) goto label$253;
			label$254:;
			{
				DOCONV$1 = 0ll;
			}
			...
			label$253:;
			{
				...
				label$257:;
				{
					...
					label$309:;
					if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$118$5 * 56ll)) + 8ll) != *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$119$5 * 56ll)) + 8ll) ) goto label$263;
					{
						DOCONV$1 = 0ll;
					}
					label$263:;
	...
	if( (*(int64*)((uint8*)&IR$ + 544ll) & 1ll) == 0ll ) goto label$265;
	{
		...
		label$310:;
		if( ((int64)-(LDCLASS$1 == 1ll) & (int64)-(*(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$120$2 * 56ll)) == 1ll)) == 0ll ) goto label$268;
		{
			int64 TMP$121$3;
			int64 TMP$122$3;
			...
			label$312:;
			if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$121$3 * 56ll)) + 8ll) == *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$122$3 * 56ll)) + 8ll) ) goto label$272;
			{
				DOCONV$1 = -1ll;
			}
			label$272:;
	...
	*(int64*)((uint8*)N$1 + 56ll) = 0ll;
	...
	if( *(int64*)((uint8*)&ENV$ + 208ll) != 0ll ) goto label$292;
	{
		if( DOCONV$1 == 0ll ) goto label$294;
		{
			...
			label$313:;
			if( TMP$125$3 != 16ll ) goto label$297;
			{
				int64 TMP$126$4;
...
void ASTUPDATECONVFD2FS( struct $7ASTNODE* N$1, int64 TO_DTYPE$1, int64 IS_EXPR$1 )
{
	...
	label$327:;
	*(int64*)((uint8*)N$1 + 48ll) = (int64)-(*(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$129$1 * 56ll)) + 8ll) >= 4ll);
	...
	label$328:;
	if( TMP$130$1 != 15ll ) goto label$326;
	{
			...
			if( *(int64*)((uint8*)N$1 + 48ll) == 0ll ) goto label$338;
			{
				if( *(int64*)((uint8*)VS$1 + 8ll) != 16ll ) goto label$340;
				{
					if( *(int64*)((uint8*)VR$1 + 8ll) != 15ll ) goto label$342;
					{
						...
						{
							(*(tmp$53*)((uint8*)&IR$ + 192ll))( 74ll, VR$1, (struct $6IRVREG*)0ull );
						}
						label$344:;
						label$343:;
					}
...
static void HCONSTCONV( int64 TODTYPE$1, struct $7ASTNODE* L$1 )
{
	...
	{
		{
			...
			label$372:;
			TMP$87$3 = *(uint64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$86$3 * 56ll)) + 40ll);
			goto label$17;
			label$18:;
			{
	...
	label$374:;
	if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$89$1 * 56ll)) + 16ll) == 0ll ) goto label$32;
	{
		{
			int64 TMP$90$3;
			uint64 TMP$91$3;
...
static int64 HCHECKPTR( int64 TO_DTYPE$1, struct $8FBSYMBOL* TO_SUBTYPE$1, int64 EXPR_DTYPE$1, struct $7ASTNODE* EXPR$1, $11AST_CONVOPT OPTIONS$1 )
{
	...
	if( (EXPR_DTYPE$1 & 480ll) == 0ll ) goto label$86;
	{
		...
		label$377:;
		if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$96$2 * 56ll)) != 0ll ) goto label$89;
		{
			int64 TMP$97$3;
			...
			label$378:;
			if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$97$3 * 56ll)) + 8ll) != *(int64*)((uint8*)&ENV$ + 592ll) ) goto label$96;
			{
				goto label$81;
			}
			label$96:;
