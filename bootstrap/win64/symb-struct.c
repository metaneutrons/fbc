...
void SYMBSTRUCTADDBASE( struct $8FBSYMBOL* S$1, struct $8FBSYMBOL* BASE_$1 )
{
	...
	struct $8FBSYMBOL* vr$0 = SYMBADDFIELD( S$1, (char*)"base$", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$94$1, 20ll, BASE_$1, 0ll, 0ll, 0ll );
...
int64 TYPECALCNATURALALIGN( int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	int64 ALIGN$1;
	{
		...
		label$43:;
		{
			...
			label$50:;
			ALIGN$1 = *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$98$3 * 56ll)) + 8ll);
		}
		goto label$39;
		label$40:;
					...
					if( BITS$1 > (PAD$1 << (3ll & 63ll)) ) goto label$97;
					{
						...
						PAD$1 = 0ll;
						{
							...
							label$100:;
							{
								...
								label$152:;
								if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$104$8 * 56ll)) + 16ll) == 0ll ) goto label$103;
								{
									DTYPE$1 = 2ll;
								}
								goto label$102;
							...
							label$105:;
							{
								...
								label$153:;
								if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$105$8 * 56ll)) + 16ll) == 0ll ) goto label$108;
								{
									DTYPE$1 = 5ll;
								}
								goto label$107;
...
struct $8FBSYMBOL* SYMBCLONESIMPLESTRUCT( struct $8FBSYMBOL* SYM$1 )
{
	...
	{
		SYMBADDFIELD( S$1, *(char**)((uint8*)FLD$1 + 32ll), 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$111$1, *(int64*)((uint8*)FLD$1 + 56ll), *(struct $8FBSYMBOL**)((uint8*)FLD$1 + 64ll), 0ll, 0ll, 0ll );
...
static void STRUCT_ANALYZE( struct $8FBSYMBOL* FLD$1, int64* PART1$1, int64* PART2$1, int64* RANGE$1 )
{
	...
	if( FLD$1 == (struct $8FBSYMBOL*)0ull ) goto label$179;
	{
		...
		label$326:;
		if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$107$2 * 56ll)) != 3ll ) goto label$184;
		{
		...
		label$327:;
		if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$108$2 * 56ll)) != 0ll ) goto label$185;
		{
