...
void PPCONDIF( void )
{
	...
	ISTRUE$1 = 0ll;
	{
		...
		label$29:;
		{
			...
			struct $8FBSYMBOL* vr$2 = CIDENTIFIERORUDTMEMBER( &TMP$96$3, (struct $10FBSYMCHAIN*)0ull );
		...
		label$30:;
		{
			...
			struct $8FBSYMBOL* vr$5 = CIDENTIFIERORUDTMEMBER( &TMP$97$3, (struct $10FBSYMCHAIN*)0ull );
	...
	{
		{
			...
			TMP$99$3 = vr$5;
			if( TMP$99$3 != 35ll ) goto label$68;
			label$69:;
			{
				LEXSKIPTOKEN( 256ll );
				{
					...
					if( (TMP$100$5 - 266ull) > 5ull ) goto label$70;
					goto *tmp$101[TMP$100$5 - 266ull];
					label$70:;
				}
			}
			goto label$67;
			label$68:;
			if( TMP$99$3 != 256ll ) goto label$86;
			label$87:;
			{
