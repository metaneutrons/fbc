		...
		label$90:;
		{
			...
			label$103:;
			{
				...
				SUBTYPE$1 = *(struct $8FBSYMBOL**)((uint8*)FLD$2 + 64ll);
				{
					...
					label$115:;
					TMP$102$5 = TMP$101$5;
					if( TMP$102$5 != 20ll ) goto label$106;
					label$107:;
					{
			...
			if( (TMP$100$3 - 1ull) > 11ull ) goto label$114;
			...
			{
				{
					...
					if( TMP$105$5 == 7ll ) goto label$130;
					label$131:;
					if( TMP$105$5 == 4ll ) goto label$130;
					label$132:;
					if( TMP$105$5 == 17ll ) goto label$130;
					label$133:;
...
struct $7ASTNODE* CMEMBERDEREF( int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, struct $7ASTNODE* VAREXPR$1, int64 CHECK_ARRAY$1 )
{
	...
	label$159:;
	{
		IDXEXPR$1 = (struct $7ASTNODE*)0ull;
		{
			...
			TMP$109$3 = vr$1;
			if( TMP$109$3 != 400ll ) goto label$163;
			label$164:;
			{
				DEREFCNT$1 = 0ll;
				if( (DTYPE$1 & 480ll) == 0ll ) goto label$166;
				{
					...
					DTYPE$1 = (((DTYPE$1 & 31ll) | ((DTYPE$1 & 480ll) + -32ll)) | (((DTYPE$1 & 261632ll) >> (1ll & 63ll)) & 261632ll)) | (DTYPE$1 & 32505856ll);
					{
						...
						if( TMP$110$6 == 0ll ) goto label$169;
						label$170:;
						if( TMP$110$6 != 23ll ) goto label$168;
						label$169:;
						{
						...
						goto label$167;
						label$168:;
						if( TMP$110$6 != 20ll ) goto label$171;
						label$172:;
						{
						}
						goto label$167;
			...
			goto label$162;
			label$163:;
			if( TMP$109$3 != 91ll ) goto label$192;
			label$193:;
			{
				LEXSKIPTOKEN( 0ll );
				...
				label$194:;
				{
					...
					if( TMP$111$5 == 17ll ) goto label$198;
					label$199:;
					if( TMP$111$5 == 18ll ) goto label$198;
					label$200:;
					if( TMP$111$5 == 4ll ) goto label$198;
					label$201:;
					if( TMP$111$5 != 7ll ) goto label$197;
					label$198:;
					{
					...
					goto label$196;
					label$197:;
					if( TMP$111$5 != 20ll ) goto label$202;
					label$203:;
					{
					...
					{
						{
							...
							if( TMP$112$7 == 0ll ) goto label$221;
							label$222:;
							if( TMP$112$7 != 23ll ) goto label$220;
							label$221:;
							{
								ERRREPORT( 71ll, -1ll, (char*)0ull );
								DTYPE$1 = 40ll;
			...
			goto label$162;
			label$192:;
			if( TMP$109$3 != 46ll ) goto label$238;
			label$239:;
			{
...
struct $7ASTNODE* CVARIABLE( struct $10FBSYMCHAIN* CHAIN_$1, int64 CHECK_ARRAY$1 )
{
	...
	label$396:;
	{
		...
		TMP$114$2 = vr$1;
		if( TMP$114$2 == 0ll ) goto label$400;
		label$401:;
		if( TMP$114$2 != 2ll ) goto label$399;
		label$400:;
		{
...
struct $7ASTNODE* CVARORDEREF( $13FB_VAREXPROPT OPTIONS$1 )
{
	...
	if( EXPR$1 == (struct $7ASTNODE*)0ull ) goto label$430;
	{
		...
		COMPLAIN$2 = -1ll;
		{
			...
			if( (TMP$115$3 - 9ull) > 16ull ) goto label$433;
...
static struct $8FBSYMBOL* HMEMBERID( struct $8FBSYMBOL* PARENT$1, int64 ALLOW_INNER$1 )
{
	...
	SYM$1 = *(struct $8FBSYMBOL**)CHAIN_$1;
	{
		...
		goto label$75;
		label$76:;
		static const void* tmp$118[14ll] = {
			&&label$77,
			&&label$77,
			&&label$83,
			&&label$84,
		...
		if( (TMP$98$2 - 1ull) > 13ull ) goto label$84;
		goto *tmp$118[TMP$98$2 - 1ull];
		label$75:;
	}
	fb$result$1 = SYM$1;
	goto label$59;
...
static struct $7ASTNODE* HSTRINDEXING( int64 DTYPE$1, struct $7ASTNODE* VAREXPR$1, struct $7ASTNODE* IDXEXPR$1 )
{
	...
	label$440:;
	if( TMP$106$1 != 17ll ) goto label$144;
	{
	...
	label$441:;
	if( TMP$107$1 != 7ll ) goto label$147;
	{
	...
	label$442:;
	if( TMP$108$1 != 7ll ) goto label$152;
	{
...
static struct $8FBSYMBOL* HVARADDUNDECL( char* ID$1, int64 DTYPE$1 )
{
	...
	*(int64*)((uint8*)&tmp$113$1 + 64ll) = 0ll;
	...
	label$286:;
	struct $8FBSYMBOL* vr$15 = SYMBADDVAR( (char*)ID$1, (char*)0ull, DTYPE$1, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$113$1, ATTRIB$1, OPTIONS$1 );
	S$1 = vr$15;
	if( S$1 != (struct $8FBSYMBOL*)0ull ) goto label$291;
	{
		ERRREPORTEX( 4ll, (char*)ID$1, 0ll, 1ll, (char*)0ull );
		char* vr$17 = SYMBUNIQUELABEL(  );
		struct $8FBSYMBOL* vr$18 = SYMBADDVAR( (char*)vr$17, (char*)0ull, DTYPE$1, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$113$1, ATTRIB$1, OPTIONS$1 );
		S$1 = vr$18;
	}
	goto label$290;
	label$291:;
