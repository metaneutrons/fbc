...
struct $7ASTNODE* ASTNEWUOP( int64 OP$1, struct $7ASTNODE* O$1 )
{
	...
	label$142:;
	if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$90$1 * 56ll)) != 2ll ) goto label$72;
	{
		goto label$56;
	}
	label$72:;
	...
	label$144:;
	DO_PROMOTE$1 = (int64)-(*(int64*)((uint8*)&ENV$ + 272ll) != 3ll) & (int64)-(*(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$93$1 * 56ll)) == 0ll);
	...
	if( DO_PROMOTE$1 == 0ll ) goto label$90;
	{
		...
		label$145:;
		if( (*(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$94$2 * 56ll)) + 32ll) & 480ll) == 0ll ) goto label$93;
		TMP$96$2 = 24ll;
		goto label$146;
		label$93:;
		...
		label$147:;
		TMP$96$2 = *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$95$2 * 56ll)) + 32ll) & 31ll;
		label$146:;
		RANK$1 = *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$96$2 * 56ll)) + 24ll);
	...
	SUBTYPE$1 = *(struct $8FBSYMBOL**)((uint8*)O$1 + 16ll);
	{
		...
		label$100:;
		{
			...
			label$148:;
			if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$98$3 * 56ll)) == 0ll ) goto label$103;
			{
		...
		label$104:;
		{
			...
			label$149:;
			if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$99$3 * 56ll)) != 0ll ) goto label$107;
			{
		...
		label$108:;
		{
			...
			label$150:;
			if( ~(*(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$100$3 * 56ll)) + 16ll)) == 0ll ) goto label$111;
			{
				if( *(int64*)O$1 != 16ll ) goto label$113;
				{
					if( *(int64*)((uint8*)&AST$ + 464ll) != 0ll ) goto label$115;
					{
						...
						label$151:;
						if( *(uint64*)((uint8*)O$1 + 40ll) <= (1ull << (((*(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$101$6 * 56ll)) + 8ll) << (3ll & 63ll)) + -1ll) & 63ll)) ) goto label$118;
						{
		...
		label$119:;
		{
			...
			label$152:;
			if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$102$3 * 56ll)) == 1ll ) goto label$122;
			{
		...
		label$123:;
		{
			...
			label$153:;
			if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$103$3 * 56ll)) != 0ll ) goto label$126;
			{
		...
		label$127:;
		{
			...
			label$154:;
			if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$104$3 * 56ll)) != 0ll ) goto label$130;
			{
		...
		if( (TMP$97$2 - 52ull) > 20ull ) goto label$98;
	...
	{
		int64 vr$130 = (*(tmp$42*)((uint8*)&IR$ + 40ll))( OP$1, DTYPE$1 );
...
static struct $7ASTNODE* HCONSTUOP( int64 OP$1, int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, struct $7ASTNODE* L$1 )
{
	...
	label$167:;
	if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$85$1 * 56ll)) != 1ll ) goto label$19;
	{
	...
	label$19:;
	{
		...
		label$168:;
		if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$87$2 * 56ll)) + 8ll) != 8ll ) goto label$40;
		{
			{
				uint64 TMP$88$4;
