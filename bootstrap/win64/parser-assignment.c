	...
	TK$1 = vr$1;
	{
		...
		label$41:;
		{
			...
			LEXSKIPTOKEN( 2048ll );
			{
				...
				goto label$44;
				label$45:;
				static const void* tmp$98[402ll] = {
					&&label$70,
					&&label$85,
					&&label$85,
					&&label$85,
				...
				if( (TMP$95$4 - 64ull) > 401ull ) goto label$85;
		...
		goto label$22;
		label$23:;
		static const void* tmp$99[428ll] = {
			&&label$40,
			&&label$86,
			&&label$86,
			&&label$86,
		...
		if( (TMP$94$2 - 38ull) > 427ull ) goto label$86;
...
static void HREPORTLETERROR( int64 ERRNUM$1, int64 ELMNUM$1 )
{
	...
	ERRREPORTEX( ERRNUM$1, (char*)*(char**)&TMP$108$1, 0ll, 1ll, (char*)0ull );
