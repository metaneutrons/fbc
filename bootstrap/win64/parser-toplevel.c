...
void CPROGRAM( void )
{
	...
	label$26:;
	{
		...
		*(uint64*)((uint8*)&PARSER$ + 192ll) = 1ull;
		struct $7ASTNODE* vr$10 = ASTNEWDBG( 113ll, *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426904ll) + 8560ll), *(char**)((uint8*)&ENV$ + 872ll) );
		ASTADD( vr$10 );
		CLABEL(  );
		CSTATEMENT(  );
		CCOMMENT( 0ll );
		...
		label$42:;
		{
			...
			TMP$94$3 = vr$12;
			if( TMP$94$3 != 257ll ) goto label$47;
			label$48:;
			{
				LEXSKIPTOKEN( 0ll );
			}
			goto label$46;
			label$47:;
			if( TMP$94$3 != 256ll ) goto label$49;
			label$50:;
			{
			}
			goto label$46;
		...
		label$53:;
		label$52:;
		struct $7ASTNODE* vr$14 = ASTNEWDBG( 114ll, 0ll, (char*)0ull );
		ASTADD( vr$14 );
		*(int64*)((uint8*)&PARSER$ + 56ll) = *(int64*)((uint8*)&PARSER$ + 56ll) + 1ll;
	}
	label$28:;
	...
	{
		{
			...
			if( (TMP$95$3 - 40ull) > 220ull ) goto label$89;
	...
	{
		{
			...
			TMP$97$3 = vr$2;
			if( TMP$97$3 != 256ll ) goto label$104;
			label$105:;
			{
				goto label$97;
			}
			goto label$103;
			label$104:;
			if( TMP$97$3 != 257ll ) goto label$106;
			label$107:;
			{
				ISCOMMENT$1 = 0ll;
			}
			goto label$103;
			label$106:;
			if( TMP$97$3 == 259ll ) goto label$109;
			label$110:;
			if( TMP$97$3 != 260ll ) goto label$108;
			label$109:;
			{
				ISCOMMENT$1 = -1ll;
			}
			goto label$103;
			label$108:;
			if( TMP$97$3 != 340ll ) goto label$111;
			label$112:;
			{
			...
			goto label$103;
			label$111:;
			if( TMP$97$3 != FOR_TOKEN$1 ) goto label$121;
			label$122:;
			{
