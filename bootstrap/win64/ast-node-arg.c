...
static int64 HCHECKBYDESCPARAM( struct $7ASTNODE* PARENT$1, struct $8FBSYMBOL* PARAM$1, struct $7ASTNODE* N$1 )
{
	...
	if( ((int64)-(*(int64*)((uint8*)PARENT$1 + 40ll) == 0ll) & (int64)-(SYM_DTYPE$1 != 0ll)) == 0ll ) goto label$82;
	{
		...
		label$339:;
		if( ((int64)-(*(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$87$2 * 56ll)) != *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$88$2 * 56ll))) | (int64)-(*(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$89$2 * 56ll)) + 8ll) != *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$90$2 * 56ll)) + 8ll))) == 0ll ) goto label$88;
		{
			goto label$76;
		}
		label$88:;
...
static int64 HCHECKVARARGPARAM( struct $7ASTNODE* PARENT$1, struct $8FBSYMBOL* PARAM$1, struct $7ASTNODE* N$1 )
{
	...
	ARG_DTYPE$1 = *(int64*)((uint8*)*(struct $7ASTNODE**)((uint8*)N$1 + 112ll) + 8ll) & 511ll;
	{
		...
		label$340:;
		TMP$92$2 = *(uint64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$91$2 * 56ll));
		goto label$115;
		label$116:;
		{
		...
		{
			{
				...
				label$119:;
				{
					...
					label$341:;
					if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$93$5 * 56ll)) + 8ll) >= 4ll ) goto label$125;
					{
						int64 TMP$94$6;
						...
						label$342:;
						if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$94$6 * 56ll)) + 16ll) == 0ll ) goto label$127;
						TMP$95$6 = 11ll;
						goto label$343;
						label$127:;
						TMP$95$6 = 12ll;
		...
		if( TMP$92$2 > 2ull ) goto label$131;
...
static int64 HCHECKSTRPARAM( struct $7ASTNODE* PARENT$1, struct $8FBSYMBOL* PARAM$1, struct $7ASTNODE* N$1 )
{
	...
	ARGDTYPE$1 = *(int64*)((uint8*)*(struct $7ASTNODE**)((uint8*)N$1 + 112ll) + 8ll) & 511ll;
	{
		...
		if( (TMP$96$2 - 4ull) > 14ull ) goto label$146;
	...
	*(struct $7ASTNODE**)((uint8*)N$1 + 112ll) = vr$5;
	{
		...
		if( TMP$97$2 != 2ll ) goto label$148;
		label$149:;
		{
		...
		goto label$147;
		label$148:;
		if( TMP$97$2 != 1ll ) goto label$152;
		label$153:;
		{
			HBUILDBYREFARG( PARAM$1, N$1 );
		}
...
static int64 HCHECKUDTPARAM( struct $8FBSYMBOL* PARAM$1, struct $7ASTNODE* N$1 )
{
	...
	label$184:;
	{
		...
		if( TMP$98$2 != 2ll ) goto label$193;
		label$194:;
		{
		...
		goto label$192;
		label$193:;
		if( TMP$98$2 != 1ll ) goto label$199;
		label$200:;
		{
			HUDTPASSBYVAL( PARAM$1, N$1 );
		}
...
static int64 HCHECKPARAM( struct $7ASTNODE* PARENT$1, struct $8FBSYMBOL* PARAM$1, struct $7ASTNODE* N$1 )
{
	...
	*(struct $7ASTNODE**)((uint8*)N$1 + 112ll) = vr$2;
	...
	ARG_DTYPE$1 = *(int64*)((uint8*)*(struct $7ASTNODE**)((uint8*)N$1 + 112ll) + 8ll) & 511ll;
	{
		...
		if( TMP$99$2 != 3ll ) goto label$204;
		label$205:;
		{
		...
		goto label$203;
		label$204:;
		if( TMP$99$2 != 4ll ) goto label$208;
		label$209:;
		{
		...
		goto label$203;
		label$208:;
		if( TMP$99$2 != 2ll ) goto label$210;
		label$211:;
		{
			int64 TMP$102$3;
			...
			if( *(int64*)((uint8*)N$1 + 40ll) != 1ll ) goto label$215;
			{
				...
				label$345:;
				if( ((int64)-(*(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$100$4 * 56ll)) != 0ll) | (int64)-(*(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$101$4 * 56ll)) + 8ll) != *(int64*)((uint8*)&ENV$ + 592ll))) == 0ll ) goto label$219;
				{
					ERRREPORT( 58ll, 0ll, (char*)0ull );
					goto label$202;
				}
			...
			TMP$102$3 = 0ll;
			label$346:;
			if( TMP$102$3 == 0ll ) goto label$222;
			{
				ERRREPORT( 58ll, 0ll, (char*)0ull );
				goto label$202;
			}
	...
	}
	{
		...
		if( (TMP$103$2 - 4ull) > 16ull ) goto label$249;
	...
	if( ((int64)-(PARAM_DTYPE$1 == 10ll) | (int64)-(ARG_DTYPE$1 == 10ll)) == 0ll ) goto label$268;
	{
		...
		label$348:;
		if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$104$2 * 56ll)) == *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$105$2 * 56ll)) ) goto label$272;
		{
	...
	if( ((int64)-(PARAM_DTYPE$1 != ARG_DTYPE$1) | (int64)-(*(struct $8FBSYMBOL**)((uint8*)PARAM$1 + 64ll) != *(struct $8FBSYMBOL**)((uint8*)*(struct $7ASTNODE**)((uint8*)N$1 + 112ll) + 16ll))) == 0ll ) goto label$285;
	{
		...
		label$352:;
		if( ((int64)-(*(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$106$2 * 56ll)) + 8ll) != *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$107$2 * 56ll)) + 8ll)) | (int64)-(*(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$108$2 * 56ll)) != *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$109$2 * 56ll)))) == 0ll ) goto label$291;
		{
