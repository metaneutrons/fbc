		...
		if( *(int64*)&PARSER$ >= *(int64*)((uint8*)&FBCTINF$ + 8ll) ) goto label$325;
		{
			...
			*(int64*)&PARSER$ = *(int64*)&PARSER$ + 1ll;
			...
			fb_StrAssign( (void*)DAT$1, -1ll, (void*)vr$10, 0ll, 0 );
			{
				...
				if( TMP$60$4 != 1ll ) goto label$335;
				label$336:;
				{
					fb$result$1 = 0ll;
					goto label$319;
				...
				goto label$334;
				label$335:;
				if( TMP$60$4 != 2ll ) goto label$337;
				label$338:;
				{
					fb$result$1 = 1ll;
					goto label$319;
				...
				goto label$334;
				label$337:;
				if( TMP$60$4 != 3ll ) goto label$339;
				label$340:;
				{
					{
						FBSTRING TMP$61$6;
	...
	{
		{
			...
			TMP$46$3 = vr$1;
			if( TMP$46$3 != 1ll ) goto label$266;
			label$267:;
			{
			...
			goto label$265;
			label$266:;
			if( TMP$46$3 != 0ll ) goto label$268;
			label$269:;
			{
	...
	{
		{
			...
			TMP$47$3 = vr$3;
			if( TMP$47$3 != 1ll ) goto label$272;
			label$273:;
			{
			...
			goto label$271;
			label$272:;
			if( TMP$47$3 != 0ll ) goto label$274;
			label$275:;
			{
			...
			goto label$271;
			label$274:;
			if( TMP$47$3 != 3ll ) goto label$276;
			label$277:;
			{
			...
			goto label$271;
			label$276:;
			if( TMP$47$3 != 2ll ) goto label$278;
			label$279:;
			{
			...
			goto label$271;
			label$278:;
			if( TMP$47$3 == 5ll ) goto label$281;
			label$282:;
			if( TMP$47$3 != 6ll ) goto label$280;
			label$281:;
			{
			...
			goto label$271;
			label$280:;
			if( TMP$47$3 != 4ll ) goto label$283;
			label$284:;
			{
