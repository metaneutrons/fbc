...
struct $6IRVREG* ASTLOADDEREF( struct $7ASTNODE* N$1 )
{
	...
	if( *(int64*)((uint8*)&AST$ + 272ll) == 0ll ) goto label$41;
	{
		...
		label$47:;
		if( (((int64)-(*(int64*)V1$1 != 4ll) | (int64)-(*(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$85$2 * 56ll)) != 0ll)) | (int64)-(*(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$86$2 * 56ll)) + 8ll) != *(int64*)((uint8*)&ENV$ + 592ll))) == 0ll ) goto label$45;
		{
			...
			VP$1 = vr$39;
			(*(tmp$53*)((uint8*)&IR$ + 240ll))( 76ll, V1$1, VP$1 );
		}
		goto label$44;
		label$45:;
		{
