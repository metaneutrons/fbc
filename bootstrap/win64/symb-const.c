...
struct $8FBSYMBOL* SYMBALLOCINTCONST( int64 VALUE$1, int64 DTYPE$1 )
{
	...
	label$46:;
	if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$90$1 * 56ll)) + 8ll) != 8ll ) goto label$45;
	{
...
struct $8FBSYMBOL* SYMBALLOCSTRCONST( char* SNAME$1, int64 STRLENGTH$1 )
{
	...
	struct $8FBSYMBOL* vr$10 = SYMBADDVAR( (char*)ID$1, (char*)ID_ALIAS$1, 4ll, (struct $8FBSYMBOL*)0ull, STRSIZE$1, 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$91$1, 3073ll, 137ll );
	S$1 = vr$10;
...
struct $8FBSYMBOL* SYMBALLOCWSTRCONST( uint16* SNAME$1, int64 STRLENGTH$1 )
{
	...
	if( (INTERNALSTRLEN$1 << (3ll & 63ll)) > 122ll ) goto label$60;
	{
		...
		char* vr$3 = HESCAPEW( (uint16*)SNAME$1 );
	...
	struct $8FBSYMBOL* vr$13 = SYMBADDVAR( (char*)ID$1, (char*)ID_ALIAS$1, 7ll, (struct $8FBSYMBOL*)0ull, STRSIZE$1, 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$94$1, 3073ll, 137ll );
	S$1 = vr$13;
...
FBSTRING* SYMBGETCONSTVALUEASSTR( struct $8FBSYMBOL* S$1 )
{
	...
	label$67:;
	{
		...
		label$76:;
		{
			...
			label$82:;
			if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$98$3 * 56ll)) + 16ll) == 0ll ) goto label$81;
			{
		...
		if( vr$7 == TEXTLEN$2 ) goto label$90;
		{
			DZSTRCONCATASSIGN( &RES$1, (char*)"!\x22" );
			{
				...
				label$94:;
				{
					...
					FBSTRING* vr$15 = fb_StrConcat( &TMP$104$5, (void*)"\x5Cx", 3ll, (void*)vr$12, -1ll );
					fb_StrAssign( (void*)&TMP$105$5, -1ll, (void*)vr$15, -1ll, 0 );
					DZSTRCONCATASSIGN( &RES$1, (char*)*(char**)&TMP$105$5 );
					fb_StrDelete( (FBSTRING*)&TMP$105$5 );
				}
				label$92:;
				I$4 = I$4 + 1ll;
				label$91:;
				if( I$4 <= TMP$102$4 ) goto label$94;
				label$93:;
			}
		}
		goto label$89;
	...
	label$88:;
	{
		...
		DZSTRCONCATASSIGN( &RES$1, (char*)"!\x22" );
		{
			...
			label$98:;
			{
				...
				FBSTRING* vr$31 = fb_StrConcat( &TMP$110$4, (void*)"\x5Cu", 3ll, (void*)vr$28, -1ll );
				fb_StrAssign( (void*)&TMP$111$4, -1ll, (void*)vr$31, -1ll, 0 );
				DZSTRCONCATASSIGN( &RES$1, (char*)*(char**)&TMP$111$4 );
				fb_StrDelete( (FBSTRING*)&TMP$111$4 );
			}
			label$96:;
			I$3 = I$3 + 1ll;
			label$95:;
			if( I$3 <= TMP$108$3 ) goto label$98;
			label$97:;
		}
		DZSTRCONCATASSIGN( &RES$1, (char*)"\x22" );
	}
...
uint16* SYMBGETCONSTSTRASWSTR( struct $8FBSYMBOL* S$1 )
{
	...
	if( (*(int64*)((uint8*)S$1 + 56ll) & 511ll) != 7ll ) goto label$102;
	{
		...
		if( vr$7 == TEXTLEN$2 ) goto label$104;
		{
			...
			TMP$112$3 = vr$8;
			DWSTRCONCATASSIGN( &RES$1, (uint16*)TMP$112$3 );
			fb_WstrDelete( (uint16*)TMP$112$3 );
			{
				int64 I$4;
				I$4 = 0ll;
				int64 TMP$113$4;
				TMP$113$4 = TEXTLEN$2 + -1ll;
				goto label$105;
				label$108:;
				{
					FBSTRING TMP$114$5;
					...
					FBSTRING* vr$17 = fb_StrConcat( &TMP$114$5, (void*)"\x5Cu", 3ll, (void*)vr$14, -1ll );
					fb_StrAssign( (void*)&TMP$115$5, -1ll, (void*)vr$17, -1ll, 0 );
					uint16* vr$19 = fb_StrToWstr( (char*)*(char**)&TMP$115$5 );
					TMP$116$5 = vr$19;
					DWSTRCONCATASSIGN( &RES$1, (uint16*)TMP$116$5 );
					fb_WstrDelete( (uint16*)TMP$116$5 );
					fb_StrDelete( (FBSTRING*)&TMP$115$5 );
				}
				label$106:;
				I$4 = I$4 + 1ll;
				label$105:;
				if( I$4 <= TMP$113$4 ) goto label$108;
				label$107:;
			}
		}
		goto label$103;
		...
		{
			uint16* TMP$117$3;
			uint16* vr$22 = fb_StrToWstr( (char*)"$\x22" );
			TMP$117$3 = vr$22;
		...
		label$103:;
		uint16* vr$23 = fb_StrToWstr( (char*)"\x22" );
		TMP$118$2 = vr$23;
	...
	label$102:;
	{
		...
		__builtin_memset( &TEXTLEN$2, 0, 8ll );
		char* TEXT$2;
		char* vr$27 = HUNESCAPE( *(char**)((uint8*)S$1 + 96ll), &TEXTLEN$2 );
		TEXT$2 = vr$27;
		uint16* vr$28 = fb_StrToWstr( (char*)"!\x22" );
		TMP$119$2 = vr$28;
		DWSTRCONCATASSIGN( &RES$1, (uint16*)TMP$119$2 );
		fb_WstrDelete( (uint16*)TMP$119$2 );
		{
			int64 I$3;
			I$3 = 0ll;
			int64 TMP$120$3;
			TMP$120$3 = TEXTLEN$2 + -1ll;
			goto label$109;
			label$112:;
			{
				FBSTRING TMP$121$4;
				...
				FBSTRING* vr$36 = fb_StrConcat( &TMP$121$4, (void*)"\x5Cu", 3ll, (void*)vr$33, -1ll );
				fb_StrAssign( (void*)&TMP$122$4, -1ll, (void*)vr$36, -1ll, 0 );
				uint16* vr$38 = fb_StrToWstr( (char*)*(char**)&TMP$122$4 );
				TMP$123$4 = vr$38;
				DWSTRCONCATASSIGN( &RES$1, (uint16*)TMP$123$4 );
				fb_WstrDelete( (uint16*)TMP$123$4 );
				fb_StrDelete( (FBSTRING*)&TMP$122$4 );
			}
			label$110:;
			I$3 = I$3 + 1ll;
			label$109:;
			if( I$3 <= TMP$120$3 ) goto label$112;
			label$111:;
		}
		uint16* vr$41 = fb_StrToWstr( (char*)"\x22" );
		TMP$124$2 = vr$41;
		DWSTRCONCATASSIGN( &RES$1, (uint16*)TMP$124$2 );
...
static struct $8FBSYMBOL* HALLOCINTORFLOATCONST( FBSTRING* SVALUE$1, int64 DTYPE$1 )
{
	...
	*(int64*)((uint8*)&tmp$85$1 + 64ll) = 0ll;
	...
	label$37:;
	char* vr$10 = SYMBUNIQUEID( (boolean)0ll );
	struct $8FBSYMBOL* vr$11 = SYMBADDVAR( (char*)ID$1, (char*)vr$10, DTYPE$1, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$85$1, 3073ll, 137ll );
	S$1 = vr$11;
