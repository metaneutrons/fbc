	...
	if( DTYPE$1 != 7ll ) goto label$199;
	{
		...
		if( LITSYM$1 == (struct $8FBSYMBOL*)0ull ) goto label$201;
		{
			if( *(int64*)((uint8*)&ENV$ + 576ll) == 0ll ) goto label$203;
			{
				...
				struct $8FBSYMBOL* vr$30 = SYMBALLOCSTRCONST( (char*)*(char**)&TMP$297$4, (*(int64*)((uint8*)LITSYM$1 + 80ll) / *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + 400ll)) + -1ll );
				LITSYM$1 = vr$30;
...
struct $7ASTNODE* RTLTOWSTR( struct $7ASTNODE* EXPR$1 )
{
	...
	if( DTYPE$1 != 4ll ) goto label$253;
	{
		...
		if( LITSYM$1 == (struct $8FBSYMBOL*)0ull ) goto label$255;
		{
			...
			{
				uint32* TMP$310$4;
				uint32* vr$11 = fb_StrToWstr( (char*)*(char**)((uint8*)LITSYM$1 + 96ll) );
				TMP$310$4 = vr$11;
				struct $8FBSYMBOL* vr$12 = SYMBALLOCWSTRCONST( TMP$310$4, *(int64*)((uint8*)LITSYM$1 + 80ll) + -1ll );
				LITSYM$1 = vr$12;
				fb_WstrDelete( (uint32*)TMP$310$4 );
	...
	label$396:;
	{
		...
		label$401:;
		{
			...
			if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$327$3 * 56ll)) < 2ll ) goto label$404;
			{
				...
				ERRREPORTEX( 58ll, (char*)*(char**)&TMP$330$4, 0ll, 1ll, (char*)0ull );
			...
			label$403:;
			{
				...
				label$407:;
				{
					...
					ERRREPORTEX( 58ll, (char*)*(char**)&TMP$333$5, 0ll, 1ll, (char*)0ull );
...
static struct $8FBSYMBOL* HEVALASCCASE( struct $8FBSYMBOL* LITERAL$1, int64 IS_LCASE$1 )
{
	...
	if( (*(int64*)((uint8*)LITERAL$1 + 56ll) & 511ll) != 7ll ) goto label$507;
	{
		...
		TMP$339$2 = 0ll;
		uint32* vr$6 = HUNESCAPEW( W$1, &TMP$339$2 );
		W$1 = vr$6;
	...
	label$507:;
	{
		...
		TMP$341$2 = 0ll;
		char* vr$26 = HUNESCAPE( Z$1, &TMP$341$2 );
		Z$1 = vr$26;
