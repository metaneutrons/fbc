...
static void SECTIONWRITELINE( FBSTRING* S$1 )
{
	label$40:;
	{
		...
		FBSTRING* vr$42 = fb_StrConcat( &TMP$128$2, (void*)TMP$122$2, -1ll, (void*)"\x0A", 2ll );
...
static void HAPPENDCTORATTRIB( FBSTRING* LN$1, struct $8FBSYMBOL* PROC$1, int64 IN_FRONT$1 )
{
	...
	if( (*(int64*)((uint8*)PROC$1 + 24ll) & 196608ll) == 0ll ) goto label$79;
	{
		...
		if( PRIORITY$1 == 0ll ) goto label$85;
		{
			...
			FBSTRING* vr$9 = fb_StrConcat( &TMP$148$3, (void*)"( ", 3ll, (void*)vr$6, -1ll );
			__builtin_memset( &TMP$149$3, 0, 24ll );
			FBSTRING* vr$12 = fb_StrConcat( &TMP$149$3, (void*)vr$9, -1ll, (void*)" )", 3ll );
...
static FBSTRING* HGETMANGLEDNAMEFORASM( struct $8FBSYMBOL* SYM$1, int64 UNDERSCORE_PREFIX$1 )
{
	...
	if( (UNDERSCORE_PREFIX$1 & *(int64*)((uint8*)&ENV$ + 584ll)) == 0ll ) goto label$91;
	{
		...
		FBSTRING* vr$8 = fb_StrConcat( &TMP$152$2, (void*)"_", 2ll, (void*)&MANGLED$1, -1ll );
...
static int64 HNEEDALIAS( struct $8FBSYMBOL* PROC$1 )
{
	...
	label$98:;
	{
		$13FB_COMPTARGET TMP$154$2;
		TMP$154$2 = *($13FB_COMPTARGET*)((uint8*)&ENV$ + 216ll);
		if( TMP$154$2 == 0ll ) goto label$102;
		label$103:;
		if( TMP$154$2 == 1ll ) goto label$102;
		label$104:;
		if( TMP$154$2 != 4ll ) goto label$101;
		label$102:;
		{
	...
	{
		$11FB_FUNCMODE TMP$155$2;
		TMP$155$2 = *($11FB_FUNCMODE*)((uint8*)PROC$1 + 152ll);
		if( TMP$155$2 == 2ll ) goto label$110;
		label$111:;
		if( TMP$155$2 != 4ll ) goto label$109;
		label$110:;
		{
			fb$result$1 = -1ll;
		}
		goto label$108;
		label$109:;
		if( TMP$155$2 != 1ll ) goto label$112;
		label$113:;
		{
			fb$result$1 = -1ll;
		}
...
static FBSTRING* HEMITPROCHEADER( struct $8FBSYMBOL* PROC$1, $16EMITPROC_OPTIONS OPTIONS$1 )
{
	...
	FBSTRING* vr$14 = fb_StrConcat( &TMP$157$1, (void*)&LN$1, -1ll, (void*)vr$10, -1ll );
	fb_StrAssign( (void*)&LN$1, -1ll, (void*)vr$14, -1ll, 0 );
	int64 vr$16 = FBGETCPUFAMILY(  );
	if( vr$16 != 0ll ) goto label$123;
	{
		{
			$11FB_FUNCMODE TMP$158$3;
			TMP$158$3 = *($11FB_FUNCMODE*)((uint8*)PROC$1 + 152ll);
			if( TMP$158$3 == 1ll ) goto label$126;
			label$127:;
			if( TMP$158$3 == 2ll ) goto label$126;
			label$128:;
			if( TMP$158$3 != 4ll ) goto label$125;
			label$126:;
			{
				{
					$13FB_COMPTARGET TMP$159$5;
					TMP$159$5 = *($13FB_COMPTARGET*)((uint8*)&ENV$ + 216ll);
					if( TMP$159$5 == 0ll ) goto label$131;
					label$132:;
					if( TMP$159$5 != 4ll ) goto label$130;
					label$131:;
					{
			...
			goto label$124;
			label$125:;
			if( TMP$158$3 != 5ll ) goto label$134;
			label$135:;
			{
				{
					$13FB_COMPTARGET TMP$162$5;
					TMP$162$5 = *($13FB_COMPTARGET*)((uint8*)&ENV$ + 216ll);
					if( TMP$162$5 == 0ll ) goto label$138;
					label$139:;
					if( TMP$162$5 != 4ll ) goto label$137;
					label$138:;
					{
			...
			goto label$124;
			label$134:;
			if( TMP$158$3 != 6ll ) goto label$141;
			label$142:;
			{
				{
					$13FB_COMPTARGET TMP$165$5;
					TMP$165$5 = *($13FB_COMPTARGET*)((uint8*)&ENV$ + 216ll);
					if( TMP$165$5 == 0ll ) goto label$145;
					label$146:;
					if( TMP$165$5 != 4ll ) goto label$144;
					label$145:;
					{
	...
	if( vr$35 == 0ll ) goto label$151;
	{
		if( (OPTIONS$1 & 1ll) == 0ll ) goto label$153;
		{
			...
			FBSTRING* vr$59 = fb_StrConcat( &TMP$170$3, (void*)&LN$1, -1ll, (void*)vr$55, -1ll );
		...
		label$153:;
		{
			...
			FBSTRING* vr$85 = fb_StrConcat( &TMP$171$3, (void*)&LN$1, -1ll, (void*)vr$81, -1ll );
			fb_StrAssign( (void*)&LN$1, -1ll, (void*)vr$85, -1ll, 0 );
			char* vr$87 = SYMBGETMANGLEDNAME( HIDDEN$1 );
			__builtin_memset( &TMP$172$3, 0, 24ll );
			FBSTRING* vr$90 = fb_StrConcat( &TMP$172$3, (void*)" ", 2ll, (void*)vr$87, 0ll );
			__builtin_memset( &TMP$173$3, 0, 24ll );
			FBSTRING* vr$94 = fb_StrConcat( &TMP$173$3, (void*)&LN$1, -1ll, (void*)vr$90, -1ll );
	...
	if( PARAM$1 == (struct $8FBSYMBOL*)0ull ) goto label$160;
	{
		...
		label$162:;
		{
			...
			if( (OPTIONS$1 & 1ll) != 0ll ) goto label$166;
			{
				...
				FBSTRING* vr$120 = fb_StrConcat( &TMP$178$4, (void*)" ", 2ll, (void*)vr$117, 0ll );
				__builtin_memset( &TMP$179$4, 0, 24ll );
				FBSTRING* vr$124 = fb_StrConcat( &TMP$179$4, (void*)&LN$1, -1ll, (void*)vr$120, -1ll );
...
static FBSTRING* HGETUDTID( struct $8FBSYMBOL* SYM$1 )
{
	...
	{
		{
			$19FB_CVA_LIST_TYPEDEF TMP$185$3;
			$19FB_CVA_LIST_TYPEDEF vr$6 = SYMBGETVALISTTYPE( *(int64*)((uint8*)SYM$1 + 56ll), *(struct $8FBSYMBOL**)((uint8*)SYM$1 + 64ll) );
			TMP$185$3 = vr$6;
			if( TMP$185$3 == 3ll ) goto label$186;
			label$187:;
			if( TMP$185$3 == 4ll ) goto label$186;
			label$188:;
			if( TMP$185$3 != 5ll ) goto label$185;
			label$186:;
			{
	...
	FBSTRING* vr$12 = fb_StrConcat( &TMP$187$1, (void*)"$", 2ll, (void*)vr$9, 0ll );
...
static void HEMITUDT( struct $8FBSYMBOL* S$1, int64 IS_PTR$1 )
{
	...
	SECTION$1 = vr$14;
	{
		...
		if( (TMP$188$2 - 3ull) > 7ull ) goto label$204;
		goto *tmp$679[TMP$188$2 - 3ull];
		label$204:;
	}
	SECTIONRETURN( SECTION$1 );
	label$192:;
...
static FBSTRING* HEMITARRAYDECL( struct $8FBSYMBOL* SYM$1 )
{
	...
	label$215:;
	{
		...
		if( TMP$199$2 == 1ll ) goto label$219;
		label$220:;
		if( TMP$199$2 != 12ll ) goto label$218;
		label$219:;
		{
			...
			{
				{
					...
					I$5 = I$5 + 1ll;
					label$223:;
					if( I$5 <= TMP$200$5 ) goto label$226;
					label$225:;
				}
			}
			label$222:;
	...
	if( (*(int64*)((uint8*)SYM$1 + 8ll) & 262144ll) != 0ll ) goto label$228;
	{
		...
		LENGTH$2 = 0ll;
		{
			...
			if( TMP$206$3 == 18ll ) goto label$231;
			label$232:;
			if( TMP$206$3 != 4ll ) goto label$230;
			label$231:;
			{
			...
			goto label$229;
			label$230:;
			if( TMP$206$3 != 7ll ) goto label$233;
			label$234:;
			{
...
static void HMAYBEEMITGLOBALVAR( struct $8FBSYMBOL* SYM$1 )
{
	...
	label$260:;
	{
		...
		if( TMP$215$2 != 1ll ) goto label$263;
		label$264:;
		{
		...
		goto label$262;
		label$263:;
		if( TMP$215$2 != 2ll ) goto label$267;
		label$268:;
		{
	...
	if( FLD$1 == (struct $8FBSYMBOL*)0ull ) goto label$307;
	{
		...
		if( SKIP$1 != 0ll ) goto label$312;
		{
			...
			if( ALIGN$1 <= 0ll ) goto label$314;
			{
				...
				label$1207:;
				if( TMP$227$4 != 20ll ) goto label$317;
				{
			...
			TMP$230$3 = -1ll;
			label$1208:;
			if( TMP$230$3 == 0ll ) goto label$324;
			{
				int64 TMP$231$4;
				...
				label$1209:;
				if( TMP$231$4 != 20ll ) goto label$327;
				{
					int64 TMP$232$5;
					int64 TMP$233$5;
					...
					TMP$232$5 = 0ll;
					label$1210:;
					if( TMP$232$5 == 0ll ) goto label$330;
					{
					...
					TMP$233$5 = 0ll;
					label$1211:;
					if( TMP$233$5 == 0ll ) goto label$333;
					{
	...
	{
		{
			...
			label$1212:;
			TMP$253$3 = *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$252$3 * 56ll)) + 8ll);
			if( TMP$253$3 != 4ll ) goto label$356;
			label$357:;
			{
			...
			goto label$355;
			label$356:;
			if( TMP$253$3 != 8ll ) goto label$358;
			label$359:;
			{
	...
	*(int64*)((uint8*)&CTX$ + 5512ll) = 2ll;
	...
	if( (*(int64*)((uint8*)&ENV$ + 448ll) & (*(int64*)((uint8*)&ENV$ + 568ll) & 4ll)) == 0ll ) goto label$403;
	{
		...
		if( vr$35 <= 0ll ) goto label$405;
		{
			...
			fb_StrAssign( (void*)&TMP$357$3, -1ll, (void*)"__asm__( \x22.text\x22 );", 20ll, 0 );
			HWRITELINE( &TMP$357$3, 0ll );
			fb_StrDelete( (FBSTRING*)&TMP$357$3 );
		}
		label$405:;
		label$404:;
...
static int64 _SUPPORTSOP( int64 OP$1, int64 DTYPE$1 )
{
	...
	label$418:;
	{
		...
		if( (TMP$359$2 - 57ull) > 15ull ) goto label$423;
		goto *tmp$680[TMP$359$2 - 57ull];
		label$420:;
	}
	label$419:;
	return fb$result$1;
...
static void _PROCALLOCSTATICVARS( struct $8FBSYMBOL* SYM$1 )
{
	...
	{
		{
			$12FB_SYMBCLASS TMP$360$3;
			TMP$360$3 = *($12FB_SYMBCLASS*)SYM$1;
			if( TMP$360$3 != 15ll ) goto label$439;
			label$440:;
			{
			...
			goto label$438;
			label$439:;
			if( TMP$360$3 != 1ll ) goto label$441;
			label$442:;
			{
...
static FBSTRING* HEMITTYPE( int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	{
		{
			$19FB_CVA_LIST_TYPEDEF TMP$361$3;
			$19FB_CVA_LIST_TYPEDEF vr$3 = SYMBGETVALISTTYPE( DTYPE$1, SUBTYPE$1 );
			TMP$361$3 = vr$3;
			if( TMP$361$3 != 2ll ) goto label$456;
			label$457:;
			{
	...
	DTYPE$1 = DTYPE$1 & 31ll;
	{
		...
		label$461:;
		{
			...
			if( DTYPE$1 != 10ll ) goto label$464;
			{
				...
				goto label$1213;
				label$465:;
				TMP$363$4 = DTYPE$1 & 31ll;
				label$1213:;
				fb_StrAssign( (void*)&S$1, -1ll, *(void**)((int64)(char**)DTYPENAME$ + (*(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$363$4 * 56ll)) + 32ll) << (3ll & 63ll))), 0ll, 0 );
			}
			goto label$462;
			label$464:;
			{
		...
		label$467:;
		{
			...
			goto label$1214;
			label$468:;
			TMP$364$3 = DTYPE$1 & 31ll;
			label$1214:;
			fb_StrAssign( (void*)&S$1, -1ll, *(void**)((int64)(char**)DTYPENAME$ + (*(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$364$3 * 56ll)) + 32ll) << (3ll & 63ll))), 0ll, 0 );
		}
		goto label$459;
		label$469:;
		{
		...
		goto label$459;
		label$460:;
		static const void* tmp$681[16ll] = {
			&&label$467,
			&&label$470,
			&&label$470,
			&&label$461,
		...
		if( (TMP$362$2 - 7ull) > 15ull ) goto label$470;
		goto *tmp$681[TMP$362$2 - 7ull];
		label$459:;
	}
...
static struct $8EXPRNODE* EXPRNEWIMMI( int64 I$1, int64 DTYPE$1 )
{
	...
	goto label$1215;
	label$491:;
	TMP$366$1 = DTYPE$1 & 31ll;
	label$1215:;
	if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$366$1 * 56ll)) + 8ll) != 8ll ) goto label$493;
	{
		int64 TMP$367$2;
		...
		label$1216:;
		if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$367$2 * 56ll)) + 16ll) == 0ll ) goto label$495;
		TMP$368$2 = 13ll;
		goto label$1217;
		label$495:;
		TMP$368$2 = 14ll;
	...
	label$493:;
	{
		...
		goto label$1218;
		label$496:;
		TMP$369$2 = DTYPE$1 & 31ll;
		label$1218:;
		if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$369$2 * 56ll)) + 16ll) == 0ll ) goto label$497;
		TMP$370$2 = 11ll;
		goto label$1219;
		label$497:;
		TMP$370$2 = 12ll;
...
static int64 SYMBISCARRAY( struct $8FBSYMBOL* SYM$1 )
{
	...
	label$502:;
	{
		$12FB_SYMBCLASS TMP$371$2;
		TMP$371$2 = *($12FB_SYMBCLASS*)SYM$1;
		if( TMP$371$2 == 1ll ) goto label$506;
		label$507:;
		if( TMP$371$2 != 12ll ) goto label$505;
		label$506:;
		{
	...
	{
		int64 TMP$372$2;
		TMP$372$2 = *(int64*)((uint8*)SYM$1 + 56ll) & 511ll;
		if( TMP$372$2 == 18ll ) goto label$514;
		label$515:;
		if( TMP$372$2 == 4ll ) goto label$514;
		label$516:;
		if( TMP$372$2 != 7ll ) goto label$513;
		label$514:;
		{
			fb$result$1 = -1ll;
			goto label$501;
...
static struct $8EXPRNODE* EXPRNEWCAST( int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, struct $8EXPRNODE* L$1 )
{
	...
	goto label$1220;
	label$521:;
	TMP$373$1 = *(int64*)((uint8*)L$1 + 8ll) & 31ll;
	label$1220:;
	if( (DTYPE$1 & 480ll) == 0ll ) goto label$522;
	TMP$374$1 = 24ll;
	goto label$1221;
	label$522:;
	TMP$374$1 = DTYPE$1 & 31ll;
	label$1221:;
	if( (((int64)-(*(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$373$1 * 56ll)) + 40ll) == *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$374$1 * 56ll)) + 40ll)) & (int64)-((*(int64*)((uint8*)L$1 + 8ll) & 480ll) == 0ll)) & (int64)-((DTYPE$1 & 480ll) == 0ll)) == 0ll ) goto label$524;
	{
		fb$result$1 = L$1;
		goto label$518;
	}
...
static int64 TYPECBOP( int64 OP$1, int64 A$1, int64 B$1 )
{
	...
	TMP$377$1 = A$1 & 31ll;
	label$1224:;
	if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$377$1 * 56ll)) + 8ll) > 4ll ) goto label$554;
	{
		int64 TMP$378$2;
		...
		TMP$378$2 = A$1 & 31ll;
		label$1225:;
		if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$378$2 * 56ll)) + 16ll) == 0ll ) goto label$556;
		TMP$379$2 = 11ll;
		goto label$1226;
		label$556:;
		TMP$379$2 = 12ll;
	...
	TMP$384$1 = B$1 & 31ll;
	label$1231:;
	if( ~(*(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$383$1 * 56ll)) + 16ll) & *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$384$1 * 56ll)) + 16ll)) == 0ll ) goto label$565;
	{
	...
	TMP$386$1 = B$1 & 31ll;
	label$1233:;
	if( ((int64)-(*(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$385$1 * 56ll)) + 8ll) == 8ll) | (int64)-(*(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$386$1 * 56ll)) + 8ll) == 8ll)) == 0ll ) goto label$569;
	{
		int64 TMP$387$2;
		$11FB_DATATYPE TMP$388$2;
		int64 TMP$389$2;
		$11FB_DATATYPE TMP$390$2;
		...
		TMP$389$2 = B$1 & 31ll;
		label$1236:;
		if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$389$2 * 56ll)) + 16ll) == 0ll ) goto label$573;
		TMP$390$2 = 13ll;
		goto label$1237;
		label$573:;
		TMP$390$2 = 14ll;
	...
	TMP$392$1 = B$1 & 31ll;
	label$1239:;
	if( ~(*(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$391$1 * 56ll)) + 16ll) & *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$392$1 * 56ll)) + 16ll)) == 0ll ) goto label$577;
	{
...
static struct $8EXPRNODE* EXPRNEWUOP( int64 OP$1, struct $8EXPRNODE* L$1 )
{
	...
	SOLVED_OUT$1 = 0ll;
	{
		...
		if( (TMP$393$2 - 22ull) > 54ull ) goto label$592;
		goto *tmp$682[TMP$393$2 - 22ull];
		label$580:;
	}
...
static struct $8EXPRNODE* EXPRNEWBOP( int64 OP$1, struct $8EXPRNODE* L$1, struct $8EXPRNODE* R$1 )
{
	...
	DTYPE$1 = vr$3;
	{
		...
		if( (TMP$394$2 - 45ull) > 5ull ) goto label$597;
		goto *tmp$683[TMP$394$2 - 45ull];
		label$597:;
	}
...
static FBSTRING* HEMITINT( int64 DTYPE$1, int64 VALUE$1 )
{
	...
	goto label$1240;
	label$616:;
	TMP$395$1 = DTYPE$1 & 31ll;
	label$1240:;
	if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$395$1 * 56ll)) + 16ll) == 0ll ) goto label$618;
	{
		int64 TMP$396$2;
		...
		goto label$1241;
		label$619:;
		TMP$396$2 = DTYPE$1 & 31ll;
		label$1241:;
		if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$396$2 * 56ll)) + 8ll) != 8ll ) goto label$621;
		{
	...
	label$618:;
	{
		...
		label$1242:;
		if( *(int64*)(((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$399$2 * 56ll)) + 8ll) != 8ll ) goto label$628;
		{
	...
	fb_StrConcatByref( (void*)LN$1, -1ll, (void*)"\x22", 2ll, 0 );
	{
		...
		label$658:;
		{
			...
			if( vr$3 == 0ll ) goto label$660;
			{
				...
				FBSTRING* vr$7 = fb_StrConcat( &TMP$412$4, (void*)"\x5Cx", 3ll, (void*)vr$4, -1ll );
			...
			if( (uint64)CH$1 != 63ull ) goto label$663;
			{
				...
				if( (uint64)(int64)*(uint8*)((uint8*)((uint8*)Z$1 + I$2) + 1ll) != 63ull ) goto label$665;
				{
					{
						uint8 TMP$415$6;
						TMP$415$6 = *(uint8*)((uint8*)((uint8*)Z$1 + I$2) + 2ll);
						if( (uint64)(int64)TMP$415$6 == 61ull ) goto label$668;
						label$669:;
						if( (uint64)(int64)TMP$415$6 == 47ull ) goto label$668;
						label$670:;
						if( (uint64)(int64)TMP$415$6 == 39ull ) goto label$668;
						label$671:;
						if( (uint64)(int64)TMP$415$6 == 40ull ) goto label$668;
						label$672:;
						if( (uint64)(int64)TMP$415$6 == 41ull ) goto label$668;
						label$673:;
						if( (uint64)(int64)TMP$415$6 == 33ull ) goto label$668;
						label$674:;
						if( (uint64)(int64)TMP$415$6 == 60ull ) goto label$668;
						label$675:;
						if( (uint64)(int64)TMP$415$6 == 62ull ) goto label$668;
						label$676:;
						if( (uint64)(int64)TMP$415$6 != 45ull ) goto label$667;
						label$668:;
						{
							fb_StrConcatByref( (void*)LN$1, -1ll, (void*)"\x22 \x22", 4ll, 0 );
						}
		...
		I$2 = I$2 + 1ll;
		label$655:;
		if( I$2 <= TMP$410$2 ) goto label$658;
		label$657:;
	}
	fb_StrConcatByref( (void*)LN$1, -1ll, (void*)"\x22", 2ll, 0 );
	label$654:;
...
static void HBUILDWSTRLIT( FBSTRING* LN$1, uint32* W$1, int64 LENGTH$1 )
{
	...
	WCHARSIZE$1 = *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + 400ll);
	{
		...
		label$682:;
		{
			...
			{
				fb_StrConcatByref( (void*)LN$1, -1ll, (void*)"?", 2ll, 0 );
				if( (uint64)(int64)*(uint32*)((uint8*)((uint8*)W$1 + (I$2 << (2ll & 63ll))) + 4ll) != 63ull ) goto label$689;
				{
					{
						uint32 TMP$427$6;
						TMP$427$6 = *(uint32*)((uint8*)((uint8*)W$1 + (I$2 << (2ll & 63ll))) + 8ll);
						if( (uint64)(int64)TMP$427$6 == 61ull ) goto label$692;
						label$693:;
						if( (uint64)(int64)TMP$427$6 == 47ull ) goto label$692;
						label$694:;
						if( (uint64)(int64)TMP$427$6 == 39ull ) goto label$692;
						label$695:;
						if( (uint64)(int64)TMP$427$6 == 40ull ) goto label$692;
						label$696:;
						if( (uint64)(int64)TMP$427$6 == 41ull ) goto label$692;
						label$697:;
						if( (uint64)(int64)TMP$427$6 == 33ull ) goto label$692;
						label$698:;
						if( (uint64)(int64)TMP$427$6 == 60ull ) goto label$692;
						label$699:;
						if( (uint64)(int64)TMP$427$6 == 62ull ) goto label$692;
						label$700:;
						if( (uint64)(int64)TMP$427$6 != 45ull ) goto label$691;
						label$692:;
						{
							fb_StrConcatByref( (void*)LN$1, -1ll, (void*)"\x22 L\x22", 5ll, 0 );
						}
		...
		I$2 = I$2 + 1ll;
		label$679:;
		if( I$2 <= TMP$424$2 ) goto label$682;
		label$681:;
	}
	fb_StrConcatByref( (void*)LN$1, -1ll, (void*)"\x22", 2ll, 0 );
	label$678:;
...
static char* HBOPTOSTR( int64 OP$1 )
{
	...
	label$701:;
	{
		...
		if( (TMP$428$2 - 28ull) > 22ull ) goto label$703;
			...
			*IS_BUILTIN$1 = -1ll;
			{
				...
				if( (TMP$448$4 - 7ull) > 3ull ) goto label$741;
			...
			{
				{
					...
					if( (TMP$453$5 - 58ull) > 12ull ) goto label$757;
			...
			{
				{
					...
					if( (TMP$464$5 - 58ull) > 12ull ) goto label$770;
...
static void HIMM2TEXT( FBSTRING* S$1, struct $8EXPRNODE* N$1 )
{
	...
	label$1244:;
	if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$475$1 * 56ll)) != 1ll ) goto label$775;
	{
		FBSTRING TMP$476$2;
...
static void HSYM2TEXT( FBSTRING* S$1, struct $8FBSYMBOL* SYM$1 )
{
	...
	if( (*(int64*)((uint8*)SYM$1 + 8ll) & 1024ll) == 0ll ) goto label$779;
	{
		if( (*(int64*)((uint8*)SYM$1 + 56ll) & 511ll) != 7ll ) goto label$781;
		{
			int64 TMP$478$3;
			TMP$478$3 = 0ll;
			uint32* vr$8 = HUNESCAPEW( *(uint32**)((uint8*)SYM$1 + 96ll), &TMP$478$3 );
		...
		label$781:;
		{
			int64 TMP$479$3;
			TMP$479$3 = 0ll;
			char* vr$12 = HUNESCAPE( *(char**)((uint8*)SYM$1 + 96ll), &TMP$479$3 );
...
static void HEXPRFLUSH( struct $8EXPRNODE* N$1, int64 NEED_PARENS$1 )
{
	...
	int64 IS_BUILTIN$1;
	{
		...
		{
			{
				...
				if( TMP$487$4 != 112ll ) goto label$795;
				label$796:;
				{
					FBSTRING TMP$489$5;
				...
				goto label$794;
				label$795:;
				if( TMP$487$4 != 109ll ) goto label$797;
				label$798:;
				{
				...
				goto label$794;
				label$797:;
				if( TMP$487$4 != 110ll ) goto label$799;
				label$800:;
				{
				...
				goto label$794;
				label$799:;
				if( TMP$487$4 != 111ll ) goto label$801;
				label$802:;
				{
		...
		{
			{
				...
				if( TMP$494$4 != 64ll ) goto label$815;
				label$816:;
				{
		...
		if( TMP$482$2 > 6ull ) goto label$787;
...
static struct $8EXPRNODE* EXPRNEWVREG( struct $6IRVREG* VREG$1, int64 IS_LVALUE$1 )
{
	...
	int64 HAVE_OFFSET$1;
	{
		...
		label$836:;
		{
			...
			if( ((int64)-(*(int64*)((uint8*)VREG$1 + 8ll) != SYMDTYPE$3) | (int64)-(*(struct $8FBSYMBOL**)((uint8*)VREG$1 + 16ll) != SYMSUBTYPE$3)) == 0ll ) goto label$844;
			{
				...
				DO_DEREF$3 = DO_DEREF$3 | (int64)-(*(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$499$4 * 56ll)) != *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$500$4 * 56ll)));
				{
					...
					label$1247:;
					TMP$502$5 = TMP$501$5;
					if( TMP$502$5 != 17ll ) goto label$849;
					label$850:;
					{
						DO_DEREF$3 = -1ll;
					}
					goto label$848;
					label$849:;
					if( TMP$502$5 != 20ll ) goto label$851;
					label$852:;
					{
					...
					{
						{
							...
							label$1248:;
							TMP$504$7 = TMP$503$7;
							if( TMP$504$7 != 17ll ) goto label$856;
							label$857:;
							{
								DO_DEREF$3 = -1ll;
							}
							goto label$855;
							label$856:;
							if( TMP$504$7 != 20ll ) goto label$858;
							label$859:;
							{
		...
		label$873:;
		{
			...
			label$1249:;
			if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$505$3 * 56ll)) != 1ll ) goto label$876;
			{
		...
		label$879:;
		{
			...
			if( L$1 != (struct $8EXPRNODE*)0ull ) goto label$881;
			{
				...
				struct $8EXPRNODE* vr$127 = EXPRNEWTEXT( *(int64*)((uint8*)VREG$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)VREG$1 + 16ll), (char*)*(char**)&TMP$509$4 );
				L$1 = vr$127;
		...
		if( TMP$498$2 > 5ull ) goto label$834;
...
static void _EMITBOP( int64 OP$1, struct $6IRVREG* V1$1, struct $6IRVREG* V2$1, struct $6IRVREG* VR$1, struct $8FBSYMBOL* LABEL$1 )
{
	...
	label$900:;
	{
		...
		if( (TMP$517$2 - 28ull) > 22ull ) goto label$902;
...
static void _EMITCONVERT( struct $6IRVREG* V1$1, struct $6IRVREG* V2$1 )
{
	...
	if( ((int64)-(*(int64*)((uint8*)V1$1 + 8ll) == 1ll) & (int64)-(*(int64*)((uint8*)R$1 + 8ll) != 1ll)) == 0ll ) goto label$934;
	{
		if( *(int64*)R$1 != 1ll ) goto label$936;
		{
			...
			label$1252:;
			if( *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$519$3 * 56ll)) != 1ll ) goto label$938;
	...
	label$1255:;
	if( ((int64)-(*(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$521$1 * 56ll)) == 0ll) & (int64)-(*(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + (TMP$522$1 * 56ll)) == 1ll)) == 0ll ) goto label$939;
	{
		FBSTRING S$2;
		...
		__builtin_memset( &TEMPDTYPE$2, 0, 8ll );
		{
			...
			if( TMP$524$3 > 5ll ) goto label$944;
			label$945:;
			{
			...
			goto label$943;
			label$944:;
			if( TMP$524$3 > 7ll ) goto label$948;
			label$949:;
			{
...
static void HDOCALL( FBSTRING* S$1, int64 BYTESTOPOP$1, struct $6IRVREG* VR$1, int64 LEVEL$1 )
{
	...
	TMP$535$1 = 0ll;
	label$1257:;
	if( TMP$535$1 == 0ll ) goto label$977;
	{
		int64 TMP$536$2;
		...
		TMP$536$2 = 0ll;
		label$1258:;
		if( TMP$536$2 == 0ll ) goto label$981;
		{
		...
		{
			{
				...
				if( TMP$599$4 != 7ll ) goto label$1063;
				label$1064:;
				{
					USES_LABEL$1 = -1ll;
				}
				goto label$1062;
				label$1063:;
				if( TMP$599$4 != 1ll ) goto label$1065;
				label$1066:;
				{
	...
	{
		{
			...
			if( TMP$603$3 != 0ll ) goto label$1074;
			label$1075:;
			{
				FBSTRING TMP$604$4;
			...
			goto label$1073;
			label$1074:;
			if( TMP$603$3 != 1ll ) goto label$1076;
			label$1077:;
			{
					...
					{
						{
							...
							if( TMP$605$7 != 1ll ) goto label$1083;
							label$1084:;
							{
							...
							goto label$1082;
							label$1083:;
							if( TMP$605$7 != 7ll ) goto label$1091;
							label$1092:;
							{
								int64 LABELNUM$8;
	...
	if( *(int64*)((uint8*)&ENV$ + 264ll) != 0ll ) goto label$1099;
	{
		...
		if( vr$114 == 0ll ) goto label$1101;
		{
			...
			fb_StrConcatAssign( (void*)&LN$1, -1ll, (void*)" : \x22" "cc\x22, \x22memory\x22", 18ll, 0 );
			{
				...
				TMP$622$4 = vr$122;
				if( TMP$622$4 == 0ll ) goto label$1104;
				label$1105:;
				if( TMP$622$4 != 1ll ) goto label$1103;
				label$1104:;
				{
				...
				goto label$1102;
				label$1103:;
				if( TMP$622$4 == 2ll ) goto label$1113;
				label$1114:;
				if( TMP$622$4 != 3ll ) goto label$1112;
				label$1113:;
				{
...
static void _EMITVARINISTR( int64 VARLENGTH$1, char* LITERAL$1, int64 LITLENGTH$1 )
{
	...
	label$1143:;
	TMP$633$1 = 0ll;
	char* vr$2 = HUNESCAPE( LITERAL$1, &TMP$633$1 );
...
static void _EMITVARINIWSTR( int64 VARLENGTH$1, uint32* LITERAL$1, int64 LITLENGTH$1 )
{
	...
	fb_StrConcatByref( (void*)((uint8*)&CTX$ + 5280ll), -1ll, (void*)"{ ", 3ll, 0 );
	TMP$635$1 = 0ll;
	uint32* vr$2 = HUNESCAPEW( LITERAL$1, &TMP$635$1 );
	LITERAL$1 = vr$2;
	WCHARSIZE$1 = *(int64*)((int64)(struct $13SYMB_DATATYPE*)SYMB_DTYPETB$ + 400ll);
	...
	label$1147:;
	{
		...
		I$2 = I$2 + 1ll;
		label$1149:;
		if( I$2 <= TMP$636$2 ) goto label$1152;
		label$1151:;
	}
	fb_StrConcatByref( (void*)((uint8*)&CTX$ + 5280ll), -1ll, (void*)" }", 3ll, 0 );
	HVARINISEPARATOR(  );
