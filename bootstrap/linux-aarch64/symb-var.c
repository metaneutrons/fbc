...
int64 SYMBARRAYHASUNKNOWNBOUNDS( struct $8FBSYMBOL* SYM$1 )
{
	...
	label$76:;
	{
		...
		label$81:;
		{
			if( *(int64*)((uint8*)((uint8*)*(struct $10FBARRAYDIM**)((uint8*)SYM$1 + 112ll) + (I$2 << (4ll & 63ll))) + 8ll) != -9223372036854775808ull ) goto label$83;
			{
				fb$result$1 = -1ll;
				goto label$75;
			}
...
int64 SYMBCHECKARRAYSIZE( int64 DIMENSIONS$1, struct $10FBARRAYDIM* DIMTB$1, int64 LGT$1, int64 IS_ON_STACK$1 )
{
	...
	ALLELEMENTS$1 = 1ull;
	{
		...
		label$170:;
		{
			if( *(int64*)((uint8*)((uint8*)DIMTB$1 + (I$2 << (4ll & 63ll))) + 8ll) != -9223372036854775808ull ) goto label$172;
			{
				ELEMENTS$1 = 1ull;
			}
			goto label$171;
